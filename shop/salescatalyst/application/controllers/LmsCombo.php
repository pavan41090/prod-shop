...
ob_start();
class LmsCombo extends CI_Controller {
	...
	public function createLmsCombo(){

		if ($this->session->userdata('logged_in') == TRUE) {

			$this->data['module'] = 'leads';
			$this->data['sub_module'] = 'Combo'; 
			...
			$this->load->view('lms_view/lms_create_combo',$this->data);
...
public function lmsComboScriptQuery()
  {
  	 ...
  	 if ($this->session->userdata('logged_in') == TRUE) {
		...
		$this->load->view('lms_view/script_query_combo');
		$this->load->view('layout/footer_inner');
...
/*combo update function*/
		...
		$cusUpdateData = array(
			...
			'cust_area' 	=> ($this->input->get_post('lms_car_area') ? $this->security->xss_clean($this->input->get_post('lms_car_area')) : ''),
			...
			'cust_landmark' => ($this->input->get_post('lms_car_pro_landmark') ? $this->security->xss_clean($this->input->get_post('lms_car_pro_landmark')) : ''),
			...
			'temp_LE'           => ($this->input->get_post('lms_cus_tle') ? $this->security->xss_clean($this->input->get_post('lms_cus_tle')) : ''),
