...
class Bundlemodel extends CI_Model {
    ...
    public function getSummodel(){
        return $this->_getSummodel();
    }

    private function _getSummodel(){
        if($_SERVER['REQUEST_METHOD'] == "POST"){
            ...
            $errorResponce['premium'] =  (int)$sumAssuedValue;
    ...
    private function _getInsertproductdata($thispost){
        ...
        $productData['lms_premium'] = $this->security->xss_clean($thispost['lms_est_premium']);
