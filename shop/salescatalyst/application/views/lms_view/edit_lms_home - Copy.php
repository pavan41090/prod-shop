...
<script src="<?php echo base_url(); ?>assets/js/lms_js/property_owner_type_struture.js"></script>
...
<hr>
         ...
         <form name="lmsCar" novalidate id="homecustomerdata">
            <div class="portlet-title tabbable-line">
               <div class="caption leadtit">
                  <i class="icon-globe font-dark hide"></i>
            ...
            <div class="row maincontf"> 
               ...
               <div class="row maincontf" >
                  ...
                  <input type="submit" class="btn blue btn-default" style="float:right;" value="Update" ng-show="updatedatacus" ng-click="updateCustomer()" />
                  <input type="button" class="btn blue btn-default" style="float:right;" value="Please wait.." ng-show="updateprogressdatacus" />
            <br><br>
         </form>
      </div>
               ...
               <div class="row maincontf">
                  ...
                  <label>Sum Insured to be provided as</label>
                     ...
                     <div class="form-group">
                        ...
                        <div class="col-md-3">
                           <input type="checkbox" name="hme_sum_insured_provided" id="valuables" value="valuables"  />
...
<?php } ?>   
			   ...
			   <input type="submit" class="btn blue btn-default" style="float:right;" value="Update" ng-click="HomeUpdateProductDetail()" ng-show="updatehomedetails"  />
			   
			   <input type="button" class="btn blue btn-default" style="float:right;" value="Please wait..." ng-show="updateprocesshomedetails" disabled />
               <br><br>
                  ...
                  <div class="col-md-6">
                     <div class="pull-right">
                        <div class="form-group">
                           ...
                           <button type="submit" class="btn blue btn-default" ng-click="homeUpdateProposal()" ng-show="updateleadhome"> Update Lead </button>
