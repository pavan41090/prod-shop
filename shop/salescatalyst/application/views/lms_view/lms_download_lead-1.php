               ...
               <div class="portlet-title">
                  ...
                  <div class="caption pull-right"> 
                      ...
                      <?php if($this->session->userdata('user_type_abbr') == 'bagi_ops' || $this->session->userdata('user_type_abbr') == 'bagi_ops' ) { ?>
                        <?php /* <script src="<?php echo base_url(); ?>assets/js/lms_js/lms-app-policy-upload.js"></script>
			...
			$.ajax({
              url : webUbrl+'User/getAllSupervisor',
               ...
               success: function( data){
                  ...
                  let firstsuper = jsonD.one;
                  let secondsuper = jsonD.two;
                  let threeuper = jsonD.three;
