...
<script src="<?php echo base_url(); ?>assets/js/lms_js/lms-app-edit-sship.js"></script>
<script src="<?php echo base_url(); ?>assets/js/lms_js/sship.js"></script>
<input type="hidden" id="web_url" value="<?php echo base_url(); ?>">
<input type="hidden" id="product_type" alue="<?php echo $editProductType ?>">
   ...
   <div class="tab-pane fade active in" id="car">
      <!--                         <form type="POST" id="carform" name="carform" >
         ...
         <div class="pull-right">
          ...
          <form name="lmsCar" novalidate id="superupdate">
            ...
            <div class="row maincontf">
              <?php require_once 'customer-extra-feilds-form.php'; ?>
               <div class="col-md-4">
                  <div class="form-group">
                     ...
                     <input list="salute" id="lms_car_salut" placeholder="Salutation" name="lms_car_salut" class="form-control input-sm" ng-change =" self_salut = lms_car_salut; ship_tax_salut = lms_car_salut " ng-model="lms_car_salut" required>
                     <datalist id="salute">
               ...
               <div class="col-md-4">
                  <div class="form-group">
                     ...
                     <span class="required"> * </span></label>  
                     <input type="text" name="lms_car_fname"  placeholder="Customer First Name"  class="form-control input-sm" id="lms_car_fname" ng-change = "self_fname=lms_car_fname; ship_tax_your_name = lms_car_fname " ng-model="lms_car_fname" required />               
             ...
             <div class="col-md-4">
                     <div class="form-group">
                        ...
                        <input type="text" name="lms_car_pro_landmark" placeholder="Enter Nearest Land Mark" class="form-control input-sm" id="lms_car_pro_landmark" ng-change="ship_tax_landmark=lms_car_pro_landmark" ng-model="lms_car_pro_landmark"/>
                  ...
                  <div class="col-md-4">
                     <div class="form-group">
                        ...
                        <input type="text" id="lms_car_pro_emergency" autocomplete="off" name="lms_car_pro_emergency" class="form-control input-sm" placeholder="Mobile Number" ng-changr="ship_tax_fixed_line=lms_car_pro_emergency"ng-model="lms_car_pro_emergency" MaxLength="10" onkeypress='return restrictAlphabets(event)' onkeyup="return mobile_validate_emergency(this.value);" placeholder="Mobile" ng-keyup="ship_tax_fixed_line=lms_car_pro_emergency" /> 
               ...
               <div class="row maincontf" >
                  ...
                  <input type="hidden" id="lms_edit_product_id" name="lms_edit_product_id" class="form-control input-sm" ng-model="lms_edit_product_id" />
                   <input type="hidden" id="edit_prim_ins_id" name="edit_prim_ins_id" class="form-control input-sm" ng-model="edit_prim_ins_id" />
            ...
            <div class="row" id="cardeatail">
                ...
                <div class="form-group">
                     <div class="question">
                      <label>Include Spouse</label> <span class="required"> </span>
                       <input class="Spouse_ship" type="checkbox" name="Spouse_ship" ng-model="spouse.spouse_ship" class="Spouse_ship test" id="Spouse_ship" ng-disabled="true" value="1" ng-click="zonewisecalculation()"/>
                   </div>
                  <div class="answer" ng-if="spouse.spouse_ship">
                  <label>Spouse DOB</label><span class="required">*</span>
                 <input ng-init="loadSpouseDate()" type="text" id="sship_spouse" name="sship_spouse" class="form-control input-sm custom-date-dob" required data-date-format="dd-mm-yyyy" placeholder="Spouse Date of Birth" ng-model="sship_spouse" ng-change="spouse.spouse_dob=sship_spouse"  >
               ...
               <div class="col-md-4">
                  <div class="form-group">
                     ...
                     <div class="radio-list">
                        <label class="radio-inline" style="font-size:12px;">
                        <input type="radio" name="noofchildrens" id="noofchildrens0" class="noofchildrens" ng-click="zonewisecalculation()" ng-model='noofchildrens'   value="0"  ng-disabled="true" required> 0 </label>   
                        <label class="radio-inline" style="font-size:12px;">
                        <input type="radio" name="noofchildrens" id="noofchildrens1" class="noofchildrens" ng-click="zonewisecalculation()" ng-model='noofchildrens'    value="1"  ng-disabled="true" required> 1 </label>
                        <label class="radio-inline" style="font-size:12px;">
                        <input type="radio" name="noofchildrens" id="noofchildrens2" class="noofchildrens" ng-click="zonewisecalculation()" ng-model='noofchildrens'   value="2" ng-disabled="true"  required> 2 </label>    
                        <label class="radio-inline" style="font-size:12px;">
                        <input type="radio" name="noofchildrens" id="noofchildrens3" class="noofchildrens" ng-click="zonewisecalculation()" ng-model='noofchildrens'   value="3" ng-disabled="true"  required> 3 </label>        
                     </div>
                  </div>
               </div>
               ...
               <div class="col-md-4">
                     <div class="form-group">
                        ...
                        <span class="required"> * </span></label>
                        <div class="radio-list">
                           <input type="text" id="sship_income" name="sship_income" class="form-control input-sm" placeholder="Income (P.A)" ng-change="ship_tax_income=sship_income"ng-model="sship_income" required /> 
                ...
                <div class="col-md-4">
                  ...
                  <div class="col-md-4">
                     <div class="form-group">
                              ...
                              <span class="required"> * </span>
                              <select id="ss_sum_insured" name="ss_sum_insured" ng-change="zonewisecalculation()" class="form-control input-sm" ng-model="ss_sum_insured"  required>
                                    <option value="" disabled selected>Select your option</option>
                  ...
                  <div class="col-md-4">
                     <div class="form-group">
                        ...
                        <?php /*<div ng-if="lmsCar.$submitted" ng-messages="lmsCar.lms_est_premium.$error" role="alert">
                ...
                <div class="form-group">
                     <div class="question">
                      <label>Critical Illness</label><span class="required"> </span>
                       <input type="checkbox" name="ss_critical" ng-model="ss_critical" id="ss_crtical" class="ss_critical" value="1" ng-click="zonewisecalculation('critical')">
                   </div>
                    <div class="answer1">
                     ...
                     <div class="form-group" >
                              <label>Sum Insured</label>
                              <span class="required"> * </span>
                              <select id="ss_sum_insured_critical" name="ss_sum_insured_critical" class="form-control input-sm  sumInsured" ng-model="ss_sum_insured_critical" ng-change="zonewisecalculation()" disabled>
            ...
            <div class="row maincontf">
               <div class="col-md-4">
                  <div class="form-group">
                     ...
                     <input type="text" id="spouse_dob" name="spouse_dob" class="form-control input-sm custom-date-dob" placeholder="DD-MM-YYYY" ng-model="spouse.spouse_dob" data-date-format="dd-mm-yyyy" ng-disabled="spouse_dob" readonly="readonly">
                      <div ng-if="lmsCar.$submitted || lmsCar.spouse_dob.$dirty" ng-messages="lmsCar.spouse_dob.$error" role="alert">
                        <div ng-message="required" class="required">Please Enter Spouse DOB</div>
                     </div>
                  </div>
               </div>
            ...
            <div class="row maincontf">
               ...
               <div class="col-md-2">
                  <div class="form-group">
                     ...
                     <input type="text" name="spouse_height_feet" onkeypress='return restrictAlphabets(event)' maxlength="1" placeholder="Enter Height(in feet)" class="form-control input-sm" id="spouse_height_feet"  ng-model="spouse.spouse_height_feet" ng-keyup="convertfeettocm()" required/>
               ...
               <div class="col-md-2">
                  <div class="form-group">
                     ...
                     <input type="text" name="spouse_height_inches" maxlength="2" onkeypress='return restrictAlphabets(event)' placeholder="Enter Height(in inches)" class="form-control input-sm" id="spouse_height_inches"  ng-model="spouse.spouse_height_inches" ng-keyup="convertfeettocm()" required/>
            ...
            <div class="row maincontf">
               <div class="col-md-2">
                  <div class="form-group">
                     ...
                     <input type="text" name="child1_height_feet" onkeypress='return restrictAlphabets(event)' placeholder="Enter Height(in feet)" class="form-control input-sm" id="child1_height_feet" maxlength="1" ng-model="child1.child1_height_feet" ng-required="cyears1>12"/>
               ...
               <div class="col-md-2">
                  <div class="form-group">
                     ...
                     <input type="text" name="child1_height_inches" onkeypress='return restrictAlphabets(event)' placeholder="Enter Height(in inches)" class="form-control input-sm" id="child1_height_inches" ng-model="child1.child1_height_inches" maxlength="2" ng-keyup="convertfeettocm()" ng-required="cyears1>12"/>
            ...
            <div class="row maincontf">
               ...
               <div class="col-md-4">
                  <div class="form-group">
                     ...
                     <input type="text" name="child2_weight" onkeypress='return restrictAlphabets(event)'  placeholder="EnterWeight(in KG's)" class="form-control input-sm" id="child2_weight" ng-model="child2.child2_weight" ng-required="cyears2>12" />
              ...
              <div class="col-md-2">
               ...
               <div class="col-md-4">
                  <div class="form-group">
                     ...
                     <input type="text" name="child3_weight"  onkeypress='return restrictAlphabets(event)' placeholder="EnterWeight(in KG's)" class="form-control input-sm" id="child3_weight" ng-model="child3.child3_weight" ng-required="cyears3>12" />
                  ...
                  <div class="col-md-6">
                     <div class="pull-right">
                        <div class="form-group">
                           ...
                           <button type="submit"  class="btn blue btn-default send_quote" ng-show="updateleadhome" ng-click="updateCustomer()" >Update Lead</button>
                           <button type="submit"  class="btn blue btn-default send_quote" ng-show="updateleadhomeprg">Please Wait...</button>
                           </a>
                        </div>
                     </div>
                  </div>
