      ...
      <div class="row">
         <div class="col-md-12">
            ...
            <?php $shortstrmwer = strtolower($shortunanan); ?>
                        ...
                        <option value="<?php echo $location; ?>" <?php echo ( ((empty($shortstrmwer) ? strtolower($loginCity) : $shortstrmwer) == strtolower($location)) ? 'selected' : '' )?>><?php echo $location; ?></option>						<?php endforeach; ?>
                        </select>
