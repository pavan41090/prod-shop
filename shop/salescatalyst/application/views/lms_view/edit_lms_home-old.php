        ...
        <div>
          ...
          <div class="col-md-4" ng-init = ' lms_car_relation_insured = "<?php echo ($lead_details->cus_relation_ishued ? $lead_details->cus_relation_ishued : ''); ?>" ' >
                      ...
                      <div class="form-group">
                         ...
                         <span class="required"> * </span></label>  
                         <select id="lms_car_relation_insured" name="lms_car_relation_insured" class="form-control input-sm" ng-model="lms_car_relation_insured" ng-required = "lms_car_relation_insured == ''">
                               <option value="" disabled selected>Select your option</option>
               ...
               <div class="row maincontf">
                  ...
                  <label>Sum Insured to be provided as</label>
                     ...
                     <div class="form-group">
                        ...
                        <div class="col-md-3">
                           <input type="checkbox" class="Spouse_ship hme_sum_insured_provided" name="hme_sum_insured_provided[]" id="valuables" value="valuables" <?php if($valuablesCheck->valuables > 0){ echo 'checked'; } ?>  />
                           <label> Valuables</label>
                        
                        </div>
                        <div class="col-md-5">
                           <input class="Spouse_ship hme_sum_insured_provided" type="checkbox" name="hme_sum_insured_provided[]" id="SIM_PEE"  ng-model="PEE" value="SIM_PEE" <?php if($valuablesCheck->pee > 0){ echo 'checked'; } ?> />
