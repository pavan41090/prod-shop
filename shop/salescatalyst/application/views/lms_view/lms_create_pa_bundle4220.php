...
<!--first continue button removed -->
        <div> 
          ...
          <div class="form-group col-md-4" ng-show = 'lms_include_spouse == "1"' ng-init=' lms_chlds_count = "<?php echo ($bundleData->bundle_child_s ? $bundleData->bundle_child_s : 0); ?>" '>
            ...
            <select id="lms_car_tenure" name="lms_car_tenure" change:Premium:Data class="form-control input-sm" ng-model="lms_car_tenure"  required>
			...
			<div class="row maincontf">
			<div class="col-md-4">
                     <div class="form-group" ng-init = ' lms_est_premium = "<?php echo $lead_details->lms_premium;?>" '>
                     ...
                     <hr>
                           ...
                           <div class="col-md-4">
                              <div class="form-group" ng-init = ' pa_pro_nomie_age = "<?php echo $lead_details->nominee_age;?>" '>
                                 ...
                                 <input type="text" name="pa_pro_nomie_age" onkeypress='return restrictAlphabets(event)' placeholder="Enter Nominee Age" maxlength="2" class="form-control input-sm age-validate" id="pa_pro_nomie_age" ng-model="pa_pro_nomie_age" required/>
