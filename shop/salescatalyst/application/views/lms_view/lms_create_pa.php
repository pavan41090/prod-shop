...
<input type="hidden" id="product_type" value="Personal Accident">

<div class="tab-content">
   <div class="tab-pane fade active in" id="car">
      <div ng-app="plunker" ng-controller="myCtrl">
         <form name="lmsCar" novalidate id="paform" >
          <div class="row">
          <div class="col-md-8">
           ...
           <div class="row maincontf">
               <div class="col-md-4" ng-init = ' lms_car_category = "<?php echo $userDetails->Channel; ?>" '>
                  ...
                  <label>Category
                     ...
                     <input list="Category" readonly placeholder="Select Category" class="form-control input-sm" name="lms_car_category" id="lms_car_category" ng-model="lms_car_category"  value="<?php echo 
                      $userDetails->Channel; ?>">
...
<!--                         <div class="row maincontf">
                           <div class="col-md-12">
                              <div class="form-group">
                                 ...
                                 <div class="col-md-2">
                                    <label class="radio-inline" style="font-size:13px;">
                                    <input type="radio" name="pa_pro_medication" class="pa_pro_medication" ng-model='pa_pro_medication' ng-value="1" value="1" > Yes </label>
                                    <label class="radio-inline" style="font-size:13px;">
                                    <input type="radio" name="pa_pro_medication" class="pa_pro_medication" ng-model='pa_pro_medication' ng-value="0" value="0"> No </label>
                                 </div>
                  ...
                  <div class="col-md-6">
                     <div class="pull-right">
                        <div class="form-group">
                           ...
                           <button type="submit"  class="btn blue btn-default send_quote" ng-click="customer()" ng-show="saveleadctn">Save Lead</button>
...
$(document).ready(function(){
    ...
    var plan=$("#plan-personal-accident").val();
