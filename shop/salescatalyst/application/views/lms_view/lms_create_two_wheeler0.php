             ...
             <div class="row maincontf" ng-init="loadtwowheeldata()">
               ...
               <div class="col-md-4">
                  <div class="form-group" ng-init = ' lms_car_category = "<?php echo $userDetails->Channel; ?>" '>
                     ...
                     <input list="Category" placeholder="Select Category" class="form-control input-sm" name="lms_car_category" id="lms_car_category" ng-model="lms_car_category" readonly value="<?php echo $lead_details->category?>">
            ...
            <div class="form-group">
			   ...
			   <div class="col-md-4">
                  <div class="form-group">
					 ...
					 <input list="cityRegistration" class="form-control input-sm" placeholder="City of Registration" name="lms_two_wheeler_city_registration" id="lms_two_wheeler_city_registration" value="<?php echo $lead_details->registration_city; ?>" ng-model="lms_two_wheeler_city_registration" readonly="readonly">
                 </div>
               </div>
             ...
             <div class="form-group">
               ...
               <label> Registration Date <span class="required"> * </span> </label>
					 <input class="form-control input-sm custom-date" placeholder="DD-MM-YYYY" name="lms_two_wheeler_registration_date" id="lms_two_wheeler_registration_date" ng-model="lms_two_wheeler_registration_date" value="<?php echo $lead_details->vehicle_register_date; ?>" ng-change="phoneNumberPattern()">
                   ...
                   <div class="col-md-4" ng-init = ' lms_car_tenure = "<?php echo ( $lead_details->vehicle_tenure ? $lead_details->vehicle_tenure : '' ); ?>" '>
                     <div class="form-group">
                        <label>Tenure<span class="required"> * </span></label>
                       
                        <select name="lms_car_tenure" class="form-control input-sm" id="lms_car_tenure" ng-model="lms_car_tenure" required>
                        ...
                        <div id="value_disable">
                           ...
                           <select ng-disabled="isPolicyChecker == '0' || isPolicyClaiinchecker == '0'" name="lms_car_ncb" class="form-control input-sm" id="lms_car_ncb" ng-model="lms_car_ncb" ng-required = 'isPolicyChecker == "1" && ischeckexpiryPolicyCLaim == "0" ' >
                              ...
                              <?php foreach (ncbVales() as $key => $value) { ?>
                                <option value="<?php echo $value; ?>" ng-selected = '<?php echo ($lead_details->expiring_policy_NCB == $value) ? true :false; ?>'><?php echo $value; ?></option>
                              <?php } ?>
                           </select>
                        </div>
