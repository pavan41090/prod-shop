      ...
      <div>
          ...
          <div class="col-md-8">
           ...
           <div class="row maincontf">
               <div class="col-md-4" ng-init = ' lms_car_category = "<?php echo $userDetails->Channel; ?>" '>
                  <div class="form-group">
                     <label>Category
                     </label>
                     <input list="Category" readonly placeholder="Select Category" class="form-control input-sm" name="lms_car_category" id="lms_car_category" ng-model="lms_car_category" value="<?php echo $userDetails->Channel; ?>">
