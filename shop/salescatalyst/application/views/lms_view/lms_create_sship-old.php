                ...
                <div class="form-group">
                     <div class="question">
                      <label>Include Spouse </label><span class="required"> </span>
                       <input class="Spouse_ship" type="checkbox" name="Spouse_ship" class="Spouse_ship" id="Spouse_ship" ng-model="spouse.spouse_ship" value="1" />
                   </div>
            ...
            <div class="row maincontf">
               <div class="col-md-4">
                  <div class="form-group">
                     ...
                     <input type="text" id="spouse_dob" name="spouse_dob" class="form-control input-sm custom-date-dob" placeholder="DD-MM-YYYY" ng-model="spouse.spouse_dob" required data-date-format="dd-mm-yyyy" ng-disabled="spouse_dob">
