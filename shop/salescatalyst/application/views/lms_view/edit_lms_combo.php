...
<script src="<?php echo base_url(); ?>assets/js/lms_js/lms_combo_edit_js.js"></script>
...
<hr>
         ...
         <form name="lmsCar" novalidate id="comboedit">
            <div class="portlet-title tabbable-line">
               <div class="caption leadtit">
                  <i class="icon-globe font-dark hide"></i>
            ...
            <div class="row maincontf">
               <div class="col-md-4">
                  <div class="form-group">
                     ...
                     <input list="Category" placeholder="Select Category" class="form-control input-sm" name="lms_car_category" id="lms_car_category" ng-model="lms_car_category" required readonly="readonly">
...
<!--                               <div class="form-group">
                     ...
                     <div class="form-group">
                        ...
                        <div ng-if="lmsCar.$submitted || lmsCar.hme_sum_insured.$dirty" ng-messages="lmsCar.hme_sum_insured.$error" role="alert">
               ...
               <div class="portlet-title tabbable-line">
                  ...
                  <div class="form-group">
                     ...
                     <br>
                        ...
                        <!--          <div ng-if="lmsCar.$submitted || lmsCar.pa_pro_suffered.$dirty" ng-messages="lmsCar.pa_pro_suffered.$error" role="alert">
                        ...
                        <div class="row maincontf" style="display:none">
                           <div class="col-md-12">
                              <div class="form-group">
                               ...
                               <!--   <div ng-if="lmsCar.$submitted || lmsCar.pa_pro_Sonography.$dirty" ng-messages="lmsCar.pa_pro_Sonography.$error" role="alert">
                        ...
                        <div class="row maincontf" style="display:none">
                           <div class="col-md-12">
                             ...
                             <!--     <div ng-if="lmsCar.$submitted || lmsCar.pa_pro_surgery.$dirty" ng-messages="lmsCar.pa_pro_surgery.$error" role="alert">
                        ...
                        <div class="row maincontf" style="display:none">
                           <div class="col-md-12">
                              <div class="form-group">
                                 ...
                                 <div ng-if="lmsCar.$submitted || lmsCar.pa_pro_medication.$dirty" ng-messages="lmsCar.pa_pro_medication.$error" role="alert">
                  ...
                  <div class="col-md-6">
                     <div class="pull-right">
                        <div class="form-group">
                           ...
                           <button type="submit" ng-show="updateleadhome" class="btn blue btn-default" ng-click="updateCustomer()" > Update Lead </button>
