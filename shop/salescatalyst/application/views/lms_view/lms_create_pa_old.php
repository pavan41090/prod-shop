              ...
              <div class="col-md-4">
               ...
               <div class="col-md-4">
                     ...
                     <div class="form-group">
                        ...
                        <input type="text" id="lms_house_number" name="lms_house_number" class="form-control input-sm" placeholder="House Number" ng-model="lms_house_number" required> 
         ...
         <form name="lmspaDetil" novalidate >
            <div class="carhide" id="cardeatail">
               <div class="portlet-title tabbable-line">
                  ...
                  <div class="col-md-4">
                     ...
                     <div class="form-group">
                        ...
                        <select id="lms_car_sum_insured" name="lms_car_sum_insured" class="form-control input-sm" ng-model="lms_car_sum_insured" required>
                           ...
                           <option value="25000000">2,50,00,000</option>
                           <option value="30000000">3,00,00,000</option>
                        </select>                       


                        <div ng-if="lmspaDetil.$submitted || lmspaDetil.lms_car_sum_insured.$dirty" ng-messages="lmspaDetil.lms_car_sum_insured.$error" role="alert">
                ...
                <input type="submit" class="btn blue btn-default" style="float:right;" value="continue" id="hide" ng-click="PaProductDetail()"   />
               <br><br>
                  ...
                  <div class="col-md-6">
                     <div class="pull-right">
                        <div class="form-group">
                           ...
                           <button type="submit"  class="btn blue btn-default send_quote" ng-click="paProposal()" >Save Lead</button>
                           </a>
                        </div>
                     </div>
                  </div>
