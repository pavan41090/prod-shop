<script src="<?php echo base_url(); ?>assets/js/lms_js/lms-app-sship-js.js"></script>
<input type="hidden" id="web_url" value="<?php echo base_url(); ?>">
<input type="hidden" id="product_type" value="Super Ship">
 <form name="lmsCar" novalidate id="superform">
<div class="tab-content" ng-app="plunker" ng-controller="myCtrl">
      ...
      <div>
          ...
          <div class="col-md-8">
            ...
            <div class="pull-right" style="margin-top: 10px;">
                        <a href="<?php echo base_url(); ?>lms-script-query-combo" target="_blank">
           ...
           <div class="row maincontf">
               <div class="col-md-4">
                  <div class="form-group" ng-init=' lms_car_category = "<?php echo $userDetails->Channel; ?>" '>
                     ...
                     <input list="Category" placeholder="Select Category" class="form-control input-sm" readonly name="lms_car_category" id="lms_car_category" ng-model="lms_car_category" value="<?php echo $userDetails->Channel; ?>" required>
            ...
            <div class="row maincontf">
               ...
               <div class="col-md-4">
                  <div class="form-group">
                     ...
                     <select id="lms_car_salut" name="lms_car_salut" class="form-control input-sm" ng-change =" self_salut = lms_car_salut; ship_tax_salut=lms_car_salut "  ng-model="lms_car_salut" required>
                        <option value="" disabled selected>Select your option</option>
                        <?php 
               ...
               <div class="col-md-4">
                  <div class="form-group">
                     ...
                     <span class="required"> * </span></label>  
                     <input type="text" name="lms_car_fname"  placeholder="Customer First Name" class="form-control input-sm" id="lms_car_fname" ng-change =" self_fname = lms_car_fname" ng-keyup ="ship_tax_your_name = lms_car_fname "  ng-model="lms_car_fname" required />               
               ...
               <div class="col-md-4">
                  <div class="form-group">
                     ...
                     <input type="text" name="lms_car_lname"  placeholder="Customer Last Name"   class="form-control input-sm" id="lms_car_lname" ng-change =" self_lname = lms_car_lname " ng-model="lms_car_lname" required/> 
               ...
               <div class="col-md-4">
                  ...
                  <div class="form-group">
                     ...
                     <input type="text" id="lms_car_dob" name="lms_car_dob"  class="form-control input-sm custom-date-dob" placeholder="DD-MM-YYYY" ng-model="lms_car_dob" required data-date-format="dd-mm-yyyy" ng-change =" self_dob = lms_car_dob; ship_tax_dob = lms_car_dob;"  >
               ...
               <div class="col-md-4">
                  <div class="form-group">
                     ...
                     <select  class="form-control input-sm" name="lms_car_gender" id="lms_car_gender" ng-change =" self_gender = lms_car_gender; ship_tax_gender=lms_car_gender" ng-model="lms_car_gender" required>
                        <option value="" disabled selected>Select your option</option>
               ...
               <div class="col-md-4">
                  <div class="form-group">
                     ...
                     <textarea class="form-control" placeholder="Address 1" name="lms_car_add1" rows="2" id="lms_car_add1" ng-model="lms_car_add1" ng-keyup = "ship_tax_addr1=lms_car_add1"required></textarea>
               ...
               <div class="col-md-4">
                  <div class="form-group">
                     ...
                     <textarea class="form-control"  placeholder="Address 2" name="lms_car_add2" rows="2" id="lms_car_add2" ng-model="lms_car_add2" ng-keyup = "ship_tax_addr2=lms_car_add2" required></textarea>
            ...
            <!-- details of lead moved to lead details -->
             <div class="col-md-4">
                     <div class="form-group">
                        ...
                        <input type="text" name="lms_car_pro_landmark" placeholder="Enter Nearest Land Mark" class="form-control input-sm" id="lms_car_pro_landmark" ng-model="lms_car_pro_landmark" ng-keyup="ship_tax_landmark=lms_car_pro_landmark" />
                  ...
                  <div class="col-md-4">
                     ...
                     <div class="form-group">
                        ...
                        <input type="text" id="lms_car_pro_emergency" autocomplete="off" name="lms_car_pro_emergency" class="form-control input-sm" onkeypress='return restrictAlphabets(event)' placeholder="Mobile Number" ng-model="lms_car_pro_emergency" MaxLength="10" onkeyup="return mobile_validate_emergency(this.value);" placeholder="Mobile" ng-keyup="ship_tax_fixed_line=lms_car_pro_emergency" /> 
        ...
        <div class="col-md-4">
                  <div class="form-group">
                     ...
                     <input type="email" id="lms_car_email" name="lms_car_email" class="form-control input-sm" placeholder="E-mail" ng-model="lms_car_email" onkeyup="return email_validate(this.value);" ng-keyup="ship_tax_email_id=lms_car_email" required> 
               ...
               <div class="col-md-4">
                  <div class="form-group">
                     ...
                     <select id="lms_car_pro_occupation" name="lms_car_pro_occupation" class="form-control input-sm" ng-change =" self_occupation = lms_car_pro_occupation; ship_tax_occupation=lms_car_pro_occupation " ng-model="lms_car_pro_occupation"  required>
                        <option value="" disabled selected>Select your option</option>
                       <?php 
            ...
            <!-- <input type="submit" class="btn blue btn-default" style="float:right;" value="continue"  ng-disabled="isDisabled" ng-click="customer(); customerdis()"   /> -->
            <br><br>
         <!-- </form> -->
      </div>
      ...
      <!-- <div ng-app="plunker" ng-controller="myCtrl"> -->
         <!-- <form name="lmsCar" novalidate > -->
              <div class="row" id="cardeatail">
                ...
                <div class="form-group">
                     <div class="question">
                      <label>Include Spouse </label><span class="required"> </span>
                       <input class="Spouse_ship" type="checkbox" name="Spouse_ship" class="Spouse_ship" id="Spouse_ship" ng-model="spouse.spouse_ship" value="1" ng-click="zonewisecalculation()"/>
                   </div>
                   
                  <div class="answer" ng-if="spouse.spouse_ship">
                     <label>Spouse DOB </label><span class="required">* </span>
                 <input ng-init="loadSpouseDate()" ng-change="onspousedobsubmit()" type="text" id="sship_spouse" name="sship_spouse" class="form-control input-sm custom-date-dob" required data-date-format="dd-mm-yyyy"  placeholder="Spouse Date of Birth"  ng-model="sship_spouse" >
                 <div ng-if="lmsCar.$submitted " ng-messages="lmsCar.sship_spouse.$error" role="alert">
               ...
               <div class="col-md-4">
                  <div class="form-group">
                     ...
                     <div class="radio-list">
                        <label class="radio-inline" style="font-size:12px;">
                        <input type="radio" name="noofchildrens" class="noofchildrens" ng-click="zonewisecalculation()" ng-model='noofchildrens' ng-value='0'  value="0" required> 0 </label>   
                        <label class="radio-inline" style="font-size:12px;">
                        <input type="radio" name="noofchildrens" class="noofchildrens" ng-click="zonewisecalculation()" ng-model='noofchildrens'  ng-value='1'  value="1" required> 1 </label>
                        <label class="radio-inline" style="font-size:12px;">
                        <input type="radio" name="noofchildrens" class="noofchildrens" ng-click="zonewisecalculation()" ng-model='noofchildrens'  ng-value='2'  value="2" required> 2 </label>    
                        <label class="radio-inline" style="font-size:12px;">
                        <input type="radio" name="noofchildrens" class="noofchildrens" ng-click="zonewisecalculation()" ng-model='noofchildrens'  ng-value='3'  value="3" required> 3 </label>        
                     </div>
                  </div>
               </div>
               ...
               <div class="col-md-4">
                     <div class="form-group">
                        ...
                        <span class="required"> * </span></label>
                        <div class="radio-list">
                           <input type="text" id="sship_income" name="sship_income" class="form-control input-sm" placeholder="Income (P.A)" ng-model="sship_income"
                           ng-keyup="ship_tax_income=sship_income" required /> 
                           <div ng-if="lmsCar.$submitted || lmsCar.sship_income.$dirty" ng-messages="lmsCar.sship_income.$error" role="alert">
             ...
             <div class="row maincontf">
                <div class="col-md-4">
                     <div class="form-group">
                        <label>Policy Tenure (in Years)<span class="required"> * </span></label>  

                        <select id="policyterm" name="policyterm" class="form-control input-sm" ng-model="policyterm" required>
                         <option value="" disabled selected>Select your option</option>
                        ...
                        <div ng-if="lmsCar.$submitted" ng-messages="lmsCar.policyterm.$error" role="alert">
                  ...
                  <div class="col-md-4">
                     <div class="form-group">
                              ...
                              <select id="ss_sum_insured" name="ss_sum_insured" ng-change="zonewisecalculation();criticalillnesssuminsured();" class="form-control input-sm" ng-model="ss_sum_insured"  required>
                                    <option value="" disabled selected>Select your option</option>
                                    <option value="500000">500000</option>
                                    <option value="750000">750000</option>
                                    <option value="1000000">1000000</option>
                                    </select> 
                                 <div ng-if="lmsCar.$submitted || lmsCar.ss_sum_insured.$dirty" ng-messages="lmsCar.ss_sum_insured.$error" role="alert">
                  ...
                  <div class="col-md-4">
                     <div class="form-group">
                        ...
                        <input type="text" id="lms_est_premium" name="lms_est_premium" class="form-control input-sm number-validate" placeholder="Premium Amount" ng-model="lms_est_premium">
                        <!-- <div ng-if="lmsCar.$submitted" ng-messages="lmsCar.lms_est_premium.$error" role="alert">
                ...
                <div class="form-group">
                     <div class="question">
                      ...
                      <input type="checkbox" name="ss_hospital_daily" ng-model="ss_hospital_daily" id="ss_hospital_daily" class="form-control input-sm" ng-click="zonewisecalculation()">
                   </div>
           ...
           <div class="col-md-4">
                <div class="form-group">
                     <div class="question">
                      <label>Critical Illness</label><span class="required"> </span>
                       <input type="checkbox" name="ss_critical" ng-model="ss_critical" id="ss_crtical" class="ss_critical" value="1" ng-change="criticalillnesssuminsured()"ng-click="zonewisecalculation('critical')">
                   </div>
                    <div class="answer1">
                     ...
                     <div class="form-group" >
                              <label>Sum Insured</label>
                              <span class="required"> * </span>
                              <select id="ss_sum_insured_critical" name="ss_sum_insured_critical" class="form-control input-sm  sumInsured" ng-model="ss_sum_insured_critical" ng-change="zonewisecalculation();criticalillnesssuminsured();" disabled>
									...
									<div >
                                    <div id="sumcriticalValue" class="required"></div>
                                 </div>
              </div>
              </div>              
             </div>
                ...
                <!-- <input type="submit" class="btn blue btn-default" style="float:right;" value="continue" ng-disabled="isDisabled" ng-click="shipProductDetail(); onFormSubmit(); customerdis()"   /> -->
               <br><br>
         ...
         <!-- </form> -->
           ...
           <!--  <h4 class="propsal-seperator">Propsal Details </h4>
            <hr> 
 -->
      <!-- <div ng-app="plunker" ng-controller="myCtrl"> -->
         <!-- <form name="lmsCar" novalidate > -->
              <div class="row" id="carproposal">
               <div class="portlet-title tabbable-line">
                  <div class="caption leadtit">
                     <i class="icon-globe font-dark hide"></i>
         ...
         <div class="row maincontf">
               <div class="col-md-4">
                  <div class="form-group">
                    ...
                    <!--  <div ng-if="lmsCar.$submitted || lmsCar.self_salut.$dirty" ng-messages="lmsCar.self_salut.$error" role="alert">
               ...
               <div class="col-md-4">
                  <div class="form-group">
                     ...
                     <!-- <div ng-if="lmsCar.$submitted || lmsCar.self_fname.$dirty" ng-messages="lmsCar.self_fname.$error" role="alert">
            ...
            <div class="row maincontf">
               <div class="col-md-4">
                  <div class="form-group">
                     ...
                     <!-- <div ng-if="lmsCar.$submitted || lmsCar.self_dob.$dirty" ng-messages="lmsCar.self_dob.$error" role="alert">
                     <div ng-message="required" class="required">Please Enter DOB</div>
                     </div> -->                        
                  </div>
               </div>
               ...
               <div class="col-md-4">
                  <div class="form-group">
                     ...
                     <!-- <div ng-if="lmsCar.$submitted || lmsCar.self_gender.$dirty" ng-messages="lmsCar.self_gender.$error" role="alert">
            ...
            <div class="row maincontf">
              <div class="col-md-4">
               <div class="form-group">
                     ...
                     <div ng-if="lmsCar.$submitted" ng-messages="lmsCar.sship_pro_policy_start.$error" role="alert">
               ...
               <div class="col-md-4">
                  <div class="form-group">
                     ...
                     <input type="text" name="sship_pro_height" onkeypress='return restrictAlphabets(event)' placeholder="Enter Height(in CM's)" class="form-control input-sm" id="sship_pro_height" ng-model="sship_pro_height" readonly />
                     <!-- <div ng-if="lmsCar.$submitted || lmsCar.sship_pro_height.$dirty" ng-messages="lmsCar.sship_pro_height.$error" role="alert">
               ...
               <div class="col-md-2">
                  <div class="form-group">
                     <label>Height(in feet)<span class="required">*</span></label>
                     <input type="text" name="sship_pro_height_feet" onkeypress='return restrictAlphabets(event)' placeholder="Enter Height(in feet)" class="form-control input-sm" id="sship_pro_height_feet" maxlength="1" ng-model="sship_pro_height_feet" ng-keyup="convertfeettocm()" required />
                      <div ng-if="lmsCar.$submitted || lmsCar.sship_pro_height_feet.$dirty" ng-messages="lmsCar.sship_pro_height_feet.$error" role="alert">
                        <div ng-message="required" class="required">Please Enter Height in feet</div>
                     </div>
                  </div>
               </div>
               <div class="col-md-2">
                  <div class="form-group">
                     <label>Height(in inches)<span class="required">*</span></label>
                     <input type="text" name="sship_pro_height_inches" onkeypress='return restrictAlphabets(event)' placeholder="Enter Height(in inches)" class="form-control input-sm" id="sship_pro_height_inches" maxlength="2" ng-model="sship_pro_height_inches" ng-keyup="convertfeettocm()" required />
                      <div ng-if="lmsCar.$submitted || lmsCar.sship_pro_height_inches.$dirty" ng-messages="lmsCar.sship_pro_height_inches.$error" role="alert">
                        <div ng-message="required" class="required">Please Enter Height in inches</div>
                     </div>
                  </div>
               </div>
               <div class="col-md-4">
                  <div class="form-group">
                     ...
                     <div ng-if="lmsCar.$submitted || lmsCar.sship_pro_Weight.$dirty" ng-messages="lmsCar.sship_pro_Weight.$error" role="alert">
                        <div ng-message="required" class="required">Please Enter Weight</div>
                     </div>
                  </div>
               </div>
               <!-- <div ng-change="onBmical()" ng-if="false"  ng-messages="lmsCar.$error" role="alert">
            ...
            <div class="row maincontf">
               <div class="col-md-12">
                  <div class="form-group">
                     ...
                     <div ng-if="lmsCar.$submitted || lmsCar.sship_pro_suffered.$dirty" ng-messages="lmsCar.sship_pro_suffered.$error" role="alert">
            ...
            <div class="row maincontf">
               <div class="col-md-12">
                  <div class="form-group">
                     ...
                     <div ng-if="lmsCar.$submitted || lmsCar.sship_pro_diseases.$dirty" ng-messages="lmsCar.sship_pro_diseases.$error" role="alert">
                        <div ng-message="required" class="required">Please Select</div>
                     </div>
                  </div>
               </div>
                        ...
                        <div class="row maincontf">
                           <div class="col-md-12">
                              <div class="form-group">
                                 ...
                                 <div ng-if="lmsCar.$submitted || lmsCar.sship_pro_psychiatric.$dirty" ng-messages="lmsCar.sship_pro_psychiatric.$error" role="alert">
                                    <div ng-message="required" class="required">Please Select</div>
                                 </div>
                              </div>
                           </div>
                        ...
                        <div class="row maincontf">
                           <div class="col-md-12">
                              <div class="form-group">
                                 ...
                                 <div ng-if="lmsCar.$submitted || lmsCar.sship_pro_medication.$dirty" ng-messages="lmsCar.sship_pro_medication.$error" role="alert">
                                    <div ng-message="required" class="required">Please Select</div>
                                 </div>
                              </div>
                           </div>
                        ...
                        <div class="row maincontf">
                           <div class="col-md-12">
                              <div class="form-group">
                                 ...
                                 <div ng-if="lmsCar.$submitted || lmsCar.sship_pro_fibroid.$dirty" ng-messages="lmsCar.sship_pro_fibroid.$error" role="alert">
                                    <div ng-message="required" class="required">Please Select</div>
                                 </div>
                              </div>
                           </div>
                        ...
                        <div class="row maincontf">
                           <div class="col-md-12">
                              <div class="form-group">
                                 ...
                                 <div ng-if="lmsCar.$submitted || lmsCar.sship_pro_cyst.$dirty" ng-messages="lmsCar.sship_pro_cyst.$error" role="alert">
                                    <div ng-message="required" class="required">Please Select</div>
                                 </div>
                              </div>
                           </div>
                        ...
                        <div class="row maincontf">
                           <div class="col-md-12">
                              <div class="form-group">
                                 ...
                                 <div ng-if="lmsCar.$submitted || lmsCar.sship_pro_bltest.$dirty" ng-messages="lmsCar.sship_pro_bltest.$error" role="alert">
                                    <div ng-message="required" class="required">Please Select</div>
                                 </div>
                              </div>
                           </div>
                        ...
                        <div class="row maincontf">
                           <div class="col-md-12">
                              <div class="form-group">
                                 ...
                                 <div ng-if="lmsCar.$submitted || lmsCar.sship_pro_diabetes.$dirty" ng-messages="lmsCar.sship_pro_diabetes.$error" role="alert">
                                    <div ng-message="required" class="required">Please Select</div>
                                 </div>
                              </div>
                           </div>
...
<!--        <div class="row maincontf">
         <div class="col-md-12">
            <div class="form-group">
               ...
               <div ng-if="lmsCar.$submitted || lmsCar.sship_pro_pregnant.$dirty" ng-messages="lmsCar.sship_pro_pregnant.$error" role="alert">
                  <div ng-message="required" class="required">Please Select</div>
               </div>
            </div>
         </div>
          ...
          <div class="row maincontf">  
            <div class="col-md-12">
               <div class="form-group">
                  ...
                  <div ng-if="lmsCar.$submitted || lmsCar.sship_pro_advice.$dirty" ng-messages="lmsCar.sship_pro_advice.$error" role="alert">
                     <div ng-message="required" class="required">Please Select</div>
                  </div>
               </div>
            </div>
             ...
             <div class="row maincontf">
               <div class="col-md-12">
                  <div class="form-group">
                     ...
                     <div ng-if="lmsCar.$submitted || lmsCar.sship_pro_gutka.$dirty" ng-messages="lmsCar.sship_pro_gutka.$error" role="alert">
                        <div ng-message="required" class="required">Please Select</div>
                     </div>
                  </div>
               </div>
         ...
         <div id="spouse-propsal-details" ng-if="spouse.spouse_ship">
          ...
          <div class="row maincontf">
               <div class="col-md-4">
                  <div class="form-group">
                     ...
                     <datalist id="saluteSpouse">
                      ...
                      <div ng-if="lmsCar.$submitted || lmsCar.spouse_salut.$dirty" ng-messages="lmsCar.spouse_salut.$error" role="alert">
                        <div ng-message="required" class="required">Please Enter Salutation</div>
                     </div> 
                  </div>
               </div>
               ...
               <div class="col-md-4">
                  <div class="form-group">
                     ...
                     <input type="text" name="spouse_fname"  placeholder="Spouse First Name"  class="form-control input-sm" id="spouse_fname" ng-model="spouse.spouse_fname" required/> 
                         <div ng-if="lmsCar.$submitted || lmsCar.spouse_fname.$dirty" ng-messages="lmsCar.spouse_fname.$error" role="alert">
               ...
               <div class="col-md-4">
                  <div class="form-group">
                     ...
                     <input type="text" name="spouse_lname"  placeholder="Spouse Last Name"   class="form-control input-sm" id="spouse_lname"  ng-model="spouse.spouse_lname" required/> 
                      <div ng-if="lmsCar.$submitted || lmsCar.spouse_lname.$dirty" ng-messages="lmsCar.spouse_lname.$error" role="alert">
            ...
            <div class="row maincontf">
               <div class="col-md-4">
                  <div class="form-group">
                     ...
                     <input  type="text" id="spouse_dob" name="spouse_dob" class="form-control input-sm custom-date-dob"  data-date-format="dd-mm-yyyy" placeholder="DD-MM-YYYY" ng-model="spouse_dob" readonly="readonly" >
               ...
               <div class="col-md-4">
                  <div class="form-group">
                     ...
                     <div ng-if="lmsCar.$submitted || lmsCar.spouse_gender.$dirty" ng-messages="lmsCar.spouse_gender.$error" role="alert">
               ...
               <div class="col-md-4">
                  <div class="form-group">
                     ...
                     <select id="spouse_occupation" name="spouse_occupation" class="form-control input-sm" ng-model="spouse.spouse_occupation" required>
                      ...
                      <div ng-if="lmsCar.$submitted || lmsCar.spouse_occupation.$dirty" ng-messages="lmsCar.spouse_occupation.$error" role="alert">
            ...
            <div class="row maincontf">
               <div class="col-md-4">
                  <div class="form-group">
                     <label>Spouse Height(in CM's)</label>
                     <input type="text" name="spouse_height" onkeypress='return restrictAlphabets(event)' placeholder="Enter Height(in CM's)" class="form-control input-sm" id="spouse_height" ng-model="spouse.spouse_height" readonly />
                      <!-- <div ng-if="lmsCar.$submitted || lmsCar.spouse_height.$dirty" ng-messages="lmsCar.spouse_height.$error" role="alert">
               ...
               <div class="col-md-2">
                  <div class="form-group">
                     <label>Spouse Height(in feet)<span class="required"> * </span></label>
                     <input type="text" name="spouse_height_feet" onkeypress='return restrictAlphabets(event)' placeholder="Enter Height(in feet)" class="form-control input-sm" id="spouse_height_feet" maxlength="1" ng-model="spouse.spouse_height_feet" ng-keyup="convertfeettocm()" required/>
                       <div ng-if="lmsCar.$submitted || lmsCar.spouse_height_feet.$dirty" ng-messages="lmsCar.spouse_height_feet.$error" role="alert">
                        <div ng-message="required" class="required">Please Enter Spouse Height in feet</div>
                     </div>
                  </div>
               </div>
               <div class="col-md-2">
                  <div class="form-group">
                     <label>Spouse Height(in inches)<span class="required"> * </span></label>
                     <input type="text" name="spouse_height_inches" onkeypress='return restrictAlphabets(event)' placeholder="Enter Height(in inches)" class="form-control input-sm" id="spouse_height_inches" maxlength="2" ng-model="spouse.spouse_height_inches" ng-keyup="convertfeettocm()" required/>
                      <div ng-if="lmsCar.$submitted || lmsCar.spouse_height_inches.$dirty" ng-messages="lmsCar.spouse_height_inches.$error" role="alert">
                        <div ng-message="required" class="required">Please Enter Spouse Height in inches</div>
                     </div>
                  </div>
               </div>
               ...
               <div class="col-md-4">
                  <div class="form-group">
                     ...
                     <input type="text" name="spouse_weight" onkeypress='return restrictAlphabets(event)' placeholder="EnterWeight(in KG's)" class="form-control input-sm" id="spouse_weight" ng-model="spouse.spouse_weight"  required/>
                      <div ng-if="lmsCar.$submitted || lmsCar.spouse_weight.$dirty" ng-messages="lmsCar.spouse_weight.$error" role="alert">
          ...
          <div class="row maincontf">
               <div class="col-md-4">
                  <div class="form-group">
                     ...
                     <div ng-if="lmsCar.$submitted || lmsCar.child1_salut.$dirty" ng-messages="lmsCar.child1_salut.$error" role="alert">
               ...
               <div class="col-md-4">
                  <div class="form-group">
                     <label>Child 1 First Name <span class="required"> * </span></label>  
                     ...
                     <div ng-if="lmsCar.$submitted || lmsCar.child1_fname.$dirty" ng-messages="lmsCar.child1_fname.$error" role="alert">
               ...
               <div class="col-md-4">
                  <div class="form-group">
                     ...
                     <div ng-if="lmsCar.$submitted || lmsCar.child1_lname.$dirty" ng-messages="lmsCar.child1_lname.$error" role="alert">
            ...
            <div class="row maincontf">
               <div class="col-md-4">
                  <div class="form-group">
                     <label>Child 1 DOB <spam class="required">*</spam> </label>
                     <input ng-init="child1Age()" type="text" id="child1_dob" name="child1_dob" class="form-control input-sm custom-date-dob" placeholder="DD-MM-YYYY" ng-model="child1.child1_dob" ng-change="calculateChildAge()" required data-date-format="dd-mm-yyyy">
                     <div ng-if="lmsCar.$submitted " ng-messages="lmsCar.child1_dob.$error" role="alert">
               ...
               <div class="col-md-4">
                  <div class="form-group">
                     ...
                     <div ng-if="lmsCar.$submitted || lmsCar.child1_gender.$dirty" ng-messages="lmsCar.child1_gender.$error" role="alert">
               ...
               <!-- <div class="col-md-4">
                  <div class="form-group">
                     ...
                     <select id="child1_occupation" name="child1_occupation" class="form-control input-sm" ng-model="child1_occupation" >
                        <option value="" disabled selected>Select your option</option>
               ...
               <div class="col-md-4">
                  <div class="form-group">
                     <label>Child 1 Height(in CM's)</label>
                     <input type="text" name="child1_height" onkeypress='return restrictAlphabets(event)' placeholder="Enter Height(in CM's)" class="form-control input-sm" id="child1_height" ng-model="child1.child1_height" readonly />
                     <!-- <div ng-if="lmsCar.$submitted || lmsCar.child1_height.$dirty" ng-messages="lmsCar.child1_height.$error" role="alert">
            ...
            <div class="row maincontf">
               <div class="col-md-2">
                  <div class="form-group">
                     <label>Child 1 Height(in feet)<span class="required"> * </span></label>
                     <input type="text" name="child1_height_feet" onkeypress='return restrictAlphabets(event)' placeholder="Enter Height(in feet)" class="form-control input-sm" id="child1_height_feet" maxlength="1" ng-model="child1.child1_height_feet" ng-keyup="convertfeettocm()" ng-required="cyears1>12"/>
                      <div ng-if="lmsCar.$submitted || lmsCar.child1_height_feet.$dirty" ng-messages="lmsCar.child1_height_feet.$error" role="alert">
                        <div ng-message="required" class="required">Please Enter Child 1 Height in feet</div>
                     </div>
                  </div>
               </div>
               <div class="col-md-2">
                  <div class="form-group">
                     <label>Child 1 Height(in inches)<span class="required"> * </span></label>
                     <input type="text" name="child1_height_inches" onkeypress='return restrictAlphabets(event)' placeholder="Enter Height(in inches)" class="form-control input-sm" id="child1_height" maxlength="2" ng-model="child1.child1_height_inches" ng-keyup="convertfeettocm()" ng-required="cyears1>12"/>
                      <div ng-if="lmsCar.$submitted || lmsCar.child1_height_inches.$dirty" ng-messages="lmsCar.child1_height_inches.$error" role="alert">
                        <div ng-message="required" class="required">Please Enter Child 1 Height in inches</div>
                     </div>
                  </div>
               </div>
               <div class="col-md-4">
                  <div class="form-group">
                     ...
                     <input type="text" name="child1_weight" onkeypress='return restrictAlphabets(event)' placeholder="EnterWeight(in KG's)" class="form-control input-sm" id="child1_weight" ng-model="child1.child1_weight" ng-required="cyears1>12"/>
                     <div ng-if="lmsCar.$submitted || lmsCar.child1_weight.$dirty" ng-messages="lmsCar.child1_weight.$error" role="alert">
            ...
            <div class="col-md-12">
               <div class="form-group">
                  ...
                  <div class="col-md-2">
                     ...
                     <label class="radio-inline" style="font-size:13px;">
                     <input type="radio" name="child1.child1_pregnant" ng-model='child1.child1_pregnant' class="child1_pregnant" ng-value="0" value="0" /> No </label>
                  </div>
          ...
          <div class="row maincontf">
               <div class="col-md-4">
                  <div class="form-group">
                     ...
                     <input list="child2Spouse" id="child2_salut" placeholder="Salutation" name="child2_salut" class="form-control input-sm" ng-model="child2.child2_salut" required >{{child2_salut}}
                     ...
                     <div ng-if="lmsCar.$submitted || lmsCar.child2_salut.$dirty" ng-messages="lmsCar.child2_salut.$error" role="alert">
               ...
               <div class="col-md-4">
                  <div class="form-group">
                     ...
                     <input type="text" name="child2_fname"  placeholder="First Name"  class="form-control input-sm" id="child2_fname" ng-model="child2.child2_fname" required /> {{child2_fname}}
                     <div ng-if="lmsCar.$submitted || lmsCar.child2_fname.$dirty" ng-messages="lmsCar.child2_fname.$error" role="alert">
               ...
               <div class="col-md-4">
                  <div class="form-group">
                     ...
                     <div ng-if="lmsCar.$submitted || lmsCar.child2_lname.$dirty" ng-messages="lmsCar.child2_lname.$error" role="alert">
            ...
            <div class="row maincontf">
               <div class="col-md-4">
                  <div class="form-group">
                     ...
                     <input ng-init="child2Age()" type="text" id="child2_dob" name="child2_dob" class="form-control input-sm custom-date-dob" placeholder="DD-MM-YYYY" ng-model="child2.child2_dob" ng-change="calculateChildAge()" required data-date-format="dd-mm-yyyy" >
                     <div ng-if="lmsCar.$submitted || lmsCar.child2_dob.$dirty" ng-messages="lmsCar.child2_dob.$error" role="alert">
               ...
               <div class="col-md-4">
                  <div class="form-group">
                     ...
                     <div ng-if="lmsCar.$submitted || lmsCar.child2_gender.$dirty" ng-messages="lmsCar.child2_gender.$error" role="alert">
               ...
               <div class="col-md-4">
                  <div class="form-group">
                     <label>Child 2 Height(in CM's)</label>
                     <input type="text" name="child2_height" onkeypress='return restrictAlphabets(event)' placeholder="Enter Height(in CM's)" class="form-control input-sm" id="child2_height" ng-model="child2.child2_height" readonly />
                     <!-- <div ng-if="lmsCar.$submitted || lmsCar.child2_height.$dirty" ng-messages="lmsCar.child2_height.$error" role="alert">
            ...
            <div class="row maincontf">
               <div class="col-md-2">
                  <div class="form-group">
                     <label>Child 2 Height(in feet)<span class="required"> * </span></label>
                     <input type="text" name="child2_height_feet" onkeypress='return restrictAlphabets(event)' placeholder="Enter Height(in feet)" class="form-control input-sm" id="child2_height_feet" maxlength="1" ng-model="child2.child2_height_feet" ng-keyup="convertfeettocm()" ng-required="cyears2>12"/>
                      <div ng-if="lmsCar.$submitted || lmsCar.child2_height_feet.$dirty" ng-messages="lmsCar.child2_height_feet.$error" role="alert">
                        <div ng-message="required" class="required">Please Enter Child 2 Height in feet</div>
                     </div> 
                  </div>
               </div>
               <div class="col-md-2">
                  <div class="form-group">
                     <label>Child 2 Height(in inches)<span class="required"> * </span></label>
                     <input type="text" name="child2_height_inches" onkeypress='return restrictAlphabets(event)' placeholder="Enter Height(in inches)" class="form-control input-sm" id="child2_height_inches" maxlength="2" ng-model="child2.child2_height_inches" ng-keyup="convertfeettocm()" ng-required="cyears2>12" />
                     <div ng-if="lmsCar.$submitted || lmsCar.child2_height_inches.$dirty" ng-messages="lmsCar.child2_height_inches.$error" role="alert">
                        <div ng-message="required" class="required">Please Enter Child 2 Height in inches</div>
                     </div> 
                  </div>
               </div>
               <div class="col-md-4">
                  <div class="form-group">
                     ...
                     <input type="text" name="child2_weight" onkeypress='return restrictAlphabets(event)'  placeholder="EnterWeight(in KG's)" class="form-control input-sm" id="child2_weight" ng-model="child2.child2_weight" 
                     ng-required="cyears2>12" />
                     <div ng-if="lmsCar.$submitted || lmsCar.child2_weight.$dirty" ng-messages="lmsCar.child2_weight.$error" role="alert">
          ...
          <div class="row maincontf">
               <div class="col-md-4">
                  <div class="form-group">
                     ...
                     <div ng-if="lmsCar.$submitted || lmsCar.child3_salut.$dirty" ng-messages="lmsCar.child3_salut.$error" role="alert">
               ...
               <div class="col-md-4">
                  <div class="form-group">
                     ...
                     <div ng-if="lmsCar.$submitted || lmsCar.child3_fname.$dirty" ng-messages="lmsCar.child3_fname.$error" role="alert">
               ...
               <div class="col-md-4">
                  <div class="form-group">
                    ...
                    <div ng-if="lmsCar.$submitted || lmsCar.child3_lname.$dirty" ng-messages="lmsCar.child3_lname.$error" role="alert">
            ...
            <div class="row maincontf">
               <div class="col-md-4">
                  <div class="form-group">
                     ...
                     <input ng-init="child3Age()" type="text" id="child3_dob" name="child3_dob" class="form-control input-sm custom-date-dob" placeholder="DD-MM-YYYY" ng-model="child3.child3_dob" ng-change="calculateChildAge()" required data-date-format="dd-mm-yyyy">
                     <div ng-if="lmsCar.$submitted || lmsCar.child3_dob.$dirty" ng-messages="lmsCar.child3_dob.$error" role="alert">
               ...
               <div class="col-md-4">
                  <div class="form-group">
                     ...
                     <div ng-if="lmsCar.$submitted || lmsCar.child3_gender.$dirty" ng-messages="lmsCar.child3_gender.$error" role="alert">
               ...
               <!-- <div class="col-md-4">
                ...
                <div class="col-md-4">
                  <div class="form-group">
                     <label>Child 3 Height(in CM's) </label>
                     <input type="text" name="child3_height" onkeypress='return restrictAlphabets(event)'  placeholder="Enter Height(in CM's)" class="form-control input-sm" id="child3_height" ng-model="child3.child3_height" readonly/>
                     <!-- <div ng-if="lmsCar.$submitted || lmsCar.child3_height.$dirty" ng-messages="lmsCar.child3_height.$error" role="alert">
            ...
            <div class="row maincontf">
              <div class="col-md-2">
                  <div class="form-group">
                     <label>Child 3 Height(in feet)<span class="required"> * </span></label>
                     <input type="text" name="child3_height_feet" onkeypress='return restrictAlphabets(event)'  placeholder="Enter Height(in feet)" class="form-control input-sm" id="child3_height_feet" maxlength="1" ng-model="child3.child3_height_feet" ng-keyup="convertfeettocm()" ng-required="cyears3>12"/>
                     <div ng-if="lmsCar.$submitted || lmsCar.child3_height_feet.$dirty" ng-messages="lmsCar.child3_height_feet.$error" role="alert">
                        <div ng-message="required" class="required">Please Enter Child 3 Height in feet</div>
                     </div>
                  </div>
               </div>
               <div class="col-md-2">
                  <div class="form-group">
                     <label>Child 3 Height(in inches)<span class="required"> * </span></label>
                     <input type="text" name="child3_height_inches" onkeypress='return restrictAlphabets(event)'  placeholder="Enter Height(in inches)" class="form-control input-sm" id="child3_height_inches" maxlength="2" ng-model="child3.child3_height_inches" ng-keyup="convertfeettocm()" ng-required="cyears3>12"/>
                     <div ng-if="lmsCar.$submitted || lmsCar.child3_height_inches.$dirty" ng-messages="lmsCar.child3_height_inches.$error" role="alert">
                        <div ng-message="required" class="required">Please Enter Child 3 Height in inches</div>
                     </div>
                  </div>
               </div>
               <div class="col-md-4">
                  <div class="form-group">
                     ...
                     <input type="text" name="child3_weight"  onkeypress='return restrictAlphabets(event)' placeholder="EnterWeight(in KG's)" class="form-control input-sm" id="child3_weight" ng-model="child3.child3_weight" 
                     ng-required="cyears3>12" />
                     <div ng-if="lmsCar.$submitted || lmsCar.child3_weight.$dirty" ng-messages="lmsCar.child3_weight.$error" role="alert">
...
<!-- 
      ...
      <div class="row maincontf">
         <div class="col-md-12">
            <div class="form-group">
               <label> Is the proposer or the persons proposed, already insured under a plan with Bharti AXA General Insurance Company Limited or any other insurance company? If yes, please share below the Policy/ Application number(s). Please mention application number in case of pending proposal.</label>
      ...
      <div class="row maincontf">
         <div class="col-md-12">
            <div class="form-group">
               <div class="col-md-6">
                     <label>Do you want us to consider these details for portability?</label>
               </div>
               <div class="col-md-2">
                  <label class="radio-inline" style="font-size:13px;">
                  <input type="radio" name="pre_ins_portability" ng-model='pre_ins_portability' class="pre_ins_portability" ng-value="0" value="0" /> Yes </label>
                  <label class="radio-inline" style="font-size:13px;">
                  <input type="radio" name="pre_ins_portability" ng-model='pre_ins_portability' class="pre_ins_portability" ng-value="1" value="1" /> No </label>
               </div>
            </div>
         </div>
      </div>
   ...
   <div class="row maincontf" id="portability_div">
      <div class="col-md-12">
         <table border="1" class="table">
            <tr align="center">
               ...
               <td>To </td>
               <td>Sum Insured </td>
               <td>Claims lodged during <br/> the preceding 3 years </td>
               <td>Cumulative Bonus </td>
            </tr>
            <tr>
               <td><input type="text" name="port_insurer_name1" ng-model="port_insurer_name1" class="form-control input-sm" ></td>
               <td><input type="text" name="port_policy_number1" ng-model="port_policy_number1" class="form-control input-sm" ></td>
               <td><input type="text" name="port_start_date1" ng-model="port_start_date1" class="form-control input-sm custom-date-dob"  data-date-format="dd-mm-yyyy" ></td>
               <td><input type="text" name="port_end_date1" ng-model="port_end_date1" class="form-control input-sm custom-date-dob"  data-date-format="dd-mm-yyyy" ></td>
               <td><input type="text" name="port_sum_insured1" ng-model="port_sum_insured1" class="form-control input-sm" ></td>
               <td><input type="text" name="port_claim_lodged1" ng-model="port_claim_lodged1" class="form-control input-sm" ></td>
               <td><input type="text" name="port_cumulative_bonus1" ng-model="port_cumulative_bonus1" class="form-control input-sm" ></td>
            </tr>

            <tr>
               <td><input type="text" name="port_insurer_name2" ng-model="port_insurer_name2" class="form-control input-sm" ></td>
               <td><input type="text" name="port_policy_number2" ng-model="port_policy_number2" class="form-control input-sm" ></td>
               <td><input type="text" name="port_start_date2" ng-model="port_start_date2" class="form-control input-sm custom-date-dob"  data-date-format="dd-mm-yyyy" ></td>
               <td><input type="text" name="port_end_date2" ng-model="port_end_date2" class="form-control input-sm custom-date-dob"  data-date-format="dd-mm-yyyy" ></td>
               <td><input type="text" name="port_sum_insured2" ng-model="port_sum_insured2" class="form-control input-sm" ></td>
               <td><input type="text" name="port_claim_lodged2" ng-model="port_claim_lodged2" class="form-control input-sm" ></td>
               <td><input type="text" name="port_cumulative_bonus2" ng-model="port_cumulative_bonus2" class="form-control input-sm" ></td>
            </tr>
         </table>
      </div>
   </div> 
     ...
     <h4 class="propsal-seperator">Family Doctor's Details,if any</h4>
         ...
         <div class="row maincontf">
            <div class="col-md-4">
               <div class="form-group">
                 ...
                 <!--  <div ng-if="lmsCar.$submitted || lmsCar.sship_pro_doc_name.$dirty" ng-messages="lmsCar.sship_pro_doc_name.$error" role="alert">
            ...
            <div class="col-md-4">
               <div class="form-group">
                  ...
                  <!-- <div ng-if="lmsCar.$submitted || lmsCar.sship_pro_doc_qualifi.$dirty" ng-messages="lmsCar.sship_pro_doc_qualifi.$error" role="alert">
            ...
            <div class="col-md-4">
               <div class="form-group">
                  ...
                  <!-- <div ng-if="lmsCar.$submitted || lmsCar.sship_pro_doc_addr.$dirty" ng-messages="lmsCar.sship_pro_doc_addr.$error" role="alert">
                     <div ng-message="required" class="required">Please Enter Address</div>
                  </div> -->
               </div>
         ...
         <div class="row maincontf">
            <div class="col-md-4">
             ...
             <input type="text" id="sship_pro_doc_mobile" name="sship_pro_doc_mobile" class="form-control input-sm" placeholder="Enter Mobile Number" ng-model="sship_pro_doc_mobile" MaxLength="10" onkeyup="mobile_validate(this.value);">
                  <!--  <div ng-if="lmsCar.$submitted || lmsCar.sship_pro_doc_mobile.$dirty" class="required" id="mobilewar" ng-messages="lmsCar.sship_pro_doc_mobile.$error" role="alert">
            ...
            <div class="col-md-4">
             ...
             <input type="text" id="sship_pro_hos_num" name="sship_pro_hos_num" class="form-control input-sm" placeholder="Clinic / Hospital Number" ng-model="sship_pro_hos_num" MaxLength="10" onkeyup="mobile_validate(this.value);">
                  <!--  <div ng-if="lmsCar.$submitted || lmsCar.sship_pro_hos_num.$dirty" class="required" id="mobilewar" ng-messages="lmsCar.sship_pro_hos_num.$error" role="alert">
         ...
         <div class="row maincontf">
            <div class="col-md-4">
               <div class="form-group">
                  ...
                  <div ng-if="lmsCar.$submitted || lmsCar.sship_pro_nname.$dirty" ng-messages="lmsCar.sship_pro_nname.$error" role="alert">
            ...
            <div class="col-md-4">
               <div class="form-group">
                  ...
                  <div ng-if="lmsCar.$submitted || lmsCar.sship_pro_nomie_relation.$dirty" ng-messages="lmsCar.sship_pro_nomie_relation.$error" role="alert">
            ...
            <div class="col-md-4">
               <div class="form-group">
                  ...
                  <input type="text" name="sship_pro_nameofappoint" placeholder="EnterName Of Appointee" class="form-control input-sm" id="sship_pro_nameofappoint" ng-model="sship_pro_nameofappoint" >
                   <!-- <div ng-if="lmsCar.$submitted || lmsCar.sship_pro_nameofappoint.$dirty" ng-messages="lmsCar.sship_pro_nameofappoint.$error" role="alert">
         ...
         <div class="row maincontf">  
           <div class="col-md-4">
               <div class="form-group">
                  ...
                  <!-- <div ng-if="lmsCar.$submitted || lmsCar.sship_pro_appoint_relation.$dirty" ng-messages="lmsCar.sship_pro_appoint_relation.$error" role="alert">
            ...
            <div class="col-md-4">
                              <div class="form-group">
                                 ...
                                 <div ng-if="lmsCar.$submitted || lmsCar.sship_pro_nomie_age.$dirty" ng-messages="lmsCar.sship_pro_nomie_age.$error" role="alert">
      ...
      <div class="row maincontf">
            ...
            <div class="form-group">
               ...
               <div class="col-md-2" ng-init="ship_tax_primary_insured='0'">
                  <label class="radio-inline" style="font-size:13px;">
                  <input type="radio" ng-change="autoPopulate()" name="ship_tax_primary_insured" ng-model='ship_tax_primary_insured' class="ship_tax_primary_insured" ng-value="1" value="1" /> Yes </label>
                  <label class="radio-inline" style="font-size:13px;">
                  <input type="radio" ng-change="autoPopulate()"  name="ship_tax_primary_insured" ng-model='ship_tax_primary_insured' class="ship_tax_primary_insured" ng-value="0" value="0"  /> No </label>
               </div>
            ...
            <div class="row maincontf" ng-init="autoPopulate()">
               <div class="col-md-4">
                  <div class="form-group">
                     ...
                     <!--  <div ng-if="lmsCar.$submitted || lmsCar.ship_tax_salut.$dirty" ng-messages="lmsCar.ship_tax_salut.$error" role="alert">
                        <div ng-message="required" class="required">Please Enter Salutation</div>
                     </div> --> 
                  </div>
               </div>
              ...
              <!--  <div ng-if="lmsCar.$submitted || lmsCar.ship_tax_your_name.$dirty" ng-messages="lmsCar.ship_tax_your_name.$error" role="alert">
                        <div ng-message="required" class="required">Please Enter Customer First Name</div>
                     </div> --> 
                  </div>
               </div>
               <div class="col-md-4">
                  <div class="form-group">
                     ...
                     <select id="ship_tax_primary_relation" name="ship_tax_primary_relation" class="form-control input-sm" ng-model="ship_tax_primary_relation" >
                       ...
                       <div ng-if="lmsCar.$submitted || lmsCar.ship_tax_primary_relation.$dirty" ng-messages="lmsCar.ship_tax_primary_relation.$error" role="alert">
                        <div ng-message="required" class="required">Please Enter Relationship</div>
                     </div> 
                  </div>
               </div>
            ...
            <div class="row maincontf">
               ...
               <div class="col-md-4">
                  <div class="form-group">
                     ...
                     <input type="text" name="ship_tax_dob"  placeholder="Date Of Birth"  class="form-control input-sm" id="ship_tax_dob" ng-model="ship_tax_dob">               
                      <!-- <div ng-if="lmsCar.$submitted || lmsCar.ship_tax_dob.$dirty" ng-messages="lmsCar.ship_tax_dob.$error" role="alert">
               ...
               <div class="col-md-4">
                  <div class="form-group">
                    ...
                    <!--  <div ng-if="lmsCar.$submitted || lmsCar.ship_tax_gender.$dirty" ng-messages="lmsCar.ship_tax_gender.$error" role="alert">
               ...
               <div class="col-md-4">
                  <div class="form-group">
                   ...
                   <!--   <div ng-if="lmsCar.$submitted || lmsCar.ship_tax_addr1.$dirty" ng-messages="lmsCar.ship_tax_addr1.$error" role="alert">
            ...
            <div class="row maincontf">
               ...
               <div class="col-md-4">
                  <div class="form-group">
                     ...
                     <!--  <div ng-if="lmsCar.$submitted || lmsCar.ship_tax_addr2.$dirty" ng-messages="lmsCar.ship_tax_addr2.$error" role="alert">
                        <div ng-message="required" class="required">Please enter Date Of Birth</div>
                     </div> --> 
                  </div>
               </div>
               ...
               <div class="col-md-4">
                  <div class="form-group">
                     ...
                     <input type="text" name="ship_tax_landmark" id="ship_tax_landmark"  placeholder="Landmark"  class="form-control input-sm" ng-model="ship_tax_landmark" >               
                      <!-- <div ng-if="lmsCar.$submitted || lmsCar.ship_tax_landmark.$dirty" ng-messages="lmsCar.ship_tax_landmark.$error" role="alert">
               ...
               <div class="col-md-4">
                  <div class="form-group">
                     <label>Fixed Line Contact No</label>  
                     <input type="text" name="ship_tax_fixed_line" id="ship_tax_fixed_line"  placeholder="Fixed Line Contact No"  class="form-control input-sm" MaxLength="10" ng-model="ship_tax_fixed_line" >               
                      <!-- <div ng-if="lmsCar.$submitted || lmsCar.ship_tax_fixed_line.$dirty" ng-messages="lmsCar.ship_tax_fixed_line.$error" role="alert">
            ...
            <div class="row maincontf">
               ...
               <div class="col-md-4">
                  <div class="form-group">
                    ...
                    <!--  <div ng-if="lmsCar.$submitted || lmsCar.ship_tax_mobile_no.$dirty" ng-messages="lmsCar.ship_tax_mobile_no.$error" role="alert">
                        <div ng-message="required" class="required">Please Enter Mobile number</div>
                     </div> --> 
                  </div>
               </div>  
               ...
               <div class="col-md-4">
                  <div class="form-group">
                     ...
                     <!-- <div ng-if="lmsCar.$submitted || lmsCar.ship_tax_email_id.$dirty" ng-messages="lmsCar.ship_tax_email_id.$error" role="alert">
               ...
               <div class="col-md-4">
                  <div class="form-group">
                     ...
                     <div class="radio-list">
                        <label class="radio-inline" style="font-size:13px;">
                        <input type="radio" name="ship_tax_nationality" ng-model="ship_tax_nationality"  value="1"  required > Yes </label>
                        <label class="radio-inline" style="font-size:13px;">
                        <input type="radio"  name="ship_tax_nationality" ng-model="ship_tax_nationality"  value="0"  required > No </label>
                         <div ng-if="lmsCar.$submitted || lmsCar.ship_tax_nationality.$dirty" ng-messages="lmsCar.ship_tax_nationality.$error" role="alert">
            ...
            <div class="row maincontf">
               <div class="col-md-4">
                  <div class="form-group">
                     ...
                     <!--  <div ng-if="lmsCar.$submitted || lmsCar.ship_tax_occupation.$dirty" ng-messages="lmsCar.ship_tax_occupation.$error" role="alert">
                        <div ng-message="required" class="required">Please Select Occupation</div>
                     </div>  -->
                  </div>
               </div>
               ...
               <div class="col-md-4">
                  <div class="form-group">
                    ...
                    <!--  <div ng-if="lmsCar.$submitted || lmsCar.ship_tax_income.$dirty" ng-messages="lmsCar.ship_tax_income.$error" role="alert">
...
<!--                      <div ng-if="lmsCar.$submitted || lmsCar.ship_tax_PPC_no.$dirty" ng-messages="lmsCar.ship_tax_PPC_no.$error" role="alert">
               ...
               <div class="row lmsresbor">
                  <div class="form-group">
                     <div class="col-md-12">
                        ...
                        <div ng-if="lmsCar.$submitted || lmsCar.declaration.$dirty" ng-messages="lmsCar.declaration.$error" role="alert">
                  ...
                  <div class="col-md-6">
                     <div class="pull-right">
                        <div class="form-group">
                           ...
                           <button type="submit"  class="btn blue btn-default send_quote" ng-show="savelead" ng-click="customer()" >Save Lead</button>
                           <button type="submit"  class="btn blue btn-default send_quote" ng-show="pleasewait" >Please Wait...</button>
                           </a>
                        </div>
                     </div>
                  </div>
...
<script>
      ...
      $('#lms_aaa_number').keypress(function (e) {
         ...
         /*$("#ss_sum_insured").on('change', function() {
      ...
      switch(sumInsured){
         ...
         case'500000':
            $('#lms_est_premium').val('3835');
            break;
         case'750000':
            $('#lms_est_premium').val('7670');
            break;
         case'1000000':
            $('#lms_est_premium').val('11505');
            break;
