            ...
            <div class="form-group">
			   ...
			   <div class="col-md-4">
                  <div class="form-group">
					 ...
					 <input list="" class="form-control input-sm" placeholder="City of Registration" name="lms_two_wheeler_city_registration" id="lms_two_wheeler_city_registration" value="" ng-model="lms_two_wheeler_city_registration">
                 </div>
				...
				<div class="col-md-4" ng-init='lms_two_wheeler_registration_date=""'>
                   ...
                   <div class="col-md-4">
                     <div class="form-group" ng-init = ' lms_car_tenure = "1" '>
                        ...
                        <select name="lms_car_tenure" readonly class="form-control input-sm" id="lms_car_tenure" ng-model="lms_car_tenure">
                              <?php for($l=1;$l>=1;$l--){ ?>
