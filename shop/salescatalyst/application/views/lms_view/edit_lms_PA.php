<script src="<?php echo base_url(); ?>assets/js/lms_js/lms_pa_create_js.js"></script>
<script src="<?php echo base_url(); ?>assets/js/lms_js/lms_pa_edit_js.js"></script>
...
<hr>
         ...
         <div class="col-md-4">
                  <div class="form-group">
                     <label> State </label>
                     <input list="state" id="lms_car_state" placeholder="Enter State"  autocomplete="off" name="lms_car_state" class="form-control input-sm" ng-model="lms_car_state"  >
                   <!--  <datalist id="state">
               ...
               <div class="col-md-4">
                  <div class="form-group">
                     ...
                     <div class="radio-list">
                        ...
                        <input type="radio" name="lms_car_cus_type" disabled="corporate" value="corporate" id="lms_car_cus_type_corporate"> Corporate </label>
                        <label class="radio-inline" style="font-size:13px;">
                        <input type="radio" name="lms_car_cus_type" id="lms_car_cus_type_individual" checked value="individual" required> Individual </label>
                ...
                <div class="row maincontf">
                     ...
                     <div class="form-group">
                        ...
                        <select id="lms_car_sum_insured" name="lms_car_sum_insured" class="form-control input-sm" ng-model="lms_car_sum_insured"  required>
                           <option value="" disabled selected>Select your option</option>
                           <?php foreach (pasuminsuredvalue() as $key => $value) { ?>
                  ...
                  <div class="col-md-6">
                     <div class="pull-right">
                        <div class="form-group">
                           ...
                           <button type="submit"  ng-show="updateleadhome" class="btn blue btn-default send_quote" ng-click="updateCustomer()" >Update Lead</button>
                           <button type="button" class="btn blue btn-default" ng-show="updateleadhomeprg"> Please wait.. </button>
                           </a>
                        </div>
                     </div>
                  </div>
	 ...
	 /**** change premium amount *******/
      ...
      switch(sumInsured){
         ...
         case'7500000':
            ...
            break;
         case'10000000':
            $('#lms_est_premium').val('15340');
            break;
         case'15000000':
            $('#lms_est_premium').val('23010');
            break;
         case'20000000':
            $('#lms_est_premium').val('30680');
            break;
         case'25000000':
            $('#lms_est_premium').val('38350');
            break; 
         case'30000000':
            $('#lms_est_premium').val('46020');
            break;     
         }
   });  
	 /*** close here ******/
