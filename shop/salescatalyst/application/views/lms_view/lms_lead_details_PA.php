                  ...
                  <div>
                      ...
                      <div class="box lmsresult">
                          <div class="row lmsresbor">
                            ...
                            <div class="col-md-4">
                                  <div class="row">
                                     <div class="col-md-5 labeltxtleft"> Bundle Premium </div>
                                      <div class="col-md-5">: <?php echo $bundleData->bundle_premium_amount ; ?>   </div>
                                  </div>
                                 </div>
                            ...
                            <div class="col-md-4">
                                 ...
                                 <div class="col-md-4">
                                  <div class="row">
                                     <div class="col-md-5 labeltxtleft"> Child 1 DOB </div>
                                      <div class="col-md-5">: <?php  echo($bundleData->bundle_child_s!='0' ?  $bundleData->bundle_child_one_dob: '' ); ?>   </div>
                                  </div>
                                 </div>
                                 ...
                                 <div class="col-md-4">
                                  <div class="row">
                                     <div class="col-md-5 labeltxtleft"> Child 1 Name </div>
                                      <div class="col-md-5">: <?php echo($bundleData->bundle_child_s!='0' ?  $bundleData->bundle_child_one_name: '');?>   </div>
                                  </div>
                                 </div>
                                 ...
                                 <div class="col-md-4">
                                  <div class="row">
                                     <div class="col-md-5 labeltxtleft"> Child 2 DOB </div>
                                      <div class="col-md-5">: <?php echo($bundleData->bundle_child_s!='0' ?  $bundleData->bundle_child_two_dob: ''); ?>   </div>
                                  </div>
                                 </div>
                                 ...
                                 <div class="col-md-4">
                                  <div class="row">
                                     <div class="col-md-5 labeltxtleft"> Child 2 Name </div>
                                      <div class="col-md-5">: <?php echo($bundleData->bundle_child_s!='0' ?  $bundleData->bundle_child_two_name: ''); ?>   </div>
                                  </div>
                                 </div>
                                 ...
                                 <div class="col-md-4">
                                  <div class="row">
                                     <div class="col-md-5 labeltxtleft"> Bundle Tenure </div>
                                 ...
                                 <div class="col-md-4">
                                  <div class="row">
                                   ...
                                   <div class="col-md-4">
                                  <div class="row">
                                     <div class="col-md-5 labeltxtleft"> UPP Long Term </div>
                                      <div class="col-md-5">: <?php echo ($bundleData->bundle_include_upp ? 'Yes' : 'No') ; ?>   </div>
                                  </div>
                                 </div>

                                  <div class="col-md-4">
                                  <div class="row">
                                     <div class="col-md-5 labeltxtleft"> UPP Loan Type </div>
                                      <div class="col-md-5">: <?php if($bundleData->bundle_include_upp!=0) {echo ($bundleData->bundle_upp_type_of_loan == 1 ? 'Personal Loan' : 'Bussiness Loan'); } ?>
                                   </div>
                                  </div>
                                 </div>
                                 ...
                                 <div class="col-md-4">
                                  <div class="row">
                                     <div class="col-md-5 labeltxtleft"> UPP Loan Amount </div>
                                      <div class="col-md-5">: <?php if($bundleData->bundle_include_upp!=0) { echo $bundleData->bundle_upp_loan_amount ; }?>   </div>
                                  </div>
                                 </div>

                                 <div class="col-md-4">
                                  <div class="row">
                                     <div class="col-md-5 labeltxtleft"> UPP Tenure </div>
                                      <div class="col-md-5">: <?php $tenurearray = getupplongterm(); if($bundleData->bundle_include_upp!=0) { echo $tenurearray[$bundleData->bundle_upp_tenure]; } ?> 
                                     </div>
                                  </div>
                                 </div>
                                 ...
                                 <div class="col-md-4">
                                  <div class="row">
                                     <div class="col-md-5 labeltxtleft"> UPP Premium Amount </div>
                                      <div class="col-md-5">: <?php if($bundleData->bundle_include_upp!=0) {echo $bundleData->bundle_upp_total_prem; } ?>
                                   </div>
                                  </div>
                                 </div>
                                 ...
                                 <div class="col-md-4">
                                  <div class="row">
                                     <div class="col-md-5 labeltxtleft">Total Premium</div>
                                      <div class="col-md-5">: <?php echo ($bundleData->total_premium == 0 ? $lead_details[0]->lms_premium  : $bundleData->total_premium); ?>
                                   </div>
                                  </div>
                                 </div>
...
<!-- 
              <?php if($logged_user_type == 'bagi_av'){ ?>
                ...
                <div class="portlet-title">
                  <div class="caption">Auto Debit Authorization </div>
               </div>
            ...
            <div class="form-group">
              <div class="row">
                  <div class="col-md-12" ng-init=' auto_debit = "<?php echo $lead_details[0]->autodebit_authorization; ?>"'>
                  <label> Do you authorize to auto renew your policy with your existing credit card at the time of renewal before expiry</label> &nbsp;
                  <input type="checkbox" name="auto_debit" id="auto_debit"  ng-model="auto_debit" ng-value="1" ng-checked="auto_debit=='1'" />
                     </div> 
                     </div>   
...
<script type="text/javascript">
   ...
   $("#auto_debit").on('click', function(){
    var abc=$("#auto_debit").val();
console.log(abc);
