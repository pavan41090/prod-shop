           ...
           <div class="row maincontf">
               <div class="col-md-4">
                  <div class="form-group" ng-init = ' lms_car_category = "<?php echo $userDetails->Channel; ?>" '>
                     ...
                     <input list="Category" placeholder="Select Category" class="form-control input-sm" name="lms_car_category" id="lms_car_category" ng-model="lms_car_category" value="<?php echo $userDetails->Channel; ?>" required readonly>
...
$('#lms_car_sum_insured').on('change', function (e) {
   ...
   if((valueSelected == 1500000) && (customerAge >= 45) ){
      alert("Customer has to undergo medical test as per the plan");
      return false;
  }
