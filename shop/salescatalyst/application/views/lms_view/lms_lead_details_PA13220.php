                                 ...
                                 <div class="col-md-4">
                                  <div class="row">
                                     <div class="col-md-5 labeltxtleft"> Child 1 DOB </div>
                                      <div class="col-md-5">: <?php  echo($bundleData->bundle_child_s=='1' ?  $bundleData->bundle_child_one_dob: '' ); ?>   </div>
                                  </div>
                                 </div>
                                 ...
                                 <div class="col-md-4">
                                  <div class="row">
                                     <div class="col-md-5 labeltxtleft"> Child 1 Name </div>
                                      <div class="col-md-5">: <?php echo($bundleData->bundle_child_s=='1' ?  $bundleData->bundle_child_one_name: '');?>   </div>
                                  </div>
                                 </div>
                                 ...
                                 <div class="col-md-4">
                                  <div class="row">
                                     <div class="col-md-5 labeltxtleft"> Child 2 DOB </div>
                                      <div class="col-md-5">: <?php echo($bundleData->bundle_child_s=='2' ?  $bundleData->bundle_child_two_dob: ''); ?>   </div>
                                  </div>
                                 </div>
                                 ...
                                 <div class="col-md-4">
                                  <div class="row">
                                     <div class="col-md-5 labeltxtleft"> Child 2 Name </div>
                                      <div class="col-md-5">: <?php echo($bundleData->bundle_child_s=='2' ?  $bundleData->bundle_child_two_name: ''); ?>   </div>
                                  </div>
                                 </div>
