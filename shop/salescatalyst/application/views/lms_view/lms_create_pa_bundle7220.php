...
<!--first continue button removed -->
      ...
      <div class="row maincontf">
            ...
            <input type="checkbox" click:Premium:Data id="lms_bundle_upp" name="lms_bundle_upp" class="lms_bundle_upp" ng-model="lms_bundle_upp" ng-value='"1"' value="1"  ng-checked = 'lms_bundle_upp == "1"'>
      ...
      <div ng-if="lms_bundle_upp == '1'">
             ...
             <div class="col-md-3">
                  <div class="form-group" ng-init=' lms_bundle_upp_type_loan = "<?php echo ($bundleData->bundle_upp_type_of_loan ? $bundleData->bundle_upp_type_of_loan : ''); ?>" '>
                    ...
                    <select id="lms_bundle_upp_type_loan" name="lms_bundle_upp_type_loan" class="form-control input-sm" ng-model="lms_bundle_upp_type_loan" change:Premium:Data required>
         ...
         <div class="col-md-3">
            <div class="form-group" ng-init =' lms_bundle_upp_loan_amount = "<?php echo $bundleData->bundle_upp_loan_amount; ?>" '>
                     ...
                     <input type="text" placeholder="Loan Amount" class="form-control input-sm" name="lms_bundle_upp_loan_amount" id="lms_bundle_upp_loan_amount" ng-model="lms_bundle_upp_loan_amount" value="<?php echo $lead_details->cust_email; ?>" upp:loan:amount change:Premium:Data required>
         ...
         <div class="col-md-3">
            <div class="form-group" ng-init=' lms_bundle_upp_age = "<?php echo $lead_details->cust_age; ?>" '>
                   ...
                   <div class="col-md-3" ng-init = ' lms_bundle_upp_tenure = "<?php echo ($bundleData->bundle_upp_tenure ? $bundleData->bundle_upp_tenure : ''); ?>" '>
                     <div class="form-group">
                        <label>Tenure<span class="required"> * </span></label>
                        <select name="lms_bundle_upp_tenure" class="form-control input-sm" id="lms_bundle_upp_tenure" ng-model="lms_bundle_upp_tenure" upp:loan:amount change:Premium:Data required>
      ...
      <div class="row maincontf">
            <div class="portlet-title tabbable-line">
                 ...
                 <div class="col-md-4">
                     <div class="form-group" ng-init = ' lms_est_premium = "<?php echo ($lead_details->lms_premium? $lead_details->lms_premium : '0');?>" '>
