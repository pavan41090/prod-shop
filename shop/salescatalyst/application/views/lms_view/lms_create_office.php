...
<input type="hidden" id="product_type" value="Office">
...
<!--                <div class="col-md-4">
            ...
            <div class="row maincontf">
               <div class="col-md-4">
                  <div class="form-group">
                     <label> State </label>
                     <input list="state" id="lms_car_state" placeholder="Select State"  autocomplete="off" name="lms_car_state" class="form-control input-sm" ng-model="lms_car_state" >
                   <!--  <datalist id="state">
              ...
              <!-- Details of lead moved to lead deails -->
      ...
      <div ng-app="plunker" ng-controller="myCtrl">
         <form name="lmsofficeDetil" novalidate >
              ...
              <div class="row maincontf">
               ...
               <div class="form-group">
                                <label>Type of Building Construction</label>
                                 <span class="required"> * </span>
                                <select id="office_building_type" name="office_building_type" class="form-control input-sm" ng-model="office_building_type"  required>
                                    <option value="" disabled selected>Select your option</option>
                                    <option value="Kutcha">Kutcha</option>
                                    <option value="Standard">Standard</option>
                                    
                                  </select> 
                                 <div ng-if="lmsofficeDetil.$submitted || lmsofficeDetil.office_building_type.$dirty" ng-messages="lmsofficeDetil.office_building_type.$error" role="alert">
               ...
               <div class="col-md-4">
                  <div class="form-group">
                                <label>Property Ownership</label>
                                 <span class="required"> * </span>
                                <select id="office_property_ownership" name="office_property_ownership" class="form-control input-sm" ng-model="office_property_ownership"  required>
                                    <option value="" disabled selected>Select your option</option>
                                    <option value="Owned">Owned</option>
                                    <option value="Rented">Rented</option>
                                    
                                  </select> 
                                 <div ng-if="lmsofficeDetil.$submitted || lmsofficeDetil.office_property_ownership.$dirty" ng-messages="lmsofficeDetil.office_property_ownership.$error" role="alert">
               ...
               <div class="col-md-4">
                     <div class="form-group">
                                <label>Do you have any claims in previous year</label>
                                 <span class="required"> * </span>
                                <select id="office_previous_claims" name="office_previous_claims" class="form-control input-sm" ng-model="office_previous_claims"  required>
                                    <option value="" disabled selected>Select your option</option>
                                    <option value="yes">Yes</option>
                                    <option value="no">No</option>
                                    
                                  </select> 
                                 <div ng-if="lmsofficeDetil.$submitted || lmsofficeDetil.office_previous_claims.$dirty" ng-messages="lmsofficeDetil.office_previous_claims.$error" role="alert">
                  ...
                  <div class="col-md-4">
                     <div class="form-group">
                                <label>No of Floors</label>
                                 <span class="required"> * </span>
                                <input type="text" name="office_no_of_floors" placeholder="No of Floors " class="form-control input-sm number-validate" id="office_no_of_floors" ng-model="office_no_of_floors" required />
                                 <div ng-if="lmsofficeDetil.$submitted || lmsofficeDetil.office_no_of_floors.$dirty" ng-messages="lmsofficeDetil.office_no_of_floors.$error" role="alert">
                  ...
                  <div class="col-md-4">
                     <div class="form-group">
                                <label>Year of construction</label>
                                 <span class="required"> * </span>
                                <input type="text" name="office_year_of_construction" placeholder="Year of construction" class="form-control input-sm number-validate" id="office_year_of_construction" ng-model="office_year_of_construction" required />
                                 <div ng-if="lmsofficeDetil.$submitted || lmsofficeDetil.office_year_of_construction.$dirty" ng-messages="lmsofficeDetil.office_year_of_construction.$error" role="alert">
                  ...
                  <div class="col-md-4">
                     <div class="form-group">
                                <label>Sum Insured</label>
                                 <span class="required"> * </span>
                                <select id="office_sum_insured" name="office_sum_insured" class="form-control input-sm" ng-model="office_sum_insured"  required>
                                    <option value="" disabled selected>Select your option</option>
                                 ...
                                 <div ng-if="lmsofficeDetil.$submitted || lmsofficeDetil.office_sum_insured.$dirty" ng-messages="lmsofficeDetil.office_sum_insured.$error" role="alert">
         ...
         <div class="row maincontf">
            <div class="form-group">
                  ...
                  <input class="Spouse_ship" type="checkbox" name="office_risk_address_same" id="office_risk_address_same"  ng-model="office_risk_address_same" value="1"  />
                      </div>
                  ...
                  <div class="col-md-4">
                     <div class="form-group">
                                <label>Risk Address 1</label>
                                 <span class="required"> * </span>
                                 <input type="text" name="office_risk_address1" placeholder="Risk Address 1" class="form-control input-sm" id="office_risk_address1" ng-model="office_risk_address1"/>
                                <!--  <div ng-if="lmshomeDetil.$submitted || lmshomeDetil.office_risk_address1.$dirty" ng-messages="lmshomeDetil.office_risk_address1.$error" role="alert"> -->
                                    <div id="office_risk_address1_error" class="required"></div>
                                <!--  </div> -->
                              </div>
                  </div>
                  ...
                  <div class="col-md-4">
                     <div class="form-group">
                                <label>Risk Address 2</label>
                                 <span class="required"> * </span>
                               <input type="text" name="office_risk_address2" placeholder="Risk Address 2 " class="form-control input-sm" id="office_risk_address2" ng-model="office_risk_address2"/>
                               <!--   <div ng-if="lmshomeDetil.$submitted || lmshomeDetil.office_risk_address2.$dirty" ng-messages="lmshomeDetil.office_risk_address2.$error" role="alert"> -->
                                    <div id="office_risk_address2_error" class="required"></div>
                                 <!-- </div> -->
                              </div>
                  </div>
                  ...
                  <div class="col-md-4">
                     <div class="form-group">
                       <label>Risk Area</label>
                        <span class="required"> * </span>
                       <input type="text" name="office_risk_area" placeholder="Risk Area " class="form-control input-sm" id="office_risk_area" ng-model="office_risk_area" />
<!--                         <div ng-if="lmshomeDetil.$submitted || lmshomeDetil.office_risk_area.$dirty" ng-messages="lmshomeDetil.office_risk_area.$error" role="alert">
 -->                           <div id="office_risk_area_error" class="required"></div>
                        </div>
<!--                      </div>
 -->                  </div>
                  ...
                  <div class="col-md-4">
                     <div class="form-group">
                          <label>Risk Pincode</label>
                           <span class="required"> * </span>
                           <input type="text" name="office_risk_pincode" placeholder="Risk Pincode" class="form-control input-sm number-validate" id="office_risk_pincode" ng-model="office_risk_pincode" />
<!--                            <div ng-if="lmshomeDetil.$submitted || lmshomeDetil.office_risk_pincode.$dirty" ng-messages="lmshomeDetil.office_risk_pincode.$error" role="alert">
 -->                              <div id="office_risk_pincode_error" class="required"></div>
<!--                            </div>
 -->                        </div>
                  </div>
                  ...
                  <div class="col-md-4">
                     <div class="form-group">
                          <label>Risk State</label>
                           <span class="required"> * </span>
                         <input type="text" name="office_risk_state" placeholder="Risk State" class="form-control input-sm" id="office_risk_state" ng-model="office_risk_state" />
<!--                            <div ng-if="lmshomeDetil.$submitted || lmshomeDetil.office_risk_state.$dirty" ng-messages="lmshomeDetil.office_risk_state.$error" role="alert">
 -->                              <div id="office_risk_state_error" class="required"></div>
<!--                            </div>
 -->                        </div>
                  </div>
                  ...
                  <div class="col-md-4">
                     <div class="form-group">
                          <label>Risk City</label>
                           <span class="required"> * </span>
                          <input type="text" name="office_risk_city" placeholder="Risk City " class="form-control input-sm" id="office_risk_city" ng-model="office_risk_city" />
<!--                            <div ng-if="lmshomeDetil.$submitted || lmshomeDetil.office_risk_city.$dirty" ng-messages="lmshomeDetil.office_risk_city.$error" role="alert">
 -->                              <div id="office_risk_city_error" class="required"></div>
                        <!--    </div>
 -->                        </div>
                  </div>
                  ...
                  <div class="col-md-4">
                     <div class="form-group">
                       <label>Risk Nearest Land Mark</label>
                        <span class="required"> * </span>
                        <input type="text" name="office_risk_nearest_land_mark" placeholder="Risk Nearest Land Mark" class="form-control input-sm" id="office_risk_nearest_land_mark" ng-model="office_risk_nearest_land_mark" />
<!--                         <div ng-if="lmshomeDetil.$submitted || lmshomeDetil.office_risk_nearest_land_mark.$dirty" ng-messages="lmshomeDetil.office_risk_nearest_land_mark.$error" role="alert">
 -->                           <div id="office_risk_nearest_land_mark_error" class="required"></div>
<!--                         </div>
 -->                     </div>
                  </div>
...
<?php for( $p = 1; $p < 5;  $p++ ) { ?>
   ...
   <div class="row maincontf">
      <div class="col-md-2">
         <div class="form-group">
            <input type="text" name="office_long_des  <?php echo $p; ?>" placeholder="Long Description" class="form-control input-sm" id="office_long_des<?php echo $p; ?>" ng-model="office_long_des<?php echo $p; ?>"  />
      ...
      <div class="col-md-2">
         <div class="form-group">
            <input type="text" name="office_assets_damage<?php echo $p;?>" placeholder="Damages" class="form-control input-sm" id="office_assets_damage<?php echo $p;?>" ng-model="office_assets_damage<?php echo $p;?>"  />
         </div>
      </div>
      
      <div class="col-md-2">
         <div class="form-group">
            <input type="text" name="office_cause_loss<?php echo $p; ?>" placeholder="Cause of loss" class="form-control input-sm" id="office_cause_loss<?php echo $p; ?>" ng-model="office_cause_loss<?php echo $p; ?>"  />
         </div>
      </div>
      ...
      <div class="col-md-1">
         <div class="form-group">
           ...
           <select id="office_ins_place<?php echo $p; ?>" name="office_ins_place<?php echo $p; ?>" class="form-control input-sm" ng-model="office_ins_place<?php echo $p; ?>" >
               <option value="" disabled selected>Select</option>
               <option value="Yes" selected>Yes</option>
               <option value="No">No</option>
            </select> 

      <!--       <input type="text" name="office_ins_place<?php //echo $p; ?>" placeholder="Insurance" class="form-control input-sm" id="office_ins_place<?php //echo $p; ?>" ng-model="office_ins_place<?php //echo $p; ?>"  /> -->
         </div>
      </div>
      
      <div class="col-md-2">
         <div class="form-group">
            <input type="text" name="office_policy_yr<?php echo $p; ?>" placeholder="Policy" class="form-control input-sm" id="office_policy_yr<?php echo $p; ?>" ng-model="office_policy_yr<?php echo $p; ?>"  />
         </div>
      </div>
      ...
      <div class="col-md-1">
         <div class="form-group">
           ...
           <select id="office_ins_claim<?php echo $p; ?>" name="office_ins_claim<?php echo $p; ?>" class="form-control input-sm" ng-model="office_ins_claim<?php echo $p; ?>" >
               <option value="" disabled selected>Select</option>
               <option value="Yes" selected>Yes</option>
               <option value="No">No</option>
            </select> 
<!-- 
            <input type="text" name="office_ins_claim<?php // echo $p; ?>" placeholder="Sum Insured" class="form-control input-sm" id="office_ins_claim<?php // echo $p; ?>" ng-model="office_ins_claim<?php // echo $p; ?>"  /> -->
         </div>
      </div>
      <div class="col-md-2">
         <div class="form-group">
            <input type="text" name="office_loss_amt<?php echo $p; ?>" placeholder="Loss" class="form-control input-sm" id="office_loss_amt<?php echo $p; ?>" ng-model="office_loss_amt<?php echo $p; ?>"  />
         </div>
      </div>
   </div>
...
<?php } ?>   
               ...
               <input type="submit" class="btn blue btn-default" style="float:right;" value="continue" id="hide" ng-click="officeProductDetail()"   />
               <br><br>
      ...
      <div ng-app="plunker" ng-controller="myCtrl">
         <form name="lmsOfficeProposal" novalidate >
            <div class="carhide" id="carproposal">
               <div class="portlet-title tabbable-line">
                  ...
                  <div class="form-group">
                     ...
                     <input type="text" id="office_pro_policy_sdate"  name="office_pro_policy_sdate" class="form-control input-sm custom-date" placeholder="DD-MM-YYYY" ng-model="office_pro_policy_sdate" required data-date-format="dd-mm-yyyy">
                     <div ng-if="lmsOfficeProposal.$submitted" ng-messages="lmsOfficeProposal.office_pro_policy_sdate.$error" role="alert">
                     ...
                     <hr>
                           ...
                           <div class="col-md-4">
                              <div class="form-group">
                                 ...
                                 <span class="required"> * </span></label>
                                 <input type="text" name="office_pro_nname" placeholder="Enter Name of Nominee " class="form-control input-sm" id="office_pro_nname" ng-model="office_pro_nname" required />
                                 <div ng-if="lmsOfficeProposal.$submitted || lmsOfficeProposal.office_pro_nname.$dirty" ng-messages="lmsOfficeProposal.office_pro_nname.$error" role="alert">
                           ...
                           <div class="col-md-4">
                              <div class="form-group">
                                 ...
                                 <span class="required"> * </span></label>
                                 <select id="office_pro_nomie_relation" name="office_pro_nomie_relation" class="form-control input-sm" ng-model="office_pro_nomie_relation"  required>
                                    <option value="" disabled selected>Select your option</option>
                                 ...
                                 <div ng-if="lmsOfficeProposal.$submitted || lmsOfficeProposal.office_pro_nomie_relation.$dirty" ng-messages="lmsOfficeProposal.office_pro_nomie_relation.$error" role="alert">
                           ...
                           <div class="col-md-4">
                              <div class="form-group">
                                 ...
                                 <input type="text" name="office_pro_nomie_age" maxlength="2" placeholder="Enter Nominee Age" class="form-control input-sm age-validate" id="office_pro_nomie_age" ng-model="office_pro_nomie_age" required/>
                                 <div ng-if="lmsOfficeProposal.$submitted || lmsOfficeProposal.office_pro_nomie_age.$dirty" ng-messages="lmsOfficeProposal.office_pro_nomie_age.$error" role="alert">
                        ...
                        <div class="row maincontf">
                           <div class="col-md-4">
                              <div class="form-group">
                                 ...
                                 <input type="text" name="office_pro_nameofappoint" placeholder="EnterName Of Appointee" class="form-control input-sm" id="office_pro_nameofappoint" ng-model="office_pro_nameofappoint" />
                                  <!-- <div ng-if="lmsOfficeProposal.$submitted || lmsOfficeProposal.office_pro_nameofappoint.$dirty" ng-messages="lmsofficeProposal.lmsOfficeProposal.$error" role="alert"> -->
                          ...
                          <div class="col-md-4">
                              <div class="form-group">
                                 ...
                                 <select id="office_pro_appoint_relation" name="office_pro_appoint_relation" class="form-control input-sm" ng-model="office_pro_appoint_relation">
                                    <option value="" disabled selected>Select your option</option>
                                    <option value="Father">Father</option>
                                    <option value="Mother">Mother</option>
                                    <option value="Brother">Brother</option>
                 ...
                 <div class="row lmsresbor">
                     <div class="form-group">
                        <div class="col-md-12">
                           ...
                           <div ng-if="lmsOfficeProposal.$submitted || lmsOfficeProposal.declaration.$dirty" ng-messages="lmsOfficeProposal.declaration.$error" role="alert">
                        ...
                        <div class="col-md-12">
                           ...
                           <div ng-if="lmsOfficeProposal.$submitted || lmsOfficeProposal.premiumPayment.$dirty" ng-messages="lmsOfficeProposal.premiumPayment.$error" role="alert">
                ...
                <!--      <div class="form-group">
                  ...
                  <div class="col-md-6">
                     <div class="pull-right">
                        <div class="form-group">
                           <a href="" >
                           <!-- <button type="submit"  class="btn blue btn-default" ng-click="officeProposalDetail()" >Save Lead</button> -->
                           <input type="submit" class="btn blue btn-default"  value="Save Lead" id="hide" ng-click="officeProposalDetail()"   />
                           </a>
                        </div>
                     </div>
                  </div>
...
jQuery(document).ready(function() { 
   $("#office_building_type").on('change', function() { 
   ...
   $("#office_risk_address_same").on('change', function() { 

      if($(this).is(":checked")) {
         
         $('#office_risk_address1').val($('#lms_car_add1').val());
         $('#office_risk_address2').val($('#lms_car_add2').val());
         $('#office_risk_area').val($('#lms_car_area').val());
         $('#office_risk_pincode').val($('#lms_car_zip').val());
         $('#office_risk_state').val($('#lms_car_state').val());
         $('#office_risk_city').val($('#lms_car_city').val());
         $('#office_risk_nearest_land_mark').val($('#lms_car_pro_landmark').val());

         $('#office_risk_address1_error').html('');
         $('#office_risk_address2_error').html('');
         $('#office_risk_area_error').html('');
         $('#office_risk_pincode_error').html('');
         $('#office_risk_state_error').html('');
         $('#office_risk_city_error').html('');
         $('#office_risk_nearest_land_mark_error').html('');

      } else {
         $('#office_risk_address1').val('');
         $('#office_risk_address2').val('');
         $('#office_risk_area').val('');
         $('#office_risk_pincode').val('');
         $('#office_risk_state').val('');
         $('#office_risk_city').val('');
         $('#office_risk_nearest_land_mark').val('');
      }
      
   });  
  
   $("#office_risk_address1").on('click', function() { $('#office_risk_address1_error').html(''); });   
   $("#office_risk_address2").on('click', function() { $('#office_risk_address2_error').html(''); });   
   $("#office_risk_area").on('click', function() { $('#office_risk_area_error').html(''); });   
   $("#office_risk_pincode").on('click', function() { $('#office_risk_pincode_error').html(''); });   
   $("#office_risk_state").on('click', function() { $('#office_risk_state_error').html(''); });   
   $("#office_risk_city").on('click', function() { $('#office_risk_city_error').html(''); });   
   $("#office_risk_nearest_land_mark").on('click', function() { $('#office_risk_nearest_land_mark_error').html(''); });   



   $('#office_previous_claims').on('change',function(){
   ...
   $('#office_year_of_construction').on('change',function(){
   ...
   $("#office_sum_insured").on('change', function() {
...
$(document).ready(function(){
    ...
    var plan=$("#plan-office").val();
    if(plan!==undefined && plan != ""){
      var planSplit=plan.split(",");
      $('#office_sum_insured').empty();
      $('#office_sum_insured').append('<option value="" disabled selected>Select your option</option>');
      for (var i=0;i<planSplit.length;i++){
       $('#office_sum_insured').append('<option value="'+planSplit[i]+'">'+planSplit[i]+'</option>');
      }
    }
});
</script>
