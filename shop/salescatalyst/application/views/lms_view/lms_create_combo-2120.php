<script src="<?php echo base_url(); ?>assets/js/lms_js/lms_combo_create_js.js"></script>
<input type="hidden" id="web_url" value="<?php echo base_url(); ?>">
<input type="hidden" id="product_type" value="Combo">

 <div class="tab-content">
   <div class="tab-pane fade active in" id="car">
       <div ng-app="plunker" ng-controller="myCtrl">
         <form name="lmsCar" novalidate id="comboform">                         
         <div class="row">
          <div class="col-md-8">
...
<!--                <div class="col-md-4">
                  <div class="form-group">
                     ...
                     <span class="required"> * </span></label>                  
                     <input list="Priority " placeholder="select Priority" class="form-control input-sm" name="lms_car_priority" id="lms_car_priority" ng-model="lms_car_priority">
...
<!--                <div class="col-md-4">
               ...
               <div class="col-md-4">
                  <div class="form-group">
                     ...
                     <div ng-if="lmsCar.$submitted || lmsCar.lms_car_zip.$dirty" class="required" id="post" ng-messages="lmsCar.lms_car_zip.$error" role="alert">
                        ...
                        <span  ng-show="lmsCar.lms_car_zip.$error.pattern">Not valid number!</span>
                     </div>
                  </div>
               </div>
               <div class="col-md-4">
               ...
               <div class="col-md-4">
                  ...
                  <div class="form-group">
                     ...
                     <input type="text" id="lms_car_mobile" autocomplete="off" name="lms_car_mobile" class="form-control input-sm" placeholder="Mobile Number" onkeypress='return restrictAlphabets(event)' ng-model="lms_car_mobile" MaxLength="10" onkeyup="return mobile_validate(this.value);" placeholder="Mobile" mobile:Number:Duplicate required /> 
      ...
      <div>
               ...
               <div class="portlet-title tabbable-line">
                  <div class="caption leadtit">
                     <i class="icon-globe font-dark hide"></i>
                     <span class="caption-subject font-dark bold uppercase">Combo Insurance Details</span>
                  </div>
               </div>
                <div class="row maincontf">
                  <div class="col-md-4">
                     ...
                     <div class="form-group">
                        ...
                        <select id="lms_car_sum_insured" name="lms_car_sum_insured" class="form-control input-sm" ng-model="lms_car_sum_insured"  required>
                           <option value="" disabled selected>Select your option</option>
                        ...
                        <div ng-if="lmsCar.$submitted || lmsCar.lms_car_sum_insured.$dirty" ng-messages="lmsCar.lms_car_sum_insured.$error" role="alert">
...
<!--                 <div class="form-group">
                        ...
                        <div ng-if="lmsCar.$submitted || lmsCar.gainful.$dirty" ng-messages="lmsCar.gainful.$error" role="alert">
      ...
      </div><!--second continue button remove -->
      ...
      <div>
               ...
               <div class="portlet-title tabbable-line">
                  <div class="caption leadtit">
                     <i class="icon-globe font-dark hide"></i>
                     <span class="caption-subject font-dark bold uppercase">Combo Insurance Proposal</span>
                  </div>
               </div>
                  ...
                  <div class="form-group">
                     ...
                     <div ng-if="lmsCar.$submitted" ng-messages="lmsCar.pa_pro_policy_sdate.$error" role="alert">
                     ...
                     <div class="pull-right">
                        <div class="form-group">
                          <a href="<?php echo base_url(); ?>qms-car-proposal-view" >
                           <button type="submit" ng-show="savelead" class="btn blue btn-default" ng-click="customer()" > Save Lead </button>
                           <button type="button" class="btn blue btn-default" ng-show="saveleadprg"> Please wait.. </button>
                           </a>
                        </div>
                     </div>
               </div>
...
$('#lms_car_sum_insured').on('change', function (e) {
...
$('#lms_car_zip').on('keyup',function(){
   ...
   $("#lms_car_sum_insured").on('change', function() {
...
$(document).ready(function(){
    ...
    var plan=$("#plan-combo").val();
    if(plan!==undefined && plan != ""){
      var planSplit=plan.split(",");
      $('#lms_car_sum_insured').empty();
      $('#lms_car_sum_insured').append('<option value="" disabled selected>Select your option</option>');
      for (var i=0;i<planSplit.length;i++){
       $('#lms_car_sum_insured').append('<option value="'+planSplit[i]+'">'+planSplit[i]+'</option>');
      }
    }
});
</script>
