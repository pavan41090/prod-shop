...
<div class="container-fluid">
   <div class="row">
      <div class="col-md-12">
         ...
         <?php
         $thisProductsData = $this->db->select('*')->where('prdt_m_status',1)->get('tbl_product_master');
         $resultData = $thisProductsData->result();
         ?>
                      <?php foreach($resultData as $prdt) { ?>
                     <?php $getPlanData = $this->db->where(array('prdt_m_id'=>$prdt->prdt_m_id,'user_id'=>$this->uri->segment(2)))->get('tbl_user_prdt_privilage')->row_object(); ?>
                          <div class="row maincontf planClass">
                             <div class="col-md-1">&nbsp;</div>
                             <div class="col-md-2">
                             ...
                             <div class="col-md-1 text-center">
                                <!-- <?php $checked = ''; if($getPlanData->privilage == '1') { $checked  = 'checked'; } ?> -->
                             ...
                             <div class="col-md-6">
                              ...
                              <?php $checkedArr=explode(",",$getPlanData->plan); ?>
                              ...
                              <?php if($prdt->prdt_m_name == 'Shop'  || $prdt->prdt_m_name == 'Combo'){?>
                              ...
                              <?php if($prdt->prdt_m_name == 'Personal Accident'){?>
                              <label><input type="checkbox" <?php if(in_array("20000000", $checkedArr)){echo "checked";} ?>  name="<?php echo $prdt->prdt_m_id; ?>20000000"  value="20000000"> 2,00,00,000</label>
                              <?php } ?>
