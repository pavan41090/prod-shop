        ...
        controller : function($scope,$http){
          ...
          $scope.cmdInserting = function(resCount,upload_path,startCount){
            try{
              ...
              $http({
                      url : __pathname+'admin-imd-lead-doc-data',
                      method : 'POST',
                      cache : false,
                      data : $.param( startObj ),
                      dataType : 'json',
          ...
          $scope.createLeadSubmit = function(_thisPolicy){
            ...
            __parentUplaoder.html('Please wait Uploading is in process');
                  $http({
                    url : __pathname+'admin-imd-excel-upload',
              method : 'POST',
              cache : false,
              data : formData,
              dataType : 'json',
                     ...
                     <form name="leaedExcelStatus" novalidate lead:Admin:Excel:Uploader>
                        <div class="portlet-title tabbable-line" >
                           <div class="caption leadtit">
                              <div class="alert bold uppercase" id="alert-response"> Upload Users Imd with password Sheet </div>
                          ...
                          <div class="col-md-3"> &nbsp; </div>
                           <div class="col-md-6 text-left">
                              <div class="form-group">
                                 <label>Upload Users Imd with password Excel
