         ...
         <div class="col-md-12">
            <div class="portlet box gray-gray">
               <div class="portlet-title">
                  <div class="caption">Quote Proposal Home </div>
               </div>
               ...
               <div class="col-md-6"> : <?php echo $home_FirstName ?> </div>
               </div>
               <div class="row paysep">
               <div class="col-md-6" >Last Name</div>
               <div class="col-md-6">: <?php echo $home_LastName ?> </div>
               </div>
                <div class="row paysep">
               <div class="col-md-6" >Mobile Number</div>
               <div class="col-md-6">: <?php echo $home_mobile ?> </div>
               </div>
                <div class="row paysep">
               <div class="col-md-6" >E-mail id</div>
               <div class="col-md-6">:<?php echo $home_email ?>  </div>
               </div>
                <div class="row paysep">
               <div class="col-md-6" >Address</div>
               <div class="col-md-6">: <?php echo $home_pro_add1 ?></div>
               </div>
                <div class="row paysep">
               <div class="col-md-6" >City</div>
               <div class="col-md-6">: <?php echo $home_city ?> </div>
               </div>
                <div class="row paysep">
               <div class="col-md-6" >State</div>
               <div class="col-md-6">:<?php echo $home_state ?> </div>
               </div>
               <div class="row paysep">
               <div class="col-md-6" >Pincode</div>
               <div class="col-md-6">:<?php echo $home_zip ?></div>
               </div>
               <div class="paysep1">&nbsp;</div>
               ...
               <div class="col-md-6">:<?php echo $home_pro_policy_sdate ?> </div>
               </div>
                <div class="row paysep">
                ...
                <div class="col-md-12">
                 ...
                 <div class="row">
                           ...
                           <div class="form-group">
                                <a href="<?php echo base_url();?>qms-home-proposal">
