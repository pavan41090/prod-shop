...
<input type="hidden" id="web_url" value="<?php echo base_url(); ?>">
                    ...
                    <input type="hidden" id="quote_type" name="quote_type" value="PA">
      ...
      <div class="row">
         <div class="col-md-12">
            <div class="portlet box gray-gray">
               ...
               <div class="row">
               <div class="col-md-6">
               <div class="prosoalrestxt">Thank you for choosing Bharti AXA General Insurance. You will receive your policy document via email. Kindly take note of the following reference numbers  in the event you do not receive your policy. We are available at 080-49010200 for any assistance.</div>
...
<input type="hidden" id="load_model" data-toggle="modal" data-target="#myModal">
                           ...
                           <div class="col-md-6">
                              <div class="pull-right">
                                 <div class="form-group">
                                     <a href="<?php echo base_url();?>Quotehome/sess_clrHome"  >
                                    <button type="submit"  class="btn blue btn-default" >Back to Home</button>
                                    </a>
                                 </div>
                              </div>
                           </div>
