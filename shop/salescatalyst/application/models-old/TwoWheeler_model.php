...
class TwoWheeler_model extends CI_Model {
	...
	public function __construct()
	{
	    ...
	    define('password','AZg3Q1SktWKLz0Os/H0MlAxFfI75pjnpKjn9xrV9vimyyS7/5Ilil/ftcP5oHxC7IFYLVF0C3MAJcIznwrZvDA==');
	}
	...
	public function getmodelvariantdata($vmmake){
		try{
			...
			$variantInfo = $this->db->get('tbl_variant_manfatcure');
			return $variantInfo;
	...
	public function __callCurl($makename,$modelname,$productname,$varianttypename,$stateCodeName,$manyear){
		...
		try{
			...
			$callxmlData = "<Envelope xmlns=\"http://schemas.xmlsoap.org/soap/envelope/\"><Body><getIDV xmlns=\"http://schemas.cordys.com/default\"><UserName>pioMtr</UserName><Password>AZg3Q1SktWKLz0Os/H0MlAxFfI75pjnpKjn9xrV9vimyyS7/5Ilil/ftcP5oHxC7IFYLVF0C3MAJcIznwrZvDA==</Password><Make>".$makename."</Make><Model>".$modelname."</Model><Producttype>".$productname."</Producttype><Variant>".$varianttypename."</Variant><StateCode>".$stateCodeName."</StateCode><Manfaturingyear>".$manyear."</Manfaturingyear></getIDV></Body></Envelope>";
...
/*<tns:DateOfRegistration>".$this->RegisterDatenew."T00:00:00</tns:DateOfRegistration>
	...
	$quotexmlxx = "<Envelope xmlns=\"http://schemas.xmlsoap.org/soap/envelope/\">
      ...
      <SessionData>
        ...
        <UserAgentID>81001336</UserAgentID>
      ...
      <tns:Quote xmlns:tns=\"http://schemas.cordys.com/bagi/b2c/emotor/2.0\">
        ...
        <PADeclaration>".$this->ispaderivedClass."</PADeclaration>
      </tns:Quote>
...
$quotexml = "<Envelope xmlns=\"http://schemas.xmlsoap.org/soap/envelope/\">
		...
		<ZeroDepriciationSelected>".$this->ZeroDepriciationSelected."</ZeroDepriciationSelected>
		...
		<PospFlag>Y</PospFlag>
		<PospName>vaseh</PospName>
		<PospContactNo>1234567890</PospContactNo>
		<PanNo>12345678985</PanNo>
		<AadharNo>123445671234</AadharNo>
		</POSP>
		...
		<IsDrviningLicencePresent>Y</IsDrviningLicencePresent>
		 ...
		 $file_namex = 'assets/uploads/quote-'.$this->vehicleMobile.'-'.time(). ".json";  
		 file_put_contents($file_namex, $quotexml);
		 chmod($file_namex, 0777);
		return $quotexml;
	}
	...
	public function createthisValues($twowheelData){
		...
		$twoAddon = $twowheelData['twoAddon'];
		...
		*/
		...
		$toDate = date('Y-m-d');
		$originalDate = str_replace('/', '-', $twowheelData['RegisterDate'] );
		$originalDatedate = date('Y-m-d',strtotime($originalDate));//str_replace('/', '-', $originalDate);
