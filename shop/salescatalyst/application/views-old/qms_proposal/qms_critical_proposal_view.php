   ...
   <div class="page-content">
      ...
      <div class="page-bar">
         <ul class="page-breadcrumb">
            ...
            <li>
               <span>Critical Illness Proposal view </span>
            </li>
         </ul>
      </div>
      <!-- END PAGE HEADER-->
         ...
         <div class="col-md-12">
            <div class="portlet box gray-gray">
               <div class="portlet-title">
                  <div class="caption">Quote Proposal Critical Illness </div>
               </div>
               ...
               <div class="col-md-6"> : <?php echo $critical_FirstName ?> </div>
               </div>
               <div class="row paysep">
               <div class="col-md-6" >Last Name</div>
               <div class="col-md-6">: <?php echo $critical_LastName ?> </div>
               </div>
                <div class="row paysep">
               <div class="col-md-6" >Mobile Number</div>
               <div class="col-md-6">: <?php echo $mobilecritical ?> </div>
               </div>
                <div class="row paysep">
               <div class="col-md-6" >E-mail id</div>
               <div class="col-md-6">:<?php echo $emailcritical ?>  </div>
               </div>
                <div class="row paysep">
               <div class="col-md-6" >Address</div>
               <div class="col-md-6">: <?php echo $ctill_pro_add1 ?></div>
               </div>
                <div class="row paysep">
               <div class="col-md-6" >City</div>
               <div class="col-md-6">: <?php echo $critical_mx_City ?> </div>
               </div>
                <div class="row paysep">
               <div class="col-md-6" >State</div>
               <div class="col-md-6">:<?php echo $critical_mx_State ?> </div>
               </div>
               <div class="row paysep">
               <div class="col-md-6" >Pincode</div>
               <div class="col-md-6">:<?php echo $ctill_pro_zip ?></div>
               </div>
               <div class="paysep1">&nbsp;</div>
               ...
               <div class="col-md-6"> :Critical Illnes </div>
               </div>
               <div class="row paysep">
               <div class="col-md-6" >Policy Start Date</div>
               <div class="col-md-6">:<?php echo $ctill_pro_policy_sdate ?> </div>
               </div>

               <div class="row paysep">
               <div class="col-md-6" >Plan Name </div>
               <div class="col-md-6">:<?php echo $selectedPlanName ?></div>
               </div>
              ...
              <div class="paysep1">&nbsp;</div>
               ...
               <div class="col-md-6">:<?php echo $PremiumPayable?></div>
                ...
                <div class="row paysep">
               <div class="col-md-6" >Sum Insured</div>
               <div class="col-md-6">:<?php echo $selectedSumInsured?></div>
               </div>
                ...
                <div class="col-md-12">
                 ...
                 <div class="row">
                           ...
                           <div class="form-group">
                                <a href="<?php echo base_url();?>qms-critical-illnes-proposal">
