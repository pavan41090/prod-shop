...
<input type="hidden" id="web_url" value="<?php echo base_url(); ?>">
                    ...
                    <input type="hidden" id="quote_type" name="quote_type" value="CI">
...
<div  ng-controller="MainCtrl"> 
                           ...
                           <div class="col-md-6">
                              <div class="pull-right">
                                 <div class="form-group">
<!--                                     <a href="<?php //echo base_url();?>Quotesship/sess_clrSship"  > -->
                                    <a href="#" id="backToHome">
                                    <button type="submit" ng-click="backToHome()"  class="btn blue btn-default" >Back to Home</button>
                                    </a>
                                 </div>
                              </div>
                           </div>
