   ...
   <div class="page-content">
      ...
      <div class="page-bar">
         <ul class="page-breadcrumb">
            ...
            <li>
               <span>super-ship Proposal view </span>
            </li>
         </ul>
      </div>
      <!-- END PAGE HEADER-->
         ...
         <div class="col-md-12">
            <div class="portlet box gray-gray">
               <div class="portlet-title">
                  <div class="caption">Quote Proposal Super Ship </div>
               </div>
               ...
               <div class="col-md-6"> : <?php echo strtoupper($sship_FirstName); ?> </div>
               </div>
               <div class="row paysep">
               <div class="col-md-6" >Last Name</div>
               <div class="col-md-6">: <?php echo strtoupper($sship_LastName); ?> </div>
               </div>
                <div class="row paysep">
               <div class="col-md-6" >Mobile Number</div>
               <div class="col-md-6">: <?php echo $sship_mobile ?> </div>
               </div>
                <div class="row paysep">
               <div class="col-md-6" >E-mail id</div>
               <div class="col-md-6">: <?php echo strtoupper($sship_email); ?>  </div>
               </div>
                <div class="row paysep">
               <div class="col-md-6" >Address</div>
               <div class="col-md-6">: <?php echo strtoupper($sship_pro_add1); ?></div>
               </div>
                <div class="row paysep">
               <div class="col-md-6" >City</div>
               <div class="col-md-6">: <?php echo strtoupper($sship_city); ?> </div>
               </div>
                <div class="row paysep">
               <div class="col-md-6" >State</div>
               <div class="col-md-6">: <?php echo strtoupper($sship_state); ?> </div>
               </div>
               <div class="row paysep">
               <div class="col-md-6" >Pincode</div>
               <div class="col-md-6">: <?php echo strtoupper($sship_zip); ?></div>
               </div>
               <div class="paysep1">&nbsp;</div>
               ...
               <div class="col-md-6">: <?php echo $sship_pro_policy_start ?> </div>
               </div>
                <div class="row paysep">
               <div class="col-md-6" >Family Type</div>
               <div class="col-md-6">: <?php echo strtoupper($familyType) ?></div>
               </div>

              <div class="row paysep">
               <div class="col-md-6" >Insured Member</div>
               <div class="col-md-6">: <?php echo strtoupper($sship_FirstName.' '.$sship_LastName); ?></div>
               </div>
               ...
               <!--  <div class="col-md-12">
                 ...
                 <div class="row">
                           ...
                           <div class="form-group">
                                <a href="<?php echo base_url();?>qms-sship-proposal">
