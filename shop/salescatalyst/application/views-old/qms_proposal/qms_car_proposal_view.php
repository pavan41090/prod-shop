         ...
         <div class="col-md-12">
            <div class="portlet box gray-gray">
               <div class="portlet-title">
                  <div class="caption">Quote Proposal Car </div>
               </div>
               ...
               <div class="col-md-6"> : <?php echo $car_first_name ?> </div>
               </div>
               <div class="row paysep">
               <div class="col-md-6" >Last Name</div>
               <div class="col-md-6">: <?php echo $car_last_name ?> </div>
               </div>
                <div class="row paysep">
               <div class="col-md-6" >Mobile Number</div>
               <div class="col-md-6">: <?php echo $car_mobile ?> </div>
               </div>
                <div class="row paysep">
               <div class="col-md-6" >E-mail id</div>
               <div class="col-md-6">:<?php echo $car_email ?>  </div>
               </div>
                <div class="row paysep">
               <div class="col-md-6" >Address</div>
               <div class="col-md-6">: <?php echo $car_pro_add1 ?></div>
               </div>
                <div class="row paysep">
               <div class="col-md-6" >City</div>
               <div class="col-md-6">: <?php echo $car_city ?> </div>
               </div>
                <div class="row paysep">
               <div class="col-md-6" >State</div>
               <div class="col-md-6">:<?php echo $car_state ?> </div>
               </div>
               <div class="row paysep">
               <div class="col-md-6" >Pincode</div>
               <div class="col-md-6">:<?php echo $car_pro_zip ?></div>
               </div>
               <div class="row paysep">
               <div class="col-md-6" >Nominee Name</div>
               <div class="col-md-6">:<?php echo $car_pro_nname ?></div>
               </div>
               <div class="row paysep">
               <div class="col-md-6" >Age Of Nominee</div>
               <div class="col-md-6">:<?php echo $car_pro_nage ?></div>
               </div>
               <div class="row paysep">
               <div class="col-md-6" >Relationship With Nominee</div>
               <div class="col-md-6">:<?php echo $car_pro_nomie_relation ?></div>
               </div>
               <?php  if ($car_pro_nameofappoint) {?>
                              <div class="row paysep">
               <div class="col-md-6" >Name Of Appointee</div>
               <div class="col-md-6">:<?php echo $car_pro_nameofappoint ?></div>
               </div>
               <?php } ?>
               <?php if($car_pro_appoint_relation) { ?>
               <div class="row paysep">
               <div class="col-md-6" >Appointee's Relationship With nominee</div>
               <div class="col-md-6">:<?php echo $car_pro_appoint_relation ?></div>
               </div>
               <?php } ?>
               <div class="paysep1">&nbsp;</div>
               </div>
               ...
               <div class="col-md-6"> :<?php echo $manufacturercar ?> </div>
               </div>
               <div class="row paysep">
               <div class="col-md-6" >Vehicle Model</div>
               <div class="col-md-6">: <?php echo $carvariant ?></div>
               </div>
                <div class="row paysep">
               <div class="col-md-6" >Cubic Capacity</div>
               <div class="col-md-6">:<?php echo $carCc ?></div>
               </div>
                <div class="row paysep">
               <div class="col-md-6" >Fuel Type</div>
               <div class="col-md-6">:<?php echo $carFuel ?></div>
               </div>
                <div class="row paysep">
               <div class="col-md-6" >Seater</div>
               <div class="col-md-6">:<?php echo $carSeating ?></div>
               </div>
               <div class="row paysep">
               <div class="col-md-6" >IDV</div>
               <div class="col-md-6">:<?php echo $idvamount ?></div>
               </div>
               <div class="row paysep">
               ...
               <div class="col-md-6">:<?php echo $car_pro_new_policy_start ?></div>
               </div>
               <?php if($ncbcar != 0 ) ?>
                <div class="row paysep">
               <div class="col-md-6" >New Policy NCB%</div>
               <div class="col-md-6">:<?php echo $ncbcar ?></div>
               </div>
               <?php ?>
              <div class="paysep1">&nbsp;</div>
                ...
                <div class="col-md-12">
                 ...
                 <div class="row">
                           ...
                           <div class="form-group">
                                <a href="<?php echo base_url();?>qms-car-proposal">
