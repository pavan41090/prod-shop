...
<!--                                 <div class="portlet-title">
     ...
     <input type="hidden" id="load_model" data-toggle="modal" data-target="#myModal">
                     ...
                     <div class="row">
                           <div class="col-md-6">
                           <div class="form-group">
                                <a href="<?php echo base_url(); ?>create-lead-health">
...
function createLeadSting(){
      ...
      var FirstName = "<?php echo $this->session->userdata('health_FirstName');?>";
      var LastName =  "<?php echo $this->session->userdata('health_LastName');?>";
      var mx_Category= "<?php echo $this->session->userdata('health_mx_Category');?>";
      var mx_Line_of_Business= "<?php echo $this->session->userdata('health_mx_Line_of_Business');?>";
      var mx_HDFC_Branch_Location= "<?php echo $this->session->userdata('health_mx_HDFC_Branch_Location');?>";
      var mx_HDFC_Ergo_Location= "<?php echo $this->session->userdata('health_mx_HDFC_Ergo_Location');?>";
      var mx_Priority= "<?php echo $this->session->userdata('health_mx_Priority');?>";
      var mx_Target_Date= "<?php echo $this->session->userdata('health_mx_Target_Date');?>";
      var mx_TSE_BDR_Code= "<?php echo $this->session->userdata('health_mx_TSE_BDR_Code');?>";
      var mx_TL_Code= "<?php echo $this->session->userdata('health_mx_TL_Code');?>";
      var mx_SM_Code= "<?php echo $this->session->userdata('health_mx_SM_Code');?>";
      var mx_Bank_Verifier_ID= "<?php echo $this->session->userdata('health_mx_Bank_Verifier_ID');?>";
      var mx_Payment_Type= "<?php echo $this->session->userdata('health_mx_Payment_Type');?>";
      var mx_Sub_Channel= "<?php echo $this->session->userdata('health_mx_Sub_Channel');?>";
      var mx_HDFC_Card_Relationship_No= "<?php echo $this->session->userdata('health_mx_HDFC_Card_Relationship_No');?>";
      var mx_HDFC_Card_Last_4_digits= "<?php echo $this->session->userdata('health_mx_HDFC_Card_Last_4_digits');?>";
      var mx_DOB= "<?php echo $this->session->userdata('health_mx_DOB');?>";
      var mx_Case_id= "<?php echo $this->session->userdata('health_mx_Case_id');?>";
      var mx_PAN_Card= "<?php echo $this->session->userdata('health_mx_PAN_Card');?>";
      var mx_Street1= "<?php echo $this->session->userdata('health_mx_Street1');?>";
      var mx_Street2= "<?php echo $this->session->userdata('health_mx_Street2');?>";
      var mx_Area= "<?php echo $this->session->userdata('health_mx_Area');?>";
      var mx_City= "<?php echo $this->session->userdata('health_mx_City');?>";
      var mx_State= "<?php echo $this->session->userdata('health_mx_State');?>";
      var mx_Zip= "<?php echo $this->session->userdata('health_mx_Zip');?>";
      var Notes= "<?php echo $this->session->userdata('health_Notes');?>";
      var EmailAddress= "<?php echo $this->session->userdata('emailhealth');?>";
      var Mobile= "<?php echo $this->session->userdata('mobilehealth');?>";     
      //var EmailAddress= 'relayvishnu@GMAIL.COM';
