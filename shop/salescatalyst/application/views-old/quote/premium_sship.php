...
<div class="col-md-12">
                            <div class="portlet gray-gray box">
                                <div class="portlet-title">
                                    <div class="caption">
                                    Select your plan & Customize your policy </div>
                           ...
                           <div class="col-md-2 shipoption">
                              ...
                              <div class="radio-list" style="text-align:center">
                                <?php foreach ($premiumArray['premiumCSSArray'] as $css) {
                                 $radioId = $vss['product_code'].substr($css['SumInsured'], 0, -3);
                           ...
                           <div class="col-md-2 shipoption">
                              ...
                              <div class="radio-list" style="text-align:center">
                                <?php foreach ($premiumArray['premiumUSSBasicArray'] as $ussB) {
                                 $radioId = $vss['product_code'].substr($ussB['SumInsured'], 0, -3);
...
<input type="hidden" name="PremiumPayable" id="<?php echo $radioId; ?>_TotalPremium" value="<?php echo $TotalPremium; ?>" > 
                           ...
                           <div class="col-md-4 shipoption">
                              ...
                              <div class="radio-list" style="text-align:center">
                               ...
                               $radioId = $vss['product_code'].substr($uss['SumInsured'], 0, -3);
...
<input type="hidden" name="TotalPremium" id="TotalPremium" value="" >                        
                     ...
                     <div class="row">
                           ...
                           <div class="form-group">
                                <a href="<?php echo base_url(); ?>create-lead-super-ship">
...
function createLeadSting(){
      ...
      var FirstName = "<?php echo $this->session->userdata('sship_FirstName');?>";
      var LastName =  "<?php echo $this->session->userdata('sship_LastName');?>";
      var mx_Category= "<?php echo $this->session->userdata('sship_mx_Category');?>";
      var mx_Line_of_Business= "<?php echo $this->session->userdata('sship_mx_Line_of_Business');?>";
      var mx_HDFC_Branch_Location= "<?php echo $this->session->userdata('sship_mx_HDFC_Branch_Location');?>";
      var mx_HDFC_Ergo_Location= "<?php echo $this->session->userdata('sship_mx_HDFC_Ergo_Location');?>";
      var mx_Priority= "<?php echo $this->session->userdata('sship_mx_Priority');?>";
      var mx_Target_Date= "<?php echo $this->session->userdata('sship_mx_Target_Date');?>";
      var mx_TSE_BDR_Code= "<?php echo $this->session->userdata('sship_mx_TSE_BDR_Code');?>";
      var mx_TL_Code= "<?php echo $this->session->userdata('sship_mx_TL_Code');?>";
      var mx_SM_Code= "<?php echo $this->session->userdata('sship_mx_SM_Code');?>";
      var mx_Bank_Verifier_ID= "<?php echo $this->session->userdata('sship_mx_Bank_Verifier_ID');?>";
      var mx_Payment_Type= "<?php echo $this->session->userdata('sship_mx_Payment_Type');?>";
      var mx_Sub_Channel= "<?php echo $this->session->userdata('sship_mx_Sub_Channel');?>";
      var mx_HDFC_Card_Relationship_No= "<?php echo $this->session->userdata('sship_mx_HDFC_Card_Relationship_No');?>";
      var mx_HDFC_Card_Last_4_digits= "<?php echo $this->session->userdata('sship_mx_HDFC_Card_Last_4_digits');?>";
      var mx_DOB= "<?php echo $this->session->userdata('sship_mx_DOB');?>";
      var mx_Case_id= "<?php echo $this->session->userdata('sship_mx_Case_id');?>";
      var mx_PAN_Card= "<?php echo $this->session->userdata('sship_mx_PAN_Card');?>";
      var mx_Street1= "<?php echo $this->session->userdata('sship_mx_Street1');?>";
      var mx_Street2= "<?php echo $this->session->userdata('sship_mx_Street2');?>";
      var mx_Area= "<?php echo $this->session->userdata('sship_mx_Area');?>";
      var mx_City= "<?php echo $this->session->userdata('sship_mx_City');?>";
      var mx_State= "<?php echo $this->session->userdata('sship_mx_State');?>";
      var mx_Zip= "<?php echo $this->session->userdata('sship_mx_Zip');?>";
      var Notes= "<?php echo $this->session->userdata('sship_Notes');?>";
      var EmailAddress= "<?php echo $this->session->userdata('emailsupership');?>"; 
      var Mobile= "<?php echo $this->session->userdata('mobilesupership');?>";   
      //var EmailAddress= 'shajieghfhgrgfe_PA01@gmailbcv.com';
    ...
    var mx_quote_details = "Type of Policy:Super Ship";
    var basePremium  = $('#selectedpremium').val(); 
     ...
     function insertLeadHistory() {
      ...
      var product = "Super-Ship";
      var first_name =  "<?php echo $this->session->userdata('sship_FirstName');?>";
      var last_name = "<?php echo $this->session->userdata('sship_LastName');?>";
      var email = "<?php echo $this->session->userdata('emailsupership');?>";  
      var mobile = "<?php echo $this->session->userdata('mobilesupership');?>";    
      var prospectId =  $('#ProspectId').val();
      var lead_status = "Prospect";
      var state = "<?php echo $this->session->userdata('sship_mx_State');?>";
      var city = "<?php echo $this->session->userdata('sship_mx_City');?>";
