...
<!-- 
                  ...
                  <div>
                      ...
                      <?php foreach($member_details as $mbr) { ?>
                          ...
                          <div class="row lmsresbor">
                              <div class="col-md-4 labeltxtleft" style="font-size:14px;"><?php echo $mbr['mem_type']; ?> Proposal Details </div>
                          </div>
                         ...
                         <div class="row lmsresbor ">
                           <div class="col-md-12">
                              <div class="form-group">
                                 <div class="col-md-10 "><label class="labeltxtleft">Have you suffered from or are you currently suffering from any disease, illness, disability, injury, accident or any medical condition?</label>
                           ...
                           <div class="col-md-12">
                              <div class="form-group">
                                 <div class="col-md-10 "><label class="labeltxtleft">Have you or any other member(s) proposed to be insured admitted to a hospital or a nursing home or had any test or imaging like CT/MRI scan Sonography or 2D Echo etc. done in the last ten years other than routine health check-up or pre-employment check-up? </label>
                           ...
                           <div class="col-md-12">
                              <div class="form-group">
                                 <div class="col-md-10 "><label class="labeltxtleft">Have you or any other member(s) proposed to be insured had any surgery in the last ten years or has surgery ever been recommended or are you awaiting any surgical operation?</label>
                           ...
                           <div class="col-md-12">
                              <div class="form-group">
                                 <div class="col-md-10 "><label class="labeltxtleft">Have you or any other member(s) proposed to be insured taken any medication for more than 2 weeks in last 5 years?</label>
                           ...
                           <div class="col-md-12">
                              <div class="form-group">
                                 <div class="col-md-10 "><label class="labeltxtleft">Have You Been Hospitalized As An In-Patient In The Last 4 Years?</label>
                           ...
                           <div class="col-md-12">
                              <div class="form-group">
                                 <div class="col-md-10 "><label class="labeltxtleft">Has any application for life, Health or lmsCiProposal illness insurance ever been declined, postponed, loaded or been made subject to any special conditions by any insurance company?</label>
             ...
             <!--                
                        ...
                        <div class="row maincontf">
                           <div class="col-md-12">
                              <div class="form-group">
                                 <div class="col-md-10 "><label class="labeltxtleft">Have you ever had or has a doctor ever said that you have multiple sclerosis, epilepsy, tremors, paralysis, psychiatric/mental illnesses or sleep disorder                                    
                                 </div>
                                 <div class="col-md-2">
                                    <label class="radio-inline" style="font-size:13px;">
                        ...
                        <div class="row maincontf">
                           <div class="col-md-12">
                              <div class="form-group">
                                 <div class="col-md-10 "><label class="labeltxtleft"> Have you taken any medication for more than 2 weeks in last 5 years? </div>
                                 <div class="col-md-2">
                                    <label class="radio-inline" style="font-size:13px;">
                        ...
                        <div class="row maincontf">
                           <div class="col-md-12">
                              <div class="form-group">
                                 <div class="col-md-10 "><label class="labeltxtleft">Are you currently suffering from or have ever suffered from Dysfunctional uterine bleeding, Fibroid, Cyst / Fibroadenoma or any other Gynaecological / Breast disorder?                                   
                                 </div>
                                 <div class="col-md-2">
                                    <label class="radio-inline" style="font-size:13px;">
                                      <?php if($lead_details[0]->option_5 == '1'){ echo 'YES';} else { echo 'NO'; } ?>
                        ...
                        <div class="row maincontf">
                           <div class="col-md-12">
                              <div class="form-group">
                                 <div class="col-md-10 "><label class="labeltxtleft">Has any application for life, Health or critical illness insurance ever been declined, postponed, loaded or been made subject to any special conditions by any insurance company?                                    
                                 </div>
                                 <div class="col-md-2">
                                    <label class="radio-inline" style="font-size:13px;">
                                      <?php if($lead_details[0]->option_6 == '1'){ echo 'YES';} else { echo 'NO'; } ?>
                        ...
                        <div class="row maincontf">
                           <div class="col-md-12">
                              <div class="form-group">
                                 <div class="col-md-10 "><label class="labeltxtleft">Undertaken any lab/blood tests, imaging tests viz. scans/MRI in the last 5 years other than routine health check-up or pre-employment check-up?                                    
                                 </div>
                                 <div class="col-md-2">
                                    <label class="radio-inline" style="font-size:13px;">
                                      <?php if($lead_details[0]->option_7 == '1'){ echo 'YES';} else { echo 'NO'; } ?>
                        ...
                        <div class="row maincontf">
                           <div class="col-md-12">
                              <div class="form-group">
                                 <div class="col-md-10 "><label class="labeltxtleft">Any complaint of diabetes, hypertension or any complication during current or earlier pregnancy?                                    
                                 </div>
                                 <div class="col-md-2">
                                    <label class="radio-inline" style="font-size:13px;">
                                      <?php if($lead_details[0]->option_8 == '1'){ echo 'YES';} else { echo 'NO'; } ?>
                        ...
                        <div class="row maincontf">
                           <div class="col-md-12">
                              <div class="form-group">
                                 <div class="col-md-10 "><label class="labeltxtleft">Is the insured person pregnant? If yes, please mention the expected date of delivery                                 
                                 </div>
                                 <div class="col-md-2">
                                    <label class="radio-inline" style="font-size:13px;">
                                      <?php if($lead_details[0]->option_9 == '1'){ echo 'YES';} else { echo 'NO'; } ?>
                        ...
                        <div class="row maincontf">
                           <div class="col-md-12">
                              <div class="form-group">
                                 <div class="col-md-10 "><label class="labeltxtleft">Have any person proposed to be insured received any advice/ treatment / consultation for any medical condition in the last 4 years? If yes, please specify                                   
                                 </div>
                                 <div class="col-md-2">
                                    <label class="radio-inline" style="font-size:13px;">
                                      <?php if($lead_details[0]->option_10 == '1'){ echo 'YES';} else { echo 'NO'; } ?>
                        ...
                        <div class="row maincontf">
                           <div class="col-md-12">
                              <div class="form-group">
                                 <div class="col-md-10 "><label class="labeltxtleft">Does any person proposed to be Insured smoke or consume Gutka/ Pan Masala /alcohol? If yes, please indicate the name and quantity per week              
                                 </div>
                                 <div class="col-md-2">
                                    <label class="radio-inline" style="font-size:13px;">
                                      <?php if($lead_details[0]->option_11 == '1'){ echo 'YES';} else { echo 'NO'; } ?>
                        ...
                        <div class="row maincontf">
                           <div class="col-md-12">
                              <div class="form-group">
                                 <div class="col-md-10 "><label class="labeltxtleft">Have you taken any medication for more than 2 weeks in last 5 years?                               
                                 </div>
                                 <div class="col-md-2">
                                    <label class="radio-inline" style="font-size:13px;">
                                      <?php if($lead_details[0]->option_1 == '1'){ echo 'YES';} else { echo 'NO'; } ?>
                ...
                <div class="portlet-body planbox" style="color: #000;">
                          ...
                          <div class="row lmsresbor">
                              <div class="col-md-12">
                                 ...
                                 <div class="col-md-2">
                                    <label class="radio-inline" style="font-size:13px;">
                                          <?php if($lead_details[0]->ship_primary_insured == '1'){ echo 'YES';} else { echo 'NO'; } ?>
                                     </label>
                                 </div>
                                  </div>
                              </div>
                    ...
                    <?php if($lead_details[0]->ship_primary_insured == '1') {?>                  
