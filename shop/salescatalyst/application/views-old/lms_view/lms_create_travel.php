...
<!--                <div class="col-md-4">
            ...
            <div class="row maincontf">
               ...
               <!-- Moved as per user concern from customer details to lead details-->
               <div class="col-md-4">
                     <div class="form-group">
            ...
            <div class="carhide" id="cardeatail">
                    ...
                    <div class="row maincontf">
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <select id="travel_relationship" name="travel_relationship" class="form-control input-sm" ng-model="travel_relationship" required>
              ...
              <div class="row maincontf">
               ...
               <div class="row maincontf">&nbsp;</div>
                ...
                <input type="submit" class="btn blue btn-default" style="float:right;" value="continue" id="hide" ng-click="TravelProductDetail()"   />
               <br><br>
                        ...
                        <div class="row maincontf">
                           <div class="col-md-4">
                              <div class="form-group">
                                 ...
                                 <div class="radio-list">
                                    <label class="radio-inline" style="font-size:13px;">
                                    <input type="radio" name="tvl_pro_present_india" ng-model='tvl_pro_present_india'  value="Yes" > Yes </label>
                                    <label class="radio-inline" style="font-size:13px;">
                                    <input type="radio" name="tvl_pro_present_india" ng-model='tvl_pro_present_india'  value="No"> No </label>
                           ...
                           <div class="col-md-4">
                              <div class="form-group">
                                 <div class="form-group">
                                    ...
                                    <div class="radio-list">
                                       <label class="radio-inline" style="font-size:13px;">
                                       <input type="radio" name="tvl_pro_vaild_passport" ng-model='tvl_pro_vaild_passport'  value="Yes" > Yes </label>
                                       <label class="radio-inline" style="font-size:13px;">
                                       <input type="radio" name="tvl_pro_vaild_passport" ng-model='tvl_pro_vaild_passport'  value="No"> No </label>
                  ...
                  <div class="col-md-12">
                     <div class="pull-right">
                        <div class="form-group">
                           ...
                           <button type="submit"  class="btn blue btn-default send_quote" ng-click="TravelProposal()" >Save Lead</button>
                           </a>
                        </div>
                     </div>
                  </div>
...
<script>
     $('input[name="travel_policy_type"]').on('click', function() {
         ...
         //  alert('checked');  Student Individual
         var value = $(this).val();
         //alert(value);
         if (value == 'Student') {
            $('.multitrips').hide();
