                          ...
                          <div class="row lmsresbor">
                              ...
                              <div class="col-md-4">
                                  <div class="row">
                                      ...
                                      <div class="col-md-7">: <?php echo $lead_details[0]->reg_number ; ?>   </div>
                                  </div>
                              </div>                         
                          </div>
                          ...
                          <div class="row lmsresbor">
                              ...
                              <div class="col-md-4">
                                  <div class="row">
                                      ...
                                      <div class="col-md-7">: <?php echo $lead_details[0]->manufacturer ; ?> </div>
                                  </div>
                              </div>   
                              <div class="col-md-4">
                                  <div class="row">
                              ...
                              <div class="col-md-4">
                                ...
                                <div class="col-md-4">
                                  <div class="row">
                                      ...
                                      <div class="col-md-7">: <?php echo $lead_details[0]->prop_mtr_reg_date ; ?> </div>
                                  </div>
                              </div>                                
                          </div>
