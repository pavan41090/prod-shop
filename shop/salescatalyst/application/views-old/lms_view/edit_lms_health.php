        ...
        <form name="lmsShipProduct" novalidate >
             <div class="carhide" id="cardeatail">
               <div class="portlet-title tabbable-line">
                  <div class="caption leadtit">
                     <i class="icon-globe font-dark hide"></i>
                     <span class="caption-subject font-dark bold uppercase">Health Details</span>
                  </div>
               </div>
                <div class="row maincontf">
                   <div class="col-md-4">
                <div class="form-group">
                  ...
                  <div class="answer">
                 <input type="text" id="sship_spouse" name="sship_spouse" class="form-control input-sm custom-date-dob"  data-date-format="dd-mm-yyyy" placeholder="Spouse Date of Birth" ng-model="sship_spouse" >
              </div>
             </div>
          </div>
               <div class="col-md-4">
                  <div class="form-group">
                     ...
                     <div class="radio-list">
                        <label class="radio-inline" style="font-size:12px;">
                        <input type="radio" name="noofchildrens" id="noofchildrens0"  value="0"> 0 </label>   
                        <label class="radio-inline" style="font-size:12px;">
                        <input type="radio" name="noofchildrens" id="noofchildrens1"  value="1"> 1 </label>
                        <label class="radio-inline" style="font-size:12px;">
                        <input type="radio" name="noofchildrens" id="noofchildrens2"  value="2"> 2 </label>    
                        <label class="radio-inline" style="font-size:12px;">
             ...
             <div class="row maincontf">
                <div class="col-md-4">
                  ...
                  <input type="submit" class="btn blue btn-default" style="float:right;" value="continue" ng-click="shipUpdateProductDetail()"   />
               <br><br>
        ...
        <form name="lmsShipProposal" novalidate >
            <div class="carhide" id="carproposal">
               <div class="portlet-title tabbable-line">
                  <div class="caption leadtit">
                     <i class="icon-globe font-dark hide"></i>
                     <span class="caption-subject font-dark bold uppercase">Health Proposal</span>
                  </div>
               </div>



   <div id="spouse-propsal-details">
   ...
   foreach($member_details as $mem) {
    ...
    ?>
      ...
      <div class="row maincontf">
         <div class="col-md-4">
            <div class="form-group">
               <label>Salutation <?php echo $i;?> </label>
               <select id="salut_mem<?php echo $i; ?>" placeholder="Salutation" name="salut_mem<?php echo $i; ?>" class="form-control input-sm" ng-model="salut_mem<?php echo $i; ?>">
         ...
         <div class="col-md-4">
            <div class="form-group">
               ...
               <input type="text" name="fname_mem<?php echo $i; ?>"  placeholder="First Name"  class="form-control input-sm" id="fname_mem<?php echo $i;?>" ng-model="fname_mem<?php echo $i;?>" />        
            </div>
         </div>
         ...
         <div class="col-md-4">
            <div class="form-group">
               ...
               <input type="text" name="lname_mem<?php echo $i;?>"  placeholder="Last Name"   class="form-control input-sm" id="lname_mem<?php echo $i;?>"  ng-model="lname_mem<?php echo $i;?>"/> 
            </div>
         </div>
      </div>
      ...
      <div class="row maincontf">
         <div class="col-md-4">
            <div class="form-group">
               <label>DOB </label>
               <input type="text" id="dob_mem<?php echo $i;?>" name="dob_mem<?php echo $i;?>" class="form-control input-sm custom-date-dob" placeholder="DD-MM-YYYY" ng-model="dob_mem<?php echo $i;?>" data-date-format="dd-mm-yyyy">
            </div>
         </div>
      </div>      
         ...
         <div class="col-md-12">
            <div class="form-group">
               <div class="col-md-10"><label>Have you suffered from or are you currently suffering from any disease, illness, disability, injury, accident or any medical condition?
                  <span class="required"> * </span></label>
                  <!-- <input type="radio" name="sship_pro_suffered" id="sship_pro_suffered_yes" > Yes </label> -->
               </div>
               <div class="col-md-2">
                  <label class="radio-inline" style="font-size:13px;">
                  <input type="radio" name="suffered_mem1" id='ship_suffered_yes_mem<?php echo $i;?>'  / > Yes </label>
                  <label class="radio-inline" style="font-size:13px;">
                  <input type="radio" name="suffered_mem1" id='ship_suffered_no_mem<?php echo $i;?>' /> No </label>
               </div>
      ...
      <div class="row maincontf">
         <div class="col-md-12">
            <div class="form-group">
               ...
               <div class="col-md-2">
                  <label class="radio-inline" style="font-size:13px;">
                  <input type="radio" name="diseases_mem1" id='ship_diseases_yes_mem<?php echo $i;?>' /> Yes </label>
                  <label class="radio-inline" style="font-size:13px;">
                  <input type="radio" name="diseases_mem1" id='ship_diseases_no_mem<?php echo $i;?>' /> No </label>
               </div>
      ...
      <div class="row maincontf">
         <div class="col-md-12">
            <div class="form-group">
               ...
               <div class="col-md-2">
                  <label class="radio-inline" style="font-size:13px;">
                  <input type="radio" name="psychiatric_mem1" id='ship_psychiatric_yes_mem<?php echo $i;?>' /> Yes </label>
                  <label class="radio-inline" style="font-size:13px;">
                  <input type="radio" name="psychiatric_mem1" id='ship_psychiatric_no_mem<?php echo $i;?>' /> No </label>
               </div>
      ...
      <div class="row maincontf">
         <div class="col-md-12">
            <div class="form-group">
               ...
               <div class="col-md-2">
                  <label class="radio-inline" style="font-size:13px;">
                  <input type="radio" name="medication_mem1" id='ship_medication_yes_mem<?php echo $i;?>' /> Yes </label>
                  <label class="radio-inline" style="font-size:13px;">
                  <input type="radio" name="medication_mem1" id='ship_medication_no_mem<?php echo $i;?>' /> No </label>
               </div>
      ...
      <div class="row maincontf">
         <div class="col-md-12">
            <div class="form-group">
               ...
               <div class="col-md-2">
                  <label class="radio-inline" style="font-size:13px;">
                  <input type="radio" name="fibroid_mem1" id='ship_fibroid_yes_mem<?php echo $i;?>' /> Yes </label>
                  <label class="radio-inline" style="font-size:13px;">
                  <input type="radio" name="fibroid_mem1" id='ship_fibroid_no_mem<?php echo $i;?>' /> No </label>
               </div>
      ...
      <div class="row maincontf">
         <div class="col-md-12">
            <div class="form-group">
               ...
               <div class="col-md-2">
                  <label class="radio-inline" style="font-size:13px;">
                  <input type="radio" name="cyst_mem1" id='ship_cyst_yes_mem<?php echo $i;?>' /> Yes </label>
                  <label class="radio-inline" style="font-size:13px;">
                  <input type="radio" name="cyst_mem1" id='ship_cyst_no_mem<?php echo $i;?>' /> No </label>
               </div>
      ...
      <div class="row maincontf">
         <div class="col-md-12">
            <div class="form-group">
               ...
               <div class="col-md-2">
                  <label class="radio-inline" style="font-size:13px;">
                  <input type="radio" name="bltest_mem1" id='ship_bltest_yes_mem<?php echo $i;?>'/> Yes </label>
                  <label class="radio-inline" style="font-size:13px;">
                  <input type="radio" name="bltest_mem1" id='ship_bltest_no_mem<?php echo $i;?>' /> No </label>
               </div>
                        ...
                        <div class="row maincontf">
                           <div class="col-md-4">
                              <div class="form-group">
                                 ...
                                 <input type="text" name="sship_pro_doc_name" placeholder="Enter doctor Name" class="form-control input-sm" ng-model="sship_pro_doc_name" required/>
...
<!--                            <div class="col-md-4">
                              <div class="form-group">
                                 <label> Doctor's Address <span class="required"> * </span></label>
                                 <input type="text" name="sship_pro_doc_addr" placeholder="Enter Address" class="form-control input-sm" id="ship_pro_doc_addr" ng-model="ship_pro_doc_addr" required/>
                                 <div ng-if="lmsShipProposal.$submitted || lmsShipProposal.sship_pro_doc_addr.$dirty" ng-messages="lmsShipProposal.ship_pro_doc_addr.$error" role="alert">
                                    <div ng-message="required" class="required">Please Enter Doctor's Address</div>
                                 </div>
                              </div>
