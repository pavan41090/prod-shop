...
?>
                  ...
                  <div>
                      ...
                      <div class="box lmsresult">
                          ...
                          <div class="row lmsresbor">
                              ...
                              <div class="col-md-4">
                                  <div class="row">
                                      <div class="col-md-5 labeltxtleft">Type of Building</div>
             ...
             <div class="row">
              ...
              <div class="row lmsresbor" >
                 ...
                 foreach($valuables_details as $vld) {?> 
                    <div class="form-group col-md-12"> 
                        <div class="col-md-5"><label> <?php echo $vld->hme_itm_des; ?></label></div>
              ...
              <div class="row lmsresbor" >
                ...
                // print_r($PEEI_details);
                 foreach($PEEI_details as $pee) {?> 
                    <div class="form-group col-md-12"> 
                        <div class="col-md-2"><label> <?php echo $pee->hme_itm_des; ?></label></div>
          ...
          <?php }  ?>
            ...
            <?php if(count($pre_claim_details) !== 0 ){ ?>                         
             <div class="row">
                <div class="col-md-12">
                      <div class="row">
              ...
              <div class="row lmsresbor" >
                ...
                // print_r($pre_claim_details);
                 foreach($pre_claim_details as $clm) {?> 
                    <div class="form-group col-md-12"> 
                        <div class="col-md-2"><label> <?php echo $clm->hme_long_des; ?></label></div>
