         ...
         <form name="lmsCar" novalidate >
            ...
            <div class="row maincontf">
             ...
             <div class="col-md-4">
                  <div class="form-group">
                     ...
                     <input type="text" name="lms_car_hdfc_card_4digt" onkeypress='return restrictAlphabets(event)' maxlength="4" placeholder="HDFC Card's Last 4 digits"  class="form-control input-sm" id="lms_car_hdfc_card_4digt" ng-model="lms_car_hdfc_card_4digt" onkeyup="return card_validate(this.value);" required />
            ...
            <?php 
                     ...
                     <div ng-if="lmsCar.$submitted || lmsCar.lms_car_sub_channel.$dirty" ng-messages="lmsCar.lms_car_sub_channel.$error" role="alert">
                        <div ng-message="required" class="required">Select Your Priority</div>
                     </div>
                  </div>
               </div>
...
<!--                <div class="col-md-4">
               ...
               <div class="col-md-4">
                  <div class="form-group">
                     ...
                     <span class="required"> * </span>
                      ...
                      <!--<input  type="text" id="lms_car_zip" maxlength="6" autocomplete="on" name="lms_car_zip" placeholder="Pincode "  class="form-control input-sm" ng-model="lms_car_zip" required onchange="cusStatefunc();">       -->         
            ...
            <div class="row maincontf">
               <div class="col-md-4">
                  <div class="form-group">
                  <label>State </label>
                   <input type="text" name="lms_car_state" placeholder="Enter the State" id="lms_car_state" autocomplete="on" maxlength="25" ng-model="lms_car_state" class="form-control input-sm">  

                  
               
                    <!-- <input list="state" id="lms_car_state" placeholder="Select State"  autocomplete="off" name="lms_car_state" class="form-control input-sm" ng-model="lms_car_state" readonly >
                     <datalist id="state">
               ...
               <div class="col-md-4">
                  <div class="form-group">
                     ...
                     <input type="text" name="lms_car_city" placeholder="Enter the City" id="lms_car_city" autocomplete="on" maxlength="25"  ng-model="lms_car_city" class="form-control input-sm" > 
                    <!--<div id="lms_car_city-loader" style="padding: 0 25%; display: none;">
                     ...
                     <!-- <div id="lms_car_city-div" style="">
                        <input list="city" id="lms_car_city" placeholder="Select city" autocomplete="off" name="lms_car_city" class="form-control input-sm" ng-model="lms_car_city" >
                        <datalist id="city">
            ...
            <!-- Details of lead moved to nxt to priority -->
            </div>
             ...
             <div class="col-md-4">
                     ...
                     <div class="form-group">
                        ...
                        <!--<div ng-if="lmsCar.$submitted || lmsCar.lms_car_pro_emergency.$dirty" class="required" id="emergencyContact" ng-messages="lmsCar.lms_car_pro_emergency.$error" role="alert">
                           <div ng-message="required" class="required">Please Enter Valid e Number</div>
                        </div> -->
                     </div>
            ...
            <div class="carhide" id="cardeatail">
              ...
              <div class="row maincontf">
               ...
               <input type="text" id="lms_est_premium" name="lms_est_premium" class="form-control input-sm number-validate" placeholder="Premium Amount" ng-model="lms_est_premium" required>
                ...
                <input type="submit" class="btn blue btn-default" style="float:right;" value="continue" ng-click="cardetail()"   />
               <br><br>
                  ...
                  <div class="col-md-4">
                     ...
                     <div class="form-group">
                        ...
                        <div class="radio-list">
                           ...
                           <input type="radio" name="lms_car_pro_prev_stand_alone" ng-model='lms_car_pro_prev_stand_alone' ng-value="1" value="1" /> Yes </label>
                           <label class="radio-inline" style="font-size:13px;">
                           <input type="radio" name="lms_car_pro_prev_stand_alone" ng-model='lms_car_pro_prev_stand_alone' ng-value="0"  value="0" /> No </label>
                        </div>
                     </div>
                  </div>
               </div>
               ...
               <div class="row maincontf">
                  ...
                  <div class="col-md-4">
                     ...
                     <div class="form-group">
                        ...
                        <div class="radio-list">
                           <label class="radio-inline" style="font-size:13px; padding-left: 18px;">
                           <input type="radio" name="lms_car_pro_prev_depre" ng-model='lms_car_pro_prev_depre' ng-value="1" value="1" /> Yes </label>
                           <label class="radio-inline" style="font-size:13px;">
                           <input type="radio" name="lms_car_pro_prev_depre" ng-model='lms_car_pro_prev_depre' ng-value="0"  value="0" /> No </label>
                        </div>
                     </div>
                  </div>
                  ...
                  <div class="col-md-4">
                     ...
                     <div class="form-group">
                        ...
                        <div class="radio-list">
                           <label class="radio-inline" style="font-size:13px; padding-left: 18px;">
                           <input type="radio" name="lms_car_pro_prev_electric" ng-model='lms_car_pro_prev_electric' ng-value="1" value="1" /> Yes </label>
                           <label class="radio-inline" style="font-size:13px;">
                           <input type="radio" name="lms_car_pro_prev_electric" ng-model='lms_car_pro_prev_electric' ng-value="0"  value="0" /> No </label>
                        </div>
                     </div>
                  </div>
                  ...
                  <div class="col-md-4">
                     ...
                     <div class="form-group">
                        ...
                        <div class="radio-list">
                           <label class="radio-inline" style="font-size:13px; padding-left: 18px;">
                           <input type="radio" name="lms_car_pro_prev_cng_lpg" ng-model='lms_car_pro_prev_cng_lpg' ng-value="1" value="1" /> Yes </label>
                           <label class="radio-inline" style="font-size:13px;">
                           <input type="radio" name="lms_car_pro_prev_cng_lpg" ng-model='lms_car_pro_prev_cng_lpg' ng-value="0"  value="0" /> No </label>
<!--                            <label class="col-md-6 pull-right" > 
                              <input type="text" name="lms_car_pro_chasis_num"  placeholder="CNG/LPG kit value" class="form-control input-sm" id="lms_car_pro_chasis_num" ng-model="lms_car_pro_chasis_num" required />
                           </label> -->
                        </div>
                     </div>
                  </div>                  
                  ...
                  <div class="col-md-4">
                     <div class="form-group">
                        ...
                        <div ng-if="lmsCarProposal.$submitted || lmsCarProposal.lms_car_pro_engine_num.$dirty" ng-messages="lmsCarProposal.lms_car_pro_engine_num.$error" role="alert">
                           <div ng-message="required" class="required">Please Enter engine number</div>
                        </div>
                     </div>
                  </div>
             ...
             <!--               <div ng-if="lmsCarProposal.$submitted || lmsCarProposal.lms_car_pro_financed.$dirty" ng-messages="lmsCarProposal.lms_car_pro_financed.$error" role="alert">
               ...
               <div class="row maincontf" id="vechicle_finiance_div" style="display: none;">
                  <div class="col-md-4">
                     <div class="form-group">
                        <label>Financing institution name</label>
                        <input type="text" name="lms_car_pro_fin_ins_name"  placeholder="Financing Institution" class="form-control input-sm" id="lms_car_pro_fin_ins_name" ng-model="lms_car_pro_fin_ins_name" />
<!--                         <div ng-if="lmsCarProposal.$submitted || lmsCarProposal.lms_car_pro_fin_ins_name.$dirty" ng-messages="lmsCarProposal.lms_car_pro_fin_ins_name.$error" role="alert">
                           <div ng-message="required" class="required">Financing institution name</div>
                        </div> -->
                     </div>
                  </div>
              ...
              <!--           <div ng-if="lmsCarProposal.$submitted || lmsCarProposal.lms_car_pro_fin_ins_city.$dirty" ng-messages="lmsCarProposal.lms_car_pro_fin_ins_city.$error" role="alert">
                           <div ng-message="required" class="required">Financing institution city</div>
                        </div> -->
                     </div>
                  </div>                  
...
<!--                <div class="row maincontf">
                  <div class="col-md-4">
                     <div class="form-group">
                        ...
                        <input placeholder="Comments" id="lms_car_comment" name="lms_car_comment" class="form-control input-sm" ng-model="lms_car_comment" >
                  ...
                  <div class="col-md-6">
                     <div class="pull-right">
                        <div class="form-group">
                           ...
                           <button type="submit"  class="btn blue btn-default send_quote" ng-click="proposal()" >Save Lead</button>
                           </a>
                        </div>
                     </div>
                  </div>
