...
?>
                  ...
                  <div>
                      ...
                      <div class="box lmsresult">
                          ...
                          <div class="row lmsresbor">
                              ...
                              <div class="col-md-4">
                                  <div class="row">
                                      <div class="col-md-5 labeltxtleft">Type of Building Construction</div>
                                      <div class="col-md-7">: <?php echo $lead_details[0]->hme_building_type; ?> </div>
                                  </div>
                              </div>
                              <div class="col-md-4">
                                  <div class="row">
                                      <div class="col-md-5 labeltxtleft">Property Ownership </div>
                                      <div class="col-md-7">: <?php echo $lead_details[0]->hme_property_ownership ; ?> </div>
                                  </div>
                              </div>   
                          ...
                          <div class="row lmsresbor">
                              <div class="col-md-4">
                                  <div class="row">
                                      <div class="col-md-5 labeltxtleft">Property Type </div>
                                      <div class="col-md-7">: <?php echo $lead_details[0]->hme_property_type ; ?>   </div>
                                  </div>
                              </div>                         
                              <div class="col-md-4">
                                  <div class="row">
                                      <div class="col-md-5 labeltxtleft">No of Floors </div>
                                      <div class="col-md-7">: <?php echo $lead_details[0]->hme_no_of_floors ; ?> </div>
                                  </div>
                              </div>   
                              <div class="col-md-4">
                                  <div class="row">
                                      <div class="col-md-5 labeltxtleft">Year of construction </div>
                                      <div class="col-md-7">: <?php echo $lead_details[0]->hme_year_of_construction ; ?>   </div>
                                  </div>
                              </div> 
                          ...
                          <div class="row lmsresbor">
                              <div class="col-md-4">
                                  <div class="row">
                                      <div class="col-md-5 labeltxtleft">Independent House</div>
                                      <div class="col-md-7">: <?php echo $lead_details[0]->hme_independent_house; ?> </div>
                                  </div>
                              </div>
                              <div class="col-md-4">
                                  <div class="row">
                                      <div class="col-md-5 labeltxtleft">Compound Wall </div>
                                      <div class="col-md-7">: <?php echo $lead_details[0]->hme_compound_wall ; ?> </div>
                                  </div>
                              </div>   
                              <div class="col-md-4">
                                  <div class="row">
                                      <div class="col-md-5 labeltxtleft">Build up Area </div>
                                      <div class="col-md-7">: <?php echo $lead_details[0]->hme_build_up ; ?>   </div>
                                  </div>
                              </div>                         
                          </div>
                          ...
                          <div class="row lmsresbor">
                              <div class="col-md-4">
                                  <div class="row">
                                      ...
                                      <div class="col-md-7">: <?php echo $lead_details[0]->sum_insured; ?> </div>
                                  </div>
                              </div>
   
                              <div class="col-md-4">
                                  <div class="row">
                                      <div class="col-md-5 labeltxtleft">Premium Amount </div>
                                      <div class="col-md-7">: <?php echo $lead_details[0]->lms_premium ; ?>   </div>
                                  </div>
                              </div>
                            <div class="col-md-4">
                                <div class="row">
                                    <div class="col-md-6 labeltxtleft">Do you have any claims in previous year</div>
                                    <div class="col-md-6">: <?php echo $lead_details[0]->hme_previous_claims; ?> </div>
                                </div>
                            </div>
                          ...
                          <div class="row lmsresbor"> 
                            ...
                            <div class="col-md-6">
                                <div class="row">
                                    <div class="col-md-6 labeltxtleft">Sum Insured to be provided as </div>
									<?php $valuablesCheck = json_decode($lead_details[0]->hme_sum_insured_provided);
									
									?>
                                    <div class="col-md-6">:   
                                        <?php if( $valuablesCheck->valuables > 0 ){ ?>
                                            Valuable
                                       <?php  } ?>
									   <?php 
									   if($valuablesCheck ->pee > 0){ echo ','; }
									   
									   if($valuablesCheck ->pee > 0) { echo 'Portable Electronic Equipment'; }
									   
									   if($valuablesCheck ->structure > 0){ echo ','; }
									   
									   if($valuablesCheck ->structure > 0) { echo 'Structure'; }
									   ?>
                                    </div>
                                </div>
                            </div>
                          ...
                          <div class="row lmsresbor">
                              <div class="col-md-4">
                                  <div class="row">
                                      <div class="col-md-5 labeltxtleft">Risk Address 1</div>
                                      <div class="col-md-7">: <?php echo $lead_details[0]->hme_risk_address1; ?> </div>
                                  </div>
                              </div>
                              <div class="col-md-4">
                                  <div class="row">
                                      <div class="col-md-5 labeltxtleft">Risk Address 2 </div>
                                      <div class="col-md-7">: <?php echo $lead_details[0]->hme_risk_address2; ?> </div>
                                  </div>
                              </div>   
                              <div class="col-md-4">
                                  <div class="row">
                                      <div class="col-md-5 labeltxtleft">Risk Area </div>
                                      <div class="col-md-7">: <?php echo $lead_details[0]->hme_risk_area; ?>   </div>
                                  </div>
                              </div>                         
                          </div>
                          ...
                          <div class="row lmsresbor">
                              <div class="col-md-4">
                                  <div class="row">
                                      <div class="col-md-5 labeltxtleft">Risk Pincode</div>
                                      <div class="col-md-7">: <?php echo $lead_details[0]->hme_risk_pincode; ?> </div>
                                  </div>
                              </div>
                              <div class="col-md-4">
                                  <div class="row">
                                      <div class="col-md-5 labeltxtleft">Risk State</div>
                                      <div class="col-md-7">: <?php echo $lead_details[0]->hme_risk_state; ?> </div>
                                  </div>
                              </div>   
                              <div class="col-md-4">
                                  <div class="row">
                                      <div class="col-md-5 labeltxtleft">Risk City </div>
                                      <div class="col-md-7">: <?php echo $lead_details[0]->hme_risk_city; ?>   </div>
                                  </div>
                              </div>                         
                          </div>
                          ...
                          <div class="row lmsresbor">
                              <div class="col-md-4">
                                  <div class="row">
                                      <div class="col-md-5 labeltxtleft">Risk Nearest Land Mark</div>
                                      <div class="col-md-7">: <?php echo $lead_details[0]->hme_risk_nearest_land_mark; ?> </div>
                                  </div>
                              </div>
                          </div>    


            <?php if(count($valuables_details) !== 0 ){ ?> 
             <div class="row">
                <div class="col-md-12">
                      <div class="row">
                          <div class="col-md-12 labeltxtleft">Valuables Description</div>
                      </div>
                  </div>
              </div>                                    
              <div class="row">&nbsp;</div>
              <div class="row lmsresbor" >
                 ...
                 <div class="form-group col-md-12 "> 
                    <div class="col-md-5"><label class="labeltxtleft">Item Description </label></div>
                    <div class="col-md-3"><label class="labeltxtleft">Weight in gm</label></div>
                    <div class="col-md-4"><label class="labeltxtleft">Sum Insured</label></div>
                  </div>
                 <?php 
                 //print_r($valuables_details);
                 foreach($valuables_details as $vld) {?> 
                    <div class="form-group col-md-12"> 
                        <div class="col-md-5" style="word-wrap: break-word;"><label> <?php echo $vld->hme_itm_des; ?></label></div>
                        <div class="col-md-3"><label> <?php echo $vld->hme_weight; ?></label></div>
                        <div class="col-md-4"><label> <?php echo $vld->hme_SI; ?></label></div>
                      </div> 
               <?php } ?>
              </div>
          <?php }  ?>
            ...
            <?php if(count($PEEI_details) !== 0 ){ ?>                         
             <div class="row">
                <div class="col-md-12">
                      <div class="row">
                          <div class="col-md-12 labeltxtleft">Portable Electronic Equipment Description</div>
                      </div>
                  </div>
              </div>                                    
              <div class="row">&nbsp;</div>
              <div class="row lmsresbor" >
                 ...
                 <div class="form-group col-md-12 "> 
                    <div class="col-md-2"><label class="labeltxtleft">Item Description </label></div>
                    <div class="col-md-1"><label class="labeltxtleft">Make</label></div>
                    <div class="col-md-2"><label class="labeltxtleft">Model</label></div>
                    <div class="col-md-1"><label class="labeltxtleft">YOM</label></div>
                    <div class="col-md-3"><label class="labeltxtleft">Serial / IMEI Number</label></div>
                    <div class="col-md-2"><label class="labeltxtleft">Sum Insured</label></div>
                  </div>
                 <?php 
                // print_r($PEEI_details);
                 foreach($PEEI_details as $pee) {?> 
                    <div class="form-group col-md-12"> 
                        <div class="col-md-2" style="word-wrap: break-word;"><label> <?php echo $pee->hme_itm_des; ?></label></div>
                        <div class="col-md-1"><label> <?php echo $pee->hme_make; ?></label></div>
                        <div class="col-md-2"><label> <?php echo $pee->hme_model; ?></label></div>                        
                        <div class="col-md-1"><label> <?php echo $pee->hme_YOM; ?></label></div>
                        <div class="col-md-3"><label> <?php echo $pee->hme_IMEI; ?></label></div>
                        <div class="col-md-2"><label> <?php echo $pee->hme_SI; ?></label></div>
                    </div> 
               <?php } ?>
          ...
          <?php }  ?>
			   ...
			   <div class="portlet-title">
                  <div class="caption"  style="padding: 11px 0 9px 0;
display: inline-block;
font-size: 18px;
color: #c61b03;"> Proposal Details </div>
               </div>
			   ...
			   <hr/>
            <?php if((!empty($pre_claim_details) && count($pre_claim_details)>0) && ($lead_details[0]->hme_previous_claims != 'no')){ ?>                         
             <div class="row">
                <div class="col-md-12">
                      <div class="row">
              ...
              <div class="row lmsresbor" >
                 ...
                 <div class="form-group col-md-12 "> 
                    <div class="col-md-2"><label class="labeltxtleft">Long Description </label></div>
                    <div class="col-md-2"><label class="labeltxtleft">Assets Damaged</label></div>
                    <div class="col-md-2"><label class="labeltxtleft">Cause Of Loss</label></div>
                    <div class="col-md-1"><label class="labeltxtleft">Insurance In Place</label></div>
                    <div class="col-md-2"><label class="labeltxtleft">Policy /Loss Year </label></div>
                    <div class="col-md-1"><label class="labeltxtleft">Insurance Claimed</label></div>
                    <div class="col-md-2"><label class="labeltxtleft">Loss Of Amount</label></div>
                  </div>
                 <?php 
                // print_r($pre_claim_details);
                 foreach($pre_claim_details as $clm) {?> 
                    <div class="form-group col-md-12"> 
                        <div class="col-md-2" style="word-wrap: break-word;"><label> <?php echo $clm->hme_long_des; ?></label></div>
                        <div class="col-md-2"><label> <?php echo $clm->hme_assets_damage; ?></label></div>
                        <div class="col-md-2"><label> <?php echo $clm->hme_cause_loss; ?></label></div>                        
                        <div class="col-md-1"><label> <?php echo $clm->hme_ins_place; ?></label></div>
                        <div class="col-md-2"><label> <?php echo $clm->hme_policy_yr; ?></label></div>
                        <div class="col-md-1"><label> <?php echo $clm->hme_ins_claim; ?></label></div>
                        <div class="col-md-2"><label> <?php echo $clm->hme_loss_amt; ?></label></div>
                    </div> 
               <?php } ?>
