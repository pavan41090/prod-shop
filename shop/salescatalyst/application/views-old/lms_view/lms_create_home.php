...
<?php } ?>   
               ...
               <input type="submit" class="btn blue btn-default" style="float:right;" value="continue" id="hide" ng-click="HomeProductDetail()"/>
               <br><br>
            ...
            <div class="carhide" id="carproposal">
               <div class="portlet-title tabbable-line">
                  ...
                  <div class="form-group">
                     ...
                     <div><span ng-if="lmshomeProposal.$submitted" ng-messages="lmshomeProposal.home_pro_policy_sdate.$error" role="alert">
                  ...
                  <div class="col-md-6">
                     <div class="pull-right">
                        <div class="form-group">
                           ...
                           <button type="submit"  class="btn blue btn-default send_quote" ng-click="homeProposal()" >Save Lead</button>
                           </a>
                        </div>
                     </div>
                  </div>
...
jQuery(document).ready(function() { 
   ...
   function updatePremium(){
      ...
      switch(sumInsured){
         case'500000':
            var premiumAmt = '3000';
            if($('#valuables').is(":checked")){ premiumAmt = Number(premiumAmt) + Number('2500'); }else { premiumAmt = premiumAmt; }
            if($('#SIM_PEE').is(":checked")){ premiumAmt = Number(premiumAmt) + Number('4000'); }else { premiumAmt = premiumAmt; }
            if($('#SIM_structure').is(":checked")){ premiumAmt = Number(premiumAmt) + Number('1239'); }else { premiumAmt = premiumAmt; }
            $('#lms_est_premium').val(premiumAmt);
            break;
         case'1000000':
            var premiumAmt = '4000';
            if($('#valuables').is(":checked")){ premiumAmt = Number(premiumAmt) + Number('4500'); }else { premiumAmt = premiumAmt; }
            if($('#SIM_PEE').is(":checked")){ premiumAmt = Number(premiumAmt) + Number('4500'); }else { premiumAmt = premiumAmt; }
            if($('#SIM_structure').is(":checked")){ premiumAmt = Number(premiumAmt) + Number('2065'); }else { premiumAmt = premiumAmt; }
            $('#lms_est_premium').val(premiumAmt);
            break;
         case'2000000':
            var premiumAmt = '7500';
            if($('#valuables').is(":checked")){ premiumAmt = Number(premiumAmt) + Number('8000'); }else { premiumAmt = premiumAmt; }
            if($('#SIM_PEE').is(":checked")){ premiumAmt = Number(premiumAmt) + Number('8000'); }else { premiumAmt = premiumAmt; }
            if($('#SIM_structure').is(":checked")){ premiumAmt = Number(premiumAmt) + Number('2891'); }else { premiumAmt = premiumAmt; }
            $('#lms_est_premium').val(premiumAmt);
            break;
         case'3000000':
            var premiumAmt = '11000';
            if($('#valuables').is(":checked")){ premiumAmt = Number(premiumAmt) + Number('12000'); }else { premiumAmt = premiumAmt; }
            if($('#SIM_PEE').is(":checked")){ premiumAmt = Number(premiumAmt) + Number('10000'); }else { premiumAmt = premiumAmt; }
            if($('#SIM_structure').is(":checked")){ premiumAmt = Number(premiumAmt) + Number('4130'); }else { premiumAmt = premiumAmt; }
            $('#lms_est_premium').val(premiumAmt);
            break;
         case'4000000':
            var premiumAmt = '14000';
            if($('#valuables').is(":checked")){ premiumAmt = Number(premiumAmt) + Number('15000'); }else { premiumAmt = premiumAmt; }
            if($('#SIM_PEE').is(":checked")){ premiumAmt = Number(premiumAmt) + Number('11000'); }else { premiumAmt = premiumAmt; }
            if($('#SIM_structure').is(":checked")){ premiumAmt = Number(premiumAmt) + Number('5369'); }else { premiumAmt = premiumAmt; }
            $('#lms_est_premium').val(premiumAmt);
            break;
         case'5000000':
            var premiumAmt = '16000';
            if($('#valuables').is(":checked")){ premiumAmt = Number(premiumAmt) + Number('17000'); }else { premiumAmt = premiumAmt; }
            if($('#SIM_PEE').is(":checked")){ premiumAmt = Number(premiumAmt) + Number('12000'); }else { premiumAmt = premiumAmt; }
            if($('#SIM_structure').is(":checked")){ premiumAmt = Number(premiumAmt) + Number('7021'); }else { premiumAmt = premiumAmt; }
            $('#lms_est_premium').val(premiumAmt);
            break;
         case'7500000':
            var premiumAmt = '20000';
            if($('#valuables').is(":checked")){ premiumAmt = Number(premiumAmt) + Number('23000'); }else { premiumAmt = premiumAmt; }
            if($('#SIM_PEE').is(":checked")){ premiumAmt = Number(premiumAmt) + Number('15000'); }else { premiumAmt = premiumAmt; }
            if($('#SIM_structure').is(":checked")){ premiumAmt = Number(premiumAmt) + Number('8260'); }else { premiumAmt = premiumAmt; }
            $('#lms_est_premium').val(premiumAmt);
            break;
      }
