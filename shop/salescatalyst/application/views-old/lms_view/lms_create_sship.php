            ...
            <div class="row maincontf">
               <div class="col-md-4">
                  <div class="form-group">
                     ...
                     <select id="lms_car_salut" name="lms_car_salut" class="form-control input-sm"  ng-model="lms_car_salut" required>
                        <option value="" disabled selected>Select your option</option>
                        <?php 
               ...
               <div class="col-md-4">
                  <div class="form-group">
                     ...
                     <span class="required"> * </span></label>  
                     <input type="text" name="lms_car_fname"  placeholder="Customer First Name"  class="form-control input-sm" id="lms_car_fname" ng-change="update_name()" ng-model="lms_car_fname" required />               
                ...
                <div class="form-group">
                    ...
                    <div class="answer1">
                     ...
                     <div class="form-group" >
                              <label>Sum Insured</label>
                              <span class="required"> * </span>
                              <select id="ss_sum_insured_critical" name="ss_sum_insured_critical" class="form-control input-sm  sumInsured" ng-model="ss_sum_insured_critical" ng-change="zonewisecalculation()" >
            ...
            <div class="row maincontf">
               <div class="col-md-4">
                  <div class="form-group">
                     ...
                     <input type="text" id="spouse_dob" name="spouse_dob" class="form-control input-sm custom-date-dob" placeholder="DD-MM-YYYY" ng-model="spouse.spouse_dob" required data-date-format="dd-mm-yyyy" ng-disabled="spouse_dob" readonly="readonly">
