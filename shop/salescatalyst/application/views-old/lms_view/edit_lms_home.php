               ...
               <div class="col-md-4">
                  <div class="form-group">
                                ...
                                <select id="hme_property_type" name="hme_property_type" class="form-control input-sm" ng-model="hme_property_type"  required>
                                    ...
                                    <option value="Housingsociety">Housing Society</option>
                                  </select> 
                                 <div ng-if="lmshomeDetil.$submitted || lmshomeDetil.hme_property_type.$dirty" ng-messages="lmshomeDetil.hme_property_type.$error" role="alert">
                                    <div ng-message="required" class="required">Please Select Property Ownership</div>
                                 </div>
                              </div>
               </div>
                  ...
                  <div class="col-md-4">
                     <div class="form-group">
                                ...
                                <select id="hme_independent_house " name="hme_independent_house " class="form-control input-sm" ng-model="hme_independent_house "  required>
                                 ...
                                 <div ng-if="lmshomeDetil.$submitted || lmshomeDetil.hme_independent_house .$dirty" ng-messages="lmshomeDetil.hme_independent_house .$error" role="alert">
                  ...
                  <div class="col-md-4">
                     <div class="form-group">
                               ...
                               <select id="hme_compound_wall" name="hme_compound_wall" class="form-control input-sm" ng-model="hme_compound_wall"  required>
                                 ...
                                 <div ng-if="lmshomeDetil.$submitted || lmshomeDetil.hme_compound_wall.$dirty" ng-messages="lmshomeDetil.hme_compound_wall.$error" role="alert">
                  ...
                  <div class="col-md-4">
                     <div class="form-group">
                                ...
                                <input type="text" name="hme_build_up" placeholder="Build up Area " class="form-control input-sm number-validate" id="hme_build_up" ng-model="hme_build_up" required />
                                 <div ng-if="lmshomeDetil.$submitted || lmshomeDetil.hme_build_up.$dirty" ng-messages="lmshomeDetil.hme_build_up.$error" role="alert">
               ...
               <div class="row maincontf">
                  ...
                  <label>Sum Insured to be provided as</label>
                     ...
                     <div class="form-group">
                        ...
                        <div class="col-md-3">
                           <input class="Spouse_ship hme_sum_insured_provided" type="checkbox" name="hme_sum_insured_provided" id="valuables"  ng-model="valuables" value="valuables"  />
                           <label> Valuables</label>
                        
                        </div>
                        <div class="col-md-5">
                           <input class="Spouse_ship hme_sum_insured_provided" type="checkbox" name="hme_sum_insured_provided" id="SIM_PEE"  ng-model="PEE" value="SIM_PEE" />
               ...
               <div class="row maincontf">
                  <div class="col-md-4">
                     <div class="form-group">
                                ...
                                <!--  <div ng-if="lmshomeDetil.$submitted || lmshomeDetil.hme_risk_address1.$dirty" ng-messages="lmshomeDetil.hme_risk_address1.$error" role="alert"> -->
                  ...
                  <div class="col-md-4">
                     <div class="form-group">
                               ...
                               <!--   <div ng-if="lmshomeDetil.$submitted || lmshomeDetil.hme_risk_address2.$dirty" ng-messages="lmshomeDetil.hme_risk_address2.$error" role="alert"> -->
...
<!--                         <div ng-if="lmshomeDetil.$submitted || lmshomeDetil.hme_risk_area.$dirty" ng-messages="lmshomeDetil.hme_risk_area.$error" role="alert">
...
<!--                            <div ng-if="lmshomeDetil.$submitted || lmshomeDetil.hme_risk_pincode.$dirty" ng-messages="lmshomeDetil.hme_risk_pincode.$error" role="alert">
...
<!--                            <div ng-if="lmshomeDetil.$submitted || lmshomeDetil.hme_risk_state.$dirty" ng-messages="lmshomeDetil.hme_risk_state.$error" role="alert">
...
<!--                            <div ng-if="lmshomeDetil.$submitted || lmshomeDetil.hme_risk_city.$dirty" ng-messages="lmshomeDetil.hme_risk_city.$error" role="alert">
...
<!--                         <div ng-if="lmshomeDetil.$submitted || lmshomeDetil.hme_risk_nearest_land_mark.$dirty" ng-messages="lmshomeDetil.hme_risk_nearest_land_mark.$error" role="alert">
...
<div id="valuable_detail_div" style="display: block; border: 1px solid #CCC; padding: 10px; margin-top: 20px;">
<div class="portlet-title tabbable-line">
                  <div class="caption leadtit">
                     <i class="icon-globe font-dark hide"></i>
   ...
   <?php for( $i = 1; $i < 7;  $i++ ) { ?>
      <div class="row maincontf form-group">
         <div class="col-md-4">
			...
			<input type="text" name="hme_itm_des_val <?php echo $i?>" placeholder="Item Description" class="form-control input-sm " id="hme_itm_des_val<?php echo $i?>" ng-model="hme_itm_des_val<?php echo $i?>"  /> 
               </div>
			   <?php if($i == 1) { ?>
         ...
         <div class="col-md-4">
            <div class="form-group">
               <input type="text" name="hme_weight_val<?php echo $i?>" placeholder="Weight in gm" class="form-control input-sm number-validate " id="hme_weight_val<?php echo $i?>" ng-model="hme_weight_val<?php echo $i?>"  />
            </div>
			<?php if($i == 1) { ?>
         ...
         <div class="col-md-4">
            <div class="form-group">
               <input type="text" name="hme_SI_val<?php echo $i?>" placeholder="Sum Insured" class="form-control input-sm number-validate " id="hme_SI_val<?php echo $i?>" ng-model="hme_SI_val<?php echo $i?>"  />
            </div>
			<?php if($i == 1) { ?>
   ...
   <div class="row maincontf">
      <div class="col-md-3">
         <div class="form-group">
           ...
           <select id="hme_itm_des_PEE<?php echo $x?>" name="hme_itm_des_PEE<?php echo $x?>" class="form-control input-sm" ng-model="hme_itm_des_PEE<?php echo $x?>" >
               <option value="" disabled selected>Select your option</option>
...
<!--             <input type="text" name="hme_itm_des_PEE<?php //echo $x; ?>" placeholder="Item Description" class="form-control input-sm" id="hme_itm_des_PEE<?php //echo $x ?>" ng-model="hme_itm_des_PEE<?php //echo $x ?>"  /> -->
         </div>
      </div>
      
      <div class="col-md-2">
         <div class="form-group">
            <input type="text" name="hme_make_PEE<?php echo $x;?>" placeholder="Make" class="form-control input-sm" id="hme_make_PEE<?php echo $x;?>" ng-model="hme_make_PEE<?php echo $x;?>"  />
         </div>
      </div>
      
      <div class="col-md-2">
         <div class="form-group">
            <input type="text" name="hme_mdl_PEE<?php echo $x; ?>" placeholder="Model" class="form-control input-sm " id="hme_mdl_PEE<?php echo $x; ?>" ng-model="hme_mdl_PEE<?php echo $x; ?>"  />
         </div>
      </div>
      
      <div class="col-md-1">
         <div class="form-group">
            <input type="text" name="hme_yom_PEE<?php echo $x; ?>" placeholder="YOM" class="form-control input-sm number-validate" id="hme_yom_PEE<?php echo $x; ?>" ng-model="hme_yom_PEE<?php echo $x; ?>"  />
         </div>
      </div>
      
      <div class="col-md-2">
         <div class="form-group">
            <input type="text" name="hme_imei_PEE<?php echo $x; ?>" placeholder="IMEI" class="form-control input-sm number-validate" id="hme_imei_PEE<?php echo $x; ?>" ng-model="hme_imei_PEE<?php echo $x; ?>"  />
         </div>
      </div>
      
      <div class="col-md-2">
         <div class="form-group">
            <input type="text" name="hme_SI_PEE<?php echo $x; ?>" placeholder="Sum Insured" class="form-control input-sm number-validate" id="hme_SI_PEE<?php echo $x; ?>" ng-model="hme_SI_PEE<?php echo $x; ?>"  />
         </div>
      </div>
...
<?php for( $p = 1; $p < 5;  $p++ ) { ?>
   ...
   <div class="row maincontf">
      ...
      <!--       <input type="text" name="hme_ins_place<?php //echo $p; ?>" placeholder="Insurance" class="form-control input-sm" id="hme_ins_place<?php //echo $p; ?>" ng-model="hme_ins_place<?php //echo $p; ?>"  /> -->
         </div>
      </div>
      
      <div class="col-md-2">
         <div class="form-group">
            <input type="text" maxlength="4" onkeypress='return restrictAlphabets(event)' name="hme_policy_yr<?php echo $p; ?>" placeholder="Policy" class="form-control input-sm" id="hme_policy_yr<?php echo $p; ?>" ng-model="hme_policy_yr<?php echo $p; ?>"  />
         </div>
      </div>
...
<!-- 
            <input type="text" name="hme_ins_claim<?php // echo $p; ?>" placeholder="Sum Insured" class="form-control input-sm" id="hme_ins_claim<?php // echo $p; ?>" ng-model="hme_ins_claim<?php // echo $p; ?>"  /> -->
         </div>
      </div>
      <div class="col-md-2">
         <div class="form-group">
...
<?php } ?>   
               ...
               <input type="submit" class="btn blue btn-default" style="float:right;" value="Update" ng-click="HomeUpdateProductDetail()"   />
               <br><br>
            ...
            <div class="carhide" id="carproposal">
               <div class="portlet-title tabbable-line">
                  ...
                  <div class="form-group">
                     ...
                     <div>
                        <span ng-if="lmshomeProposal.$submitted" ng-messages="lmshomeProposal.home_pro_policy_sdate.$error" role="alert"><div ng-message="required" class="required">Please Enter policy start date</div></span>
                     ...
                     <hr>
                           ...
                           <div class="col-md-4">
                              <div class="form-group">
                                 ...
                                 <select id="home_pro_nomie_relation" name="home_pro_nomie_relation" class="form-control input-sm" ng-model="home_pro_nomie_relation"  >
                                    <option value="" disabled selected>Select your option</option>
                           ...
                           <div class="col-md-4">
                              <div class="form-group">
                                 ...
                                 <input type="text" name="home_pro_nomie_age" maxlength="2" placeholder="Enter Nominee Age" class="form-control input-sm age-validate" id="home_pro_nomie_age" ng-model="home_pro_nomie_age" />
                           ...
                           <div class="col-md-4">
                              <div class="form-group">
                                 ...
                                 <input type="text" name="home_pro_nameofappoint" placeholder="EnterName Of Appointee" class="form-control input-sm" id="home_pro_nameofappoint" ng-model="home_pro_nameofappoint" />
                                  <!-- <div ng-if="lmshomeProposal.$submitted || lmshomeProposal.home_pro_nameofappoint.$dirty" ng-messages="lmshomeProposal.home_pro_nameofappoint.$error" role="alert"> -->
...
<script>
  $(document).ready(function () {
   ...
   $(".hme_sum_insured_provided").on('change', function() { 
   ...
   function updatePremium(){
      ...
      switch(sumInsured){
         case'500000':
            ...
            if($("#uniform-valuables span").hasClass("checked")){ premiumAmt = Number(premiumAmt) + Number('2500'); }else { premiumAmt = premiumAmt; }
            if($("#uniform-SIM_PEE span").hasClass("checked")){ premiumAmt = Number(premiumAmt) + Number('4000'); }else { premiumAmt = premiumAmt; }
            if($("#uniform-SIM_structure span").hasClass("checked")){ premiumAmt = Number(premiumAmt) + Number('1239'); }else { premiumAmt = premiumAmt; }
            $('#lms_est_premium').val(premiumAmt);
            break;
         case'1000000':
            var premiumAmt = '4000';
            if($("#uniform-valuables span").hasClass("checked")){ premiumAmt = Number(premiumAmt) + Number('4500'); }else { premiumAmt = premiumAmt; }
            if($("#uniform-SIM_PEE span").hasClass("checked")){ premiumAmt = Number(premiumAmt) + Number('4500'); }else { premiumAmt = premiumAmt; }
            if($("#uniform-SIM_structure span").hasClass("checked")){ premiumAmt = Number(premiumAmt) + Number('2065'); }else { premiumAmt = premiumAmt; }
            $('#lms_est_premium').val(premiumAmt);
            break;
         case'2000000':
            var premiumAmt = '7500';
            if($("#uniform-valuables span").hasClass("checked")){ premiumAmt = Number(premiumAmt) + Number('8000'); }else { premiumAmt = premiumAmt; }
            if($("#uniform-SIM_PEE span").hasClass("checked")){ premiumAmt = Number(premiumAmt) + Number('8000'); }else { premiumAmt = premiumAmt; }
            if($("#uniform-SIM_structure span").hasClass("checked")){ premiumAmt = Number(premiumAmt) + Number('2891'); }else { premiumAmt = premiumAmt; }
            $('#lms_est_premium').val(premiumAmt);
            break;
         case'3000000':
            var premiumAmt = '11000';
             if($("#uniform-valuables span").hasClass("checked")){ premiumAmt = Number(premiumAmt) + Number('12000'); }else { premiumAmt = premiumAmt; }
            if($("#uniform-SIM_PEE span").hasClass("checked")){ premiumAmt = Number(premiumAmt) + Number('10000'); }else { premiumAmt = premiumAmt; }
            if($("#uniform-SIM_structure span").hasClass("checked")){ premiumAmt = Number(premiumAmt) + Number('4130'); }else { premiumAmt = premiumAmt; }
            $('#lms_est_premium').val(premiumAmt);
            break;
         case'4000000':
            var premiumAmt = '14000';
             if($("#uniform-valuables span").hasClass("checked")){ premiumAmt = Number(premiumAmt) + Number('15000'); }else { premiumAmt = premiumAmt; }
            if($("#uniform-SIM_PEE span").hasClass("checked")){ premiumAmt = Number(premiumAmt) + Number('11000'); }else { premiumAmt = premiumAmt; }
            if($("#uniform-SIM_structure span").hasClass("checked")){ premiumAmt = Number(premiumAmt) + Number('5369'); }else { premiumAmt = premiumAmt; }
            $('#lms_est_premium').val(premiumAmt);
            break;
         case'5000000':
            var premiumAmt = '16000';
            if($("#uniform-valuables span").hasClass("checked")){ premiumAmt = Number(premiumAmt) + Number('17000'); }else { premiumAmt = premiumAmt; }
            if($("#uniform-SIM_PEE span").hasClass("checked")){ premiumAmt = Number(premiumAmt) + Number('12000'); }else { premiumAmt = premiumAmt; }
            if($("#uniform-SIM_structure span").hasClass("checked")){ premiumAmt = Number(premiumAmt) + Number('7021'); }else { premiumAmt = premiumAmt; }
            $('#lms_est_premium').val(premiumAmt);
            break;
         case'7500000':
            var premiumAmt = '20000';
            if($("#uniform-valuables span").hasClass("checked")){ premiumAmt = Number(premiumAmt) + Number('23000'); }else { premiumAmt = premiumAmt; }
            if($("#uniform-SIM_PEE span").hasClass("checked")){ premiumAmt = Number(premiumAmt) + Number('15000'); }else { premiumAmt = premiumAmt; }
            if($("#uniform-SIM_structure span").hasClass("checked")){ premiumAmt = Number(premiumAmt) + Number('8260'); }else { premiumAmt = premiumAmt; }
            $('#lms_est_premium').val(premiumAmt);
            break;
      }
