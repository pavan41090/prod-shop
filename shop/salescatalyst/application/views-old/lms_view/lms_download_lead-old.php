...
<style>  
  ...
  .table th {
    font-size: 12px;
		...
		<script type="text/javascript" src="//ajax.aspnetcdn.com/ajax/modernizr/modernizr-1.7-development-only.js"></script>
...
<?php if($this->session->userdata('user_type_abbr') == 'report' ) { ?>
               ...
               <div class="row">
                 ...
                 <?php if($this->session->userdata('user_type_abbr') == 'report' ) { ?>
                          ...
                          <button style="margin-left:10px" type="button" class="btn blue btn-default downloadReport" id="download_reports">Download Reports</button> 
                      <?php } ?>
               </div>
               </div>
<?php } ?>
                    ...
                    url : webUbrl+'User/getAllSupervisor',
                     ...
                     success: function( data){
                        ...
                        for (var i=0;i<data.length;i++){
                          $('#user_supervisor').append('<option value="'+data[i].emp_id+'">'+data[i].user_name+'</option>');
                        }
                     }
