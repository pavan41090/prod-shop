...
$scope.criticalillnesssuminsured=function(){
    if($('#ss_crtical').is(":checked")){
        $scope.ss_sum_insured_critical = $('#ss_sum_insured').val();
    }
  ...
  cateValue = $('#lms_car_category').val();
   ...
   cateValue = $scope.channel;
    ...
    var paramsArray = {
                ...
                "sship_pro_height": $scope.sship_pro_height,
                "sship_pro_Weight": $scope.sship_pro_Weight,
                "sship_pro_height_feet": $scope.sship_pro_height_feet,
                "sship_pro_height_inches":$scope.sship_pro_height_inches,
                ...
                "spouse_height": $scope.spouse.spouse_height,
                "spouse_weight": $scope.spouse.spouse_weight,
                "spouse_height_feet":$scope.spouse.spouse_height_feet,
                "spouse_height_inches":$scope.spouse.spouse_height_inches,
                ...
                "child1_height_feet":$scope.child1.child1_height_feet,
                "child1_height_inches":$scope.child1.child1_height_inches,
                ...
                "child2_height_feet":$scope.child2.child2_height_feet,
                "child2_height_inches":$scope.child2.child2_height_inches,
                ...
                "child3_height_feet":$scope.child3.child3_height_feet,
                "child3_height_inches":$scope.child3.child3_height_inches,
...
$scope.calculateChildAge=function(){
    ...
    $scope.copchange=function(){
        if($scope.lms_car_category=='COP'){
        var dob=$scope.lms_car_dob;
        var yer=calage(dob);
        if(yer<=25){
            if($scope.spouse.spouse_ship==''&& $scope.noofchildrens==''){
                alert("Please Select Spouse and atleast 1 child");
                return false;
            }else if(yer > 25 && yer<=35){
                if($scope.spouse.spouse_ship==''|| $scope.noofchildrens==''){
