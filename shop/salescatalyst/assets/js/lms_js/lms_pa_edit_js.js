...
if(clainprevious == 'yes'){
 ...
 /* reading from database complete here*/
                    ...
                    if(!Aprompt){
                       var finalConfirm = confirm('Lead is canceling');
                        ...
                        return false;
                            ...
                            $scope.getUpdatepersonalAccident();
                            return true;
                        }
                } else {
...
$scope.getUpdatepersonalAccident = function(){
           ...
           $scope.updateprogressdatacus = true;
            ...
            $scope.updateleadhomeprg = true
             var url = __pathname + "LmsPersonalAccident/lmsUpdateCustomerDetails";
            $http.get(url, {
                params: paramsArray
                ...
                if (responceDataR.status == true) {
                    ...
                    location.reload();
                     $("#paedit :input").prop("disabled", true);
                } else {
