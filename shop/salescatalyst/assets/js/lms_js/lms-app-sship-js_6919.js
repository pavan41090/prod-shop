...
$scope.zonewisecalculation = function(data) {
	...
	$('#ss_critical').attr('checked',false);
        $('#ss_sum_insured_critical').val( $('#ss_sum_insured').val() );

/*

        if($('#ss_crtical').is(':checked') == false){

            $('#ss_crtical').attr('checked',true);
            $('#ss_crtical').click();
  ...
  cateValue = $('#lms_car_category').val();
   ...
   cateValue = $scope.channel;
    ...
    var paramsArray = {
                ...
                "ss_sum_insured_critical":$('#ss_sum_insured_critical').val(),//$scope.ss_sum_insured_critical,
