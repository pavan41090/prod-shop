...
//$scope.lmsCar.$setPristine();
   ...
   $scope.savelead = true;
    ...
    $scope.customer = function(){
	  ...
	  if($scope.lmsCar.$valid && checkpolicytime == true){
		if(dobdate.length==0){
...
var findMobileNumber = $('#lms_car_mobile').val();
        var mobileObject = new Object();
        mobileObject.number = findMobileNumber;
        mobileObject.productname = 'Combo';
...
$scope.getInsertCombDtaa = function(){
var cateValue = '';
...
$scope.lms_car_campaign_name =$('#lms_car_campaign_name').val();
    ...
    var paramsArray = {
                ...
                //Nominee Details
                 ...
                 $scope.saveleadprg = true
                var url = __pathname + "LmsCombo/lmsCustomerDetails";
                $http.get(url, {
                    params: paramsArray
                ...
                if (responceDataR.status == true ) {
                    ...
                    location.reload();
                    $("#comboform :input").prop("disabled", true);
                } else {
