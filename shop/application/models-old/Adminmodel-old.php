...
class Adminmodel extends CI_Model {
	...
	public function __construct(){
 	...
 	public function getSearchDownloadQuery(){
		...
		$this->db->select('lead_order_id,shop_plan_name,shop_other_data,shop_premises_covered,shop_insured_name,shop_owner_name,shop_gender,shop_owner_dob,shop_mobile_number,shop_email_id,shop_communication_address,shop_resk_addresss,shop_nominee_name,shop_nominee_relation,shop_nominee_dob,shop_account_number');
