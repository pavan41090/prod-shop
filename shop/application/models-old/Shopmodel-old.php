...
class Shopmodel extends CI_Model {
	...
	public function createLink($thislinkCus,$emailId,$mobileNumber){
		...
		$this->makeUrlink = 'https://servicesonline.bharti-axagi.co.in/shop/s/'.$thislinkCus;
	...
	public function senMailCmpleteOrderID($leadOrderNumber) { 
	    
            $from_email = "crm@bhartiaxa.com";
           //Load email library 
            $selectedValeus = $this->db->select('shop_plan_name,shop_email_id')->where('shop_cus_id',$this->session->userdata('sessionCustomerVal'))->get( TABLE_SHOP_LEAD_NUMBER )->row_object();
