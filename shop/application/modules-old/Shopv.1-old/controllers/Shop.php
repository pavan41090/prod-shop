	...
	public function index()
	{
		...
		try{
			...
			if($_SERVER['REQUEST_METHOD'] == "POST"){
				...
				/*,
				'checkbankrecords' => $this->security->xss_clean($thistermsPost['checkbankrecords']),
				'confirmrelation' => $this->security->xss_clean($thistermsPost['confirmrelation']),
				'confirminformation' => $this->security->xss_clean($thistermsPost['confirminformation']),
				'confirmautorenewal' => $this->security->xss_clean($thistermsPost['confirmautorenewal']),*/
				
				$rmdeclarationArray = array(
				'rmdeclarationagree' => $this->security->xss_clean($thistermsPost['rmdeclarationagree'])
				);
				...
				$dataInsertion['shop_other_data'] = $this->security->xss_clean($this->input->post('thirdValueData'));
