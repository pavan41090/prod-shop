...
<title>Bharti AXA General Insurance</title>
  ...
  <script type="text/javascript" src="http://localhost/python/js/nativesearch.js"></script>
  <style type="text/css">
      ...
      <a href="javascript:;"><img src="https://buyuat.bharti-axagi.co.in:8443/microsite/images/commonb2c/headerFooter/logo.png" class="img-responsive imgres" style="width: 100%;"></a>
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          <div class="col-md-12"><img src="<?php echo base_url(); ?>css/Shop_v10.jpg" style="width: 100%; height:auto; max-height: 100%;"></div>
            ...
            <?php 
			$nnmaeplan = $information->shop_plan_name ? $information->shop_plan_name : ($planName ? $planName : '');
			$this->session->set_userdata('sessionPlanname',$nnmaeplan,true);
			?>
            <?php if($nnmaeplan == '5'){
              $plannameDis = 'Plan A';
...
<?php 
	...
	<div class="form-group">
    <form action="<?php echo base_url('payment-porcessing/'.$this->uri->segment(2)); ?>" method="POST">
	<div class="row">
    <div class="form-group text-right">
