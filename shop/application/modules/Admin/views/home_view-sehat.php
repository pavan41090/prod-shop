        ...
        <div class="col-sm-3 col-md-2 sidebar">
          <ul class="nav nav-sidebar">
            <li>
              ...
              <li> &nbsp; </li>
              <li> &nbsp; </li>
              <li class="list-group-item <?php if($this->uri->segment(1) == 'Admin') { echo 'active'; } ?> "> <a href="<?php echo base_url('Admin'); ?>" > Dukandar Lead Download </a> </li>
              <li class="list-group-item <?php if($this->uri->segment(1) == 'sehat-download-lead') { echo 'active'; } ?> "> <a href="<?php echo base_url('sehat-download-lead'); ?>" > SEHAT Lead Download </a> </li>
          </ul>
          
        </div>
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          <h3 class="page-header text-left"><a>SHOP <span style="text-transform: uppercase;">SEHAT</span> Lead Report Download</a></h3>
          <form action="<?php echo base_url().'sehat-lead-download'; ?>" target="_blank" method="POST">
          <div class="row">
